...
| **Compression**         | Ten codecs (LZ4, Zstd, Brotli, GZip, …), streams/files, size limits and bomb protections. **June 2026 benchmarks:** LZ4 ~117 µs / Zstd ~70 µs decompress @ 1 MB; Zstd ~29× faster streaming compress than GZip @ 100 MB.                                                                                  | [Lyo.Compression](Lyo.Net/Data/Compression/Lyo.Compression/README.md) · [benchmark summary](Lyo.Net/Data/Compression/Lyo.Compression.Benchmarks/BENCHMARK_SUMMARY.md)                                                                          |
