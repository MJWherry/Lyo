...
- [Lyo.PackageMetadata](Lyo.Net/Core/PackageMetadata/Lyo.PackageMetadata/README.md): **`IPackageMetadataStore`**, **`PackageMetadata`**, digest helpers for diagnostics frame
  enrichment.
