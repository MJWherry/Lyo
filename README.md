...
- [Lyo.DataTable.Models](Lyo.Net/Data/DataTable/Lyo.DataTable.Models/README.md): Mutable in-memory data table with sparse columns, headers, footer, per-cell formatting, fluent builders, and an HTML renderer.
