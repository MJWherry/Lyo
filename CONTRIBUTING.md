...
Thanks for helping improve Lyo.
...
The Apache 2.0 license lets people use Lyo in commercial and closed-source apps **without** owing us patches or features. We chose that on purpose so adoption stays easy.

If Lyo helps your project, we still **hope** you will:
...
- Match existing code style and patterns in the touched projects.
- Add or update tests when behavior changes.
- For substantial work, mention intent in an issue first.

If you cannot contribute code, starring the repo or reporting issues with repro steps still helps.
