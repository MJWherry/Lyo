...
(e.g. `lyo-person-api-client`, `lyo-job-api-client`, `lyo-reporting-api-client`) re-export these types on request models.

Parameter picker resolve: `ParameterOptionsResolveReq` / `ParameterOptionsResolveRes` (`POST Reporting/ResolveParameterOptions`).
