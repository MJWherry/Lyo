...
/// <summary>Stock <see cref="IIOTempService" /> using <see cref="IIOTempStorageProvider" /> for every I/O call.</summary>
...
public sealed class IOTempService : IIOTempService
{
    ...
    /// <param name="storageProvider">Storage backend; default is <see cref="FileSystemIOTempStorageProvider" /> at <see cref="IOTempServiceOptions.RootDirectory" />.</param>
            ...
            if (entry.IsDirectory) {
                ...
                try {
                    ...
                    if (!_storage.DirectoryExists(entry.FullPath)) {
                        deletedDirectories++;
                        DirectoryDeleted?.Invoke(entry.FullPath);
                    }
                }
            }
            else {
