...
/// <summary>
/// Abstracts all file-system I/O performed by <c>IOTempService</c>, <c>IOTempSession</c>, and
/// <c>IOTempFileGenerator</c>.  Implement this interface to swap in a different storage backend
/// (in-memory, FTP, SFTP, Azure Blob, etc.) without changing any IOTemp business logic.
/// </summary>
...
public interface IIOTempStorageProvider
{
    ...
    /// <summary>Validates that the directory at <paramref name="path"/> is readable and writable.
    /// Throw if access is denied; implementations backed by in-memory storage may treat this as a no-op.</summary>
