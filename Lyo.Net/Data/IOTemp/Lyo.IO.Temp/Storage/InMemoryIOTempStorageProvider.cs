...
/// <summary>
/// In-memory <see cref="IIOTempStorageProvider" /> on a <see cref="ConcurrentDictionary{TKey,TValue}" />. Use it in Blazor WASM, unit tests, or anywhere without a writable
/// disk. Data lasts for this provider instance's lifetime.
/// </summary>
...
public sealed class InMemoryIOTempStorageProvider : IIOTempStorageProvider
{
    ...
    {
        var n = Normalize(path);
        // Create ancestor directories first.
