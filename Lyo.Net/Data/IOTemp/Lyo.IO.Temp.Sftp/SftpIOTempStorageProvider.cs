...
/// <summary><see cref="IIOTempStorageProvider" /> over SFTP, using <see cref="Lyo.Common.Core.Pathing.PathStyle.Posix" />.</summary>
// ReSharper disable once InconsistentNaming
public sealed class SftpIOTempStorageProvider : IIOTempStorageProvider
{
    private readonly ISftpClient _client;

    /// <summary>Stores temp data under the SFTP client's remote root jail.</summary>
    public SftpIOTempStorageProvider(ISftpClient client)
    {
