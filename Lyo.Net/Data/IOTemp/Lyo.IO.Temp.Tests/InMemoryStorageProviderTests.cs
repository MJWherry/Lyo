...
public sealed class InMemoryStorageProviderTests
{
    ...
    [Fact]
    public void EnumerateEntries_Returns_OnlyImmediateChildren()
    {
        var storage = NewProvider();
    ...
    [Fact]
    public void EnumerateEntries_Returns_EmptyForEmptyDirectory()
    {
        var storage = NewProvider();
    ...
    [Fact]
    public void GetFileLength_Returns_CorrectByteCount()
    {
        var storage = NewProvider();
    ...
    [Fact]
    public void GetFileCreationTimeUtc_Is_CloseToNow()
    {
    ...
    [Fact]
    public void AddIOTempService_Uses_RegisteredIIOTempStorageProvider()
    {
