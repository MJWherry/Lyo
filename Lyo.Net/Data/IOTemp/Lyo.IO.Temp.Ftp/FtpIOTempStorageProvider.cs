...
/// <summary><see cref="IIOTempStorageProvider" /> over FTP, using <see cref="Lyo.Common.Core.Pathing.PathStyle.Posix" />.</summary>
// ReSharper disable once InconsistentNaming
public sealed class FtpIOTempStorageProvider : IIOTempStorageProvider
{
    private readonly IFtpClient _client;

    /// <summary>Stores temp data under the FTP client's remote root jail.</summary>
