...
/// <summary>Live annotated preview of a SmartFormat template. Pair with <see cref="LyoFormatterTemplateEditor" /> through <see cref="LyoFormatterLiveSession" />.</summary>
public partial class LyoFormatterPreview : IDisposable
{
    ...
    /// <summary>Shown when the debounced template has no text.</summary>
    [Parameter]
