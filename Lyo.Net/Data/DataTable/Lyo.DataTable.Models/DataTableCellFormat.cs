...
/// <summary>Optional per-cell formatting for a <see cref="DataTable" />. Stored sparsely on the table, not on the cell.</summary>
...
public sealed record DataTableCellFormat(
