...
### Snapshot Metrics
- `filesystemwatcher.snapshot.duration` - Duration of snapshot operations
- `filesystemwatcher.snapshot.duration_ms` - Duration in milliseconds
- `filesystemwatcher.snapshot.file_count` - Number of files in snapshot
- `filesystemwatcher.snapshot.directory_count` - Number of directories in snapshot
- `filesystemwatcher.snapshot.item_count` - Total items in snapshot

### Change Detection Metrics
- `filesystemwatcher.change_detection.duration` - Duration of change detection
- `filesystemwatcher.change_detection.duration_ms` - Duration in milliseconds
- `filesystemwatcher.changes.detected` - Number of changes detected per scan

### Event Metrics
- `filesystemwatcher.file.created` - File created events
- `filesystemwatcher.file.deleted` - File deleted events
- `filesystemwatcher.file.changed` - File changed events
- `filesystemwatcher.file.moved` - File moved events
- `filesystemwatcher.file.renamed` - File renamed events
- `filesystemwatcher.directory.created` - Directory created events
- `filesystemwatcher.directory.deleted` - Directory deleted events
- `filesystemwatcher.directory.changed` - Directory changed events
- `filesystemwatcher.directory.moved` - Directory moved events
- `filesystemwatcher.directory.renamed` - Directory renamed events

### Error Metrics
- `filesystemwatcher.error.count` - Number of errors encountered
...
- **Event handler exceptions**: Errors in your event handlers are caught and logged
