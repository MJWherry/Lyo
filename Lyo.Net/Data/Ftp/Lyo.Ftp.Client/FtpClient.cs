...
/// <summary>
/// Pooled FluentFTP client that logs and records metrics. Async methods are the real implementation. Sync methods wait on them. Safe for concurrent callers up to
