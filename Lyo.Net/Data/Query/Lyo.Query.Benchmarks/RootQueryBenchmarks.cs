...
/// <summary>
/// End-to-end root <c>/Query</c> (From/Joins) benchmarks against PostgreSQL (Testcontainers). Isolated so Docker-less CI can filter this class out with BenchmarkDotNet
/// filters.
/// </summary>
