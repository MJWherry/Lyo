...
/// <summary>
/// Self-contained entity used for in-memory where-clause/sort/projection measures (no EF dependencies). Carries a nested <see cref="Address" /> object and a
...
/// <summary>Nested address on <see cref="BenchPerson" />, used to drive nested-path filtering/projection.</summary>
...
/// <summary>Nested contact row inside <see cref="BenchPerson.Contacts" />.</summary>
...
/// <summary>Shared factory helpers for the query suites.</summary>
...
/// <summary>ILyoMapper implementation that forwards to Mapster's IMapper.</summary>
