...
/// <summary>
/// End-to-end CRUD measures for the Lyo.Api query pipeline against a real PostgreSQL database (Testcontainers). Needs Docker; the container starts in
...
public class CrudActionBenchmarks
{
    ...
    public void Setup()
    {
        ...
        // Insert enough definitions to exercise paging.
    ...
    {
        var req = new ProjectionQueryReq { Amount = Amount, Select = ["Id", "Name"] };
