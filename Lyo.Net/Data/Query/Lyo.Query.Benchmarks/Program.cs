...
[assembly: BenchmarkReport(
    ...
    "Query & CRUD",
    Description =
        "Lyo.Query engine internals plus end-to-end CRUD. In-memory suites run the where-clause engine "
        ...
        + "against a real PostgreSQL database (Testcontainers, Docker) paging Amount rows. Each class's data shape "
