...
/// <summary>Checks that QueryPropertyNameAttribute lets saved query paths (e.g. "DocketCharges") resolve to C# properties with different names (e.g. "Charges").</summary>
public class QueryPropertyNameTests : WhereClauseServiceTests
{
    ...
    public void ApplyWhereClause_ResolvesViaQueryPropertyNameAttribute_Equals()
    {
        ...
        // Query uses the saved path "DocketCharges" (canonical name from DB/other system)
    ...
    public void Resolution_IsCaseInsensitive()
    {
        ...
        // Attribute value is "DocketCharges" — "docketcharges" (lowercase) must still resolve
