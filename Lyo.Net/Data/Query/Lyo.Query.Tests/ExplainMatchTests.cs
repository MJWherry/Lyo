...
public class ExplainMatchTests : WhereClauseServiceTests
{
    ...
    {
        var svc = CreateService();
        // Name fails the first predicate; Age satisfies the second — overall And is still false.
    ...
    /// <summary>Minimal stub with no ExplainMatch: the default interface implementation should throw.</summary>
