...
/// <summary>Fluent builder for <see cref="ProjectionQueryReq" /> (<c>/QueryProject</c> — projection plus optional computed columns).</summary>
...
public class ProjectionQueryReqBuilder(ProjectionQueryReq? baseQuery = null)
{
    ...
    /// <summary>Adds include paths (uncommon for QueryProject; API may derive includes from selects).</summary>
    ...
    /// <summary>Adds projected field path(s) onto <see cref="ProjectionQueryReq.Select" />.</summary>
    ...
    /// <summary>Adds projected fields from an array (at least one needed).</summary>
    ...
    /// <summary>Adds one SmartFormat computed column.</summary>
    ...
    /// <summary>Adds a ready <see cref="ComputedField" />.</summary>
    ...
    /// <summary>Starts a typed builder for expression selects, includes, where, and sort (see <see cref="ProjectionQueryReqForBuilder{T}" />).</summary>
    ...
    /// <summary>When <c>true</c>, QueryProject zips sibling fields under the same collection into one object array. <c>null</c> uses the API default (zip).</summary>
    ...
    /// <summary>The configured <see cref="ProjectionQueryReq" />.</summary>
    public ProjectionQueryReq Build() => _query;

    /// <summary>Builds a new empty projection builder.</summary>
    public static ProjectionQueryReqBuilder New() => new();

    public override string ToString() => _query.ToString();

    /// <summary>Typed façade over <see cref="ProjectionQueryReqBuilder" /> for expression-based select, include, where, and sort.</summary>
    public class ProjectionQueryReqForBuilder<T>
    {
        ...
        /// <summary>Adds an include path from a member-access lambda expression.</summary>
        ...
        /// <summary>Builds a typed where clause and assigns it on the projection request.</summary>
        ...
        /// <summary>Adds a SmartFormat computed column (<see cref="ProjectionQueryReqBuilder.AddComputedField(string, string)" />).</summary>
        ...
        /// <summary>Adds a sort using a property path from <paramref name="selector" />.</summary>
        ...
        /// <summary>Parent <see cref="ProjectionQueryReqBuilder" />.</summary>
