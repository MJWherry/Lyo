...
/// <summary>Fluent builder for <see cref="QueryConcreteReq" /> (<c>/QueryConcrete</c> — full entities, no sparse projection).</summary>
...
public class QueryConcreteReqBuilder(QueryConcreteReq? baseQuery = null)
{
    ...
    /// <summary>Returns the configured <see cref="QueryConcreteReq" />.</summary>
    ...
    /// <summary>Typed façade over <see cref="QueryConcreteReqBuilder" /> using expression-based paths.</summary>
