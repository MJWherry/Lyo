...
/// <summary>AST node for filter clauses: a field predicate (<see cref="ConditionClause" />) or a boolean group (<see cref="GroupClause" />).</summary>
...
{
    /// <summary>Optional human-readable label for diagnostics, logs, or UI (not evaluated as SQL).</summary>
    ...
    /// <summary>Pretty-print the clause at the given indent depth (each depth = 2 spaces). Default falls back to ToString(); derived classes may override.</summary>
