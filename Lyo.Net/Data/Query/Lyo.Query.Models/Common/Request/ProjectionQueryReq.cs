...
/// <remarks>
/// <see cref="QueryRequestBase.Include" /> is not used for QueryProject: EF navigation loads are derived from <see cref="Select" /> (and from collection paths referenced in
...
public sealed class ProjectionQueryReq : QueryRequestBase, IQueryExecutionRequest
{
    ...
    /// <summary>Optional computed fields (SmartFormat). Requires IFormatterService. Placeholders reference <see cref="Select" /> field names.</summary>
