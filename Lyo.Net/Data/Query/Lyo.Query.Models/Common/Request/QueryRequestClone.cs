...
/// <summary>Structural clones of query request DTOs (fresh list containers; <see cref="WhereClause" /> shared by reference).</summary>
public static class QueryRequestClone
{
    ...
    /// <summary>Clones <paramref name="source" /> while keeping its concrete request type.</summary>
