...
/// <summary>
/// Pooled SSH.NET SFTP client that logs and records metrics. Async methods are the real implementation. Sync methods wait on them. Safe for concurrent callers up to
...
public sealed class SftpClient : ISftpClient
{
    ...
    /// <summary>Builds a client from options that have already been validated.</summary>
