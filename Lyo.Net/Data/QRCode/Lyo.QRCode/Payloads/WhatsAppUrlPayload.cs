...
/// <summary>Opens a WhatsApp chat at <c>https://wa.me/&lt;E164 digits&gt;</c>. No <c>+</c> in the path.</summary>
...
public sealed class WhatsAppUrlPayload : IQrPayload
{
    ...
    /// <summary>Builds a WhatsApp deep link from a phone string (digits and an optional leading <c>+</c>).</summary>
