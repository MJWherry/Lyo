...
/// <summary>Absolute HTTP(S) URL used as QR content.</summary>
...
public sealed class HttpUrlPayload : IQrPayload
{
    ...
    /// <summary>If true, upgrade <c>http</c> to <c>https</c>.</summary>
    public bool ForceHttps { get; }

    /// <summary>Builds a payload from a URL string.</summary>
    ...
    /// <summary>Builds a payload from an absolute <see cref="Uri" />.</summary>
