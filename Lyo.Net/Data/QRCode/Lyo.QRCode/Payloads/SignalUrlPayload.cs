...
/// <summary>Signal URI for adding a contact by phone (<c>sgnl://signal.me/#p/&lt;E164&gt;</c>). Client support varies by platform.</summary>
...
public sealed class SignalUrlPayload : IQrPayload
{
    ...
    /// <summary>Builds a Signal link from a phone number, normalized to E.164 with a leading <c>+</c>.</summary>
    ...
    public string ToQrString()
    {
        ...
        // Fragment uses E.164 with a literal + (digits and plus only).
