...
/// <summary>Decodes QR images with ZXing. Shared by <see cref="BuiltInQRCodeService" /> and QRCoder-backed services.</summary>
public static class QRCodeZxingRead
{
    /// <summary>Decodes the first QR code in an image (PNG, JPEG, BMP, and similar).</summary>
