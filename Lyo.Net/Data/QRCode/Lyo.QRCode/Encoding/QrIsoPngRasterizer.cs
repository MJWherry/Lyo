...
internal static class QrIsoPngRasterizer
{
    ...
    private sealed class PngBuilder : IDisposable
    {
        ...
        /// <summary>Writes the PLTE chunk, and also the tRNS chunk if necessary. Must come before the IDAT chunk.</summary>
        ...
        /// <summary>Writes the IDAT chunk with the actual picture.</summary>
        ...
        /// <summary>Writes the IEND chunk. This must be the last chunk in the file.</summary>
