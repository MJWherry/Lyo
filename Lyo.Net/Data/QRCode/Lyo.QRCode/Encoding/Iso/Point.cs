...
internal sealed partial class QrIsoEncoder
{
    ...
    private readonly struct Point : IEquatable<Point>
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Point" /> struct with specified X and Y coordinates.</summary>
        ...
        /// <summary>Determines whether the specified <see cref="Point" /> is equal to the current <see cref="Point" />.</summary>
        ...
        /// <remarks>
        /// If this method which implements <see cref="IEquatable{T}.Equals(T)" /> is not implemented, comparisons used by methods such as <see cref="List{T}.Contains(T)" /> fall
        /// back to reflection, which causes heap allocations internally during the calls to <see cref="FieldInfo.GetValue(object)" />.
        /// </remarks>
