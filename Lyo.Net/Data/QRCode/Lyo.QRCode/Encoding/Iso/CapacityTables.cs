...
internal sealed partial class QRIsoEncoder
{
    ...
    private static class CapacityTables
    {
        ...
        /// <returns>
        /// An <see cref="ECCInfo" /> object containing the total number of data codewords, ECC per block, block group details, and other parameters required for encoding error
        /// correction data.
        /// </returns>
        ...
        /// <summary>
        /// Retrieves the capacity information for a specific QR code version. The returned structure contains detailed data capacity values for each error correction level (L, M, Q,
        /// H) and encoding mode (Numeric, Alphanumeric, Byte, Kanji), indicating the maximum number of characters that can be stored in a QR code of the specified version under each
        /// configuration.
        /// </summary>
        /// <param name="version">The version of the QR code (1 to 40, or -1 to -4 for M1 to M4).</param>
        ...
        /// boundaries, as required by the QR code specification.
        /// </summary>
        /// <param name="version">The version of the QR code (1 to 40, or -1 to -4 for M1 to M4).</param>
        ...
        /// found, it throws an exception indicating that the data length exceeds the maximum capacity for the given settings.
        /// </summary>
        ...
        /// <exception cref="DataTooLongException">Thrown when the data length exceeds the maximum capacity for the specified encoding mode and error correction level.</exception>
        ...
        /// <summary>
        /// Attempts to determine the minimum QR code version required to encode a data segment with a specific error correction level. This method accounts for the version-dependent
        /// size of mode and count indicators when calculating the total bit length.
        /// </summary>
        ...
        /// <summary>
        /// Determines the minimum Micro QR code version required to encode a given amount of data with a specific encoding mode and error correction level. If no suitable version is
        /// found, it throws an exception indicating that the data length exceeds the maximum capacity for the given settings.
        /// </summary>
        /// <param name="length">The length of the data to be encoded.</param>
        /// <param name="encMode">The encoding mode (e.g., Numeric, Alphanumeric, Byte).</param>
        ...
        /// <summary>
        /// Generates a table containing the error correction capacities and data codeword information for different QR code versions and error correction levels. This table is
        /// essential for determining how much data can be encoded in a QR code of a specific version and ECC level, as well as how robust the QR code will be against distortions or
        /// obstructions.
        /// </summary>
        ...
        /// <summary>
        /// Generates a list containing detailed capacity information for various versions of QR codes. This table includes capacities for different encoding modes (numeric,
        /// alphanumeric, byte, etc.) under each error correction level. The capacity table is crucial for QR code generation, as it determines how much data each QR code version can store
        /// depending on the encoding mode and error correction level used. The index in the capacity table corresponds to one less than the version number.
        /// </summary>
