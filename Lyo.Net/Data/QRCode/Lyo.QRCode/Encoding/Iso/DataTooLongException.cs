...
/// <summary>Exception thrown when the given payload exceeds the maximum size of the QR code standard.</summary>
internal sealed class DataTooLongException : Exception
{
    /// <summary>Initializes a new instance of the <see cref="DataTooLongException" /> class with a specified error message.</summary>
