...
internal sealed partial class QrIsoEncoder
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="VersionInfo" /> struct with a specific version number and its details.</summary>
        ...
        /// <summary>Gets the version number of the QR code. Each version number specifies a different size of the QR matrix.</summary>
        public int Version { get; }

        /// <summary>Gets a list of details about the QR code version, including the error correction levels and encoding capacities.</summary>
