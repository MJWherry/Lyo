...
internal sealed partial class QrIsoEncoder
{
    ...
    /// with a coefficient of 3 and an exponent of 2.
    /// </summary>
    private struct PolynomItem
    {
        /// <summary>Initializes a new instance of the <see cref="PolynomItem" /> struct with the specified coefficient and exponent.</summary>
        ...
        /// <summary>Gets the coefficient of the polynomial term.</summary>
        public int Coefficient { get; }

        /// <summary>Gets the exponent of the polynomial term.</summary>
