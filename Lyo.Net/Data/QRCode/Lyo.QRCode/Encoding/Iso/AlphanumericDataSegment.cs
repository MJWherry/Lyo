...
internal sealed partial class QrIsoEncoder
{
    ...
    {
        /// <summary>Gets the encoding mode (always Alphanumeric)</summary>
        public override EncodingMode EncodingMode => EncodingMode.Alphanumeric;

        /// <summary>Initializes a new instance of the AlphanumericDataSegment class.</summary>
        ...
        /// <summary>Calculates the total bit length for encoding alphanumeric text of a given length for a specific QR code version. Includes mode indicator, count indicator, and data bits.</summary>
        ...
        /// <summary>Writes a portion of alphanumeric text to a BitArray at the specified index. Includes mode indicator, count indicator, and data bits.</summary>
