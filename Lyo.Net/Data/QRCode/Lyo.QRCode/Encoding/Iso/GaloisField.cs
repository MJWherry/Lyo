...
internal sealed partial class QrIsoEncoder
{
    ...
    /// <para>
    /// Provides mappings between exponential and integer representations of field elements using a primitive element (α). The field is constructed with respect to a generator
    ...
    internal static class GaloisField
    {
        ...
        /// logarithmic representation in the field.
        /// </summary>
        ...
        /// <summary>
        /// Normalizes a Galois field exponent to ensure it remains within the bounds of the field's size. This is particularly necessary when performing multiplications in the field
        /// which can result in exponents exceeding the field's maximum.
        /// </summary>
