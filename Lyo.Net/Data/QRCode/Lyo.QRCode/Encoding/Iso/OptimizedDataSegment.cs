...
internal sealed partial class QrIsoEncoder
{
    ...
    /// This implements the QR Code optimization algorithm from ISO/IEC 18004:2015 Annex J.2. It does not support Kanji mode.
    /// </summary>
    private sealed class OptimizedLatin1DataSegment : DataSegment
    {
        /// <summary>Gets the encoding mode (used only for DataTooLongException)</summary>
        public override EncodingMode EncodingMode => EncodingMode.Byte;

        /// <summary>Initializes a new instance of the OptimizedDataSegment class.</summary>
        ...
        /// <summary>Checks if the given string can be encoded using optimized Latin-1 encoding. Returns true if all characters are within the ISO-8859-1 range (0x00-0xFF).</summary>
        ...
        /// <summary>Calculates the bit length for a byte mode segment.</summary>
        private static int GetByteBitLength(int textLength, int version)
        {
            ...
            var dataLength = textLength * 8; // ISO-8859-1 encoding
        ...
        /// <summary>Writes a byte mode segment to the BitArray.</summary>
