...
internal sealed partial class QrIsoEncoder
{
    ...
    {
        /// <summary>Gets the X-coordinate of the top-left corner of the rectangle.</summary>
        public int X { get; }

        /// <summary>Gets the Y-coordinate of the top-left corner of the rectangle.</summary>
        public int Y { get; }
        ...
        /// <summary>Initializes a new instance of the <see cref="Rectangle" /> struct with the specified top-left corner coordinates, width, and height.</summary>
