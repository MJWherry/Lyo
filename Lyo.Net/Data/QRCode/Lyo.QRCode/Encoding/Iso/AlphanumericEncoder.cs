...
internal sealed partial class QrIsoEncoder
{
    ...
    internal static class AlphanumericEncoder
    {
        ...
        /// <summary>
        /// Converts alphanumeric plain text into a binary format optimized for QR codes. Alphanumeric encoding packs characters into 11-bit groups for each pair of characters, and 6
        /// bits for a single remaining character if the total count is odd.
        /// </summary>
        ...
        /// <summary>
        /// Writes a portion of alphanumeric plain text directly into an existing BitArray at the specified index. Alphanumeric encoding packs characters into 11-bit groups for each
        /// pair of characters, and 6 bits for a single remaining character if the total count is odd.
        /// </summary>
        /// <param name="plainText">The alphanumeric text to be encoded, which should only contain characters valid in QR alphanumeric mode.</param>
