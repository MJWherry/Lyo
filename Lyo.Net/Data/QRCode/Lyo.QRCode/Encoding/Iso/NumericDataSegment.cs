...
internal sealed partial class QrIsoEncoder
{
    ...
    /// they do not complete a group of three.
    /// </summary>
    ...
    /// <summary>
    /// Converts a portion of numeric plain text into a binary format specifically optimized for QR codes, writing directly to an existing BitArray. Numeric compression groups up
    /// to 3 digits into 10 bits, less for remaining digits if they do not complete a group of three.
    /// </summary>
    /// <param name="plainText">The numeric text to be encoded, which should only contain digit characters.</param>
    ...
    /// <summary>Data segment optimized for numeric data encoding.</summary>
    private sealed class NumericDataSegment : DataSegment
    {
        /// <summary>Gets the encoding mode (always Numeric)</summary>
        public override EncodingMode EncodingMode => EncodingMode.Numeric;

        /// <summary>Initializes a new instance of the NumericDataSegment class.</summary>
        ...
        /// <summary>Calculates the total bit length for encoding numeric text of a given length for a specific QR code version. Includes mode indicator, count indicator, and data bits.</summary>
        ...
        /// <summary>Writes this data segment to an existing BitArray at the specified index.</summary>
        /// <param name="bitArray">The target BitArray to write to</param>
        ...
        /// <summary>Writes a portion of numeric text to a BitArray at the specified index. Includes mode indicator, count indicator, and data bits.</summary>
