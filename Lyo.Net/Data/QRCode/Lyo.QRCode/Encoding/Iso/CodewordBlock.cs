...
internal sealed partial class QrIsoEncoder
{
    ...
    /// followed by error correction codewords.
    /// </summary>
    private readonly struct CodewordBlock
    {
        /// <summary>Initializes a new instance of the CodewordBlock struct with specified arrays of code words and error correction (ECC) words.</summary>
        ...
        /// <summary>Gets the offset of the data codewords in the BitArray.</summary>
        public int CodeWordsOffset { get; }

        /// <summary>Gets the length of the data codewords in the BitArray.</summary>
        public int CodeWordsLength { get; }

        /// <summary>Gets the error correction codewords associated with this block.</summary>
