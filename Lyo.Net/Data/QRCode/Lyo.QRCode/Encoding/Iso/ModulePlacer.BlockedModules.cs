...
internal sealed partial class QrIsoEncoder
{
    ...
    {
        /// <summary>Struct that represents blocked modules using rectangles.</summary>
        public struct BlockedModules : IDisposable
        {
            ...
            /// <summary>Initializes a new instance of the <see cref="BlockedModules" /> struct with a specified size.</summary>
            ...
            /// <summary>Adds a blocked module at the specified coordinates.</summary>
            ...
            /// <summary>Adds a blocked module defined by the specified rectangle.</summary>
            ...
            /// <summary>Checks if the specified coordinates are blocked.</summary>
            ...
            /// <summary>Checks if the specified rectangle is blocked.</summary>
