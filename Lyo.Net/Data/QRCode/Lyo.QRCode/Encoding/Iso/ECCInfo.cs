...
internal sealed partial class QrIsoEncoder
{
    ...
    {
        /// <summary>Initializes a new instance of the ECCInfo struct with specified properties.</summary>
        ...
        /// <summary>Initializes a new instance of the ECCInfo struct with specified properties for Micro QR codes.</summary>
        /// <param name="version">The version number of the QR code.</param>
        /// <param name="errorCorrectionLevel">The error correction level used in the QR code.</param>
        /// <param name="totalDataCodewords">The total number of data codewords for this version and error correction level.</param>
        ...
        /// <summary>Gets the version number of the QR code.</summary>
        public int Version { get; }

        /// <summary>Gets the error correction level of the QR code.</summary>
        public ECCLevel ErrorCorrectionLevel { get; }

        /// <summary>Gets the total number of data codewords for this version and error correction level.</summary>
        public int TotalDataCodewords { get; }

        /// <summary>Gets the total number of data codewords for this version and error correction level.</summary>
        public int TotalDataBits { get; }

        /// <summary>Gets the number of error correction codewords per block.</summary>
        public int ECCPerBlock { get; }

        /// <summary>Gets the number of blocks in group 1.</summary>
        public int BlocksInGroup1 { get; }

        /// <summary>Gets the number of codewords in each block of group 1.</summary>
        public int CodewordsInGroup1 { get; }

        /// <summary>Gets the number of blocks in group 2, if any.</summary>
        public int BlocksInGroup2 { get; }

        /// <summary>Gets the number of codewords in each block of group 2, if any.</summary>
