...
internal sealed partial class QrIsoEncoder
{
    ...
    private struct Polynom : IDisposable
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Polynom" /> struct with a specified number of initial capacity for polynomial terms.</summary>
        ...
        /// <summary>Adds a polynomial term to the polynomial.</summary>
        ...
        /// <summary>Removes all polynomial terms from the polynomial.</summary>
        public void Clear() => Count = 0;

        /// <summary>Clones the polynomial, creating a new instance with the same polynomial terms.</summary>
        ...
        /// <summary>Sorts the collection of <see cref="PolynomItem" /> using a custom comparer function.</summary>
        /// <param name="comparer">
        /// A function that compares two <see cref="PolynomItem" /> objects and returns an integer indicating their relative order: less than zero if the first is less
        /// than the second, zero if they are equal, or greater than zero if the first is greater than the second.
        /// </param>
        ...
        /// <summary>
        /// Returns a string that represents the polynomial in standard algebraic notation. Example output: "a^2*x^3 + a^5*x^1 + a^3*x^0", which represents the polynomial 2x³ + 5x +
        /// 3.
        /// </summary>
        ...
        /// <summary>Ensures that the polynomial has enough capacity to store the specified number of polynomial terms.</summary>
...
#if HAS_SPAN
        /// <summary>Rents memory for the polynomial terms from the shared memory pool.</summary>
        private static PolynomItem[] RentArray(int count) => ArrayPool<PolynomItem>.Shared.Rent(count);

        /// <summary>Returns memory allocated for the polynomial terms back to the shared memory pool.</summary>
        ...
        /// <summary>Returns an enumerator that iterates through the polynomial terms.</summary>
        public PolynumEnumerator GetEnumerator() => new(this);

        /// <summary>Value type enumerator for the <see cref="Polynom" /> struct.</summary>
