...
/// <summary>Reads EXIF from image streams via MetadataExtractor (used when SkiaSharp has no EXIF).</summary>
internal static class SkiaExifExtractor
{
    /// <summary>Reads EXIF from a seekable image stream. Call after resetting stream position to 0.</summary>
        ...
        foreach (var dir in directories) {
            foreach (var tag in dir.Tags) {
                try {
                    ...
                    // Drop tags that fail conversion
                }
            }
        }
