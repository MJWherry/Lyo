...
OCR contracts for Lyo: `IOcrEngine`, request/response models, Y-up pixel bounding boxes (aligned with [`BoundingBox2D`](../../../Core/Common/Lyo.Common/Records/BoundingBox2D.cs)), coordinate helpers, and shared `OcrEngineOptions`.
