...
/// <summary>Error codes raised by OCR operations.</summary>
public static class OcrErrorCodes
{
    ...
    /// <summary>Could not decode or load image bytes for OCR.</summary>
    public const string ImageLoadFailed = "OCR_IMAGE_LOAD_FAILED";

    /// <summary>OCR engine is not configured (missing tessdata path, for example).</summary>
