...
/// <summary>Groups word boxes into lines with a simple Y-overlap heuristic.</summary>
public static class OcrLineGrouper
{
    /// <summary>Groups words into lines ordered top-to-bottom (decreasing Y-up).</summary>
