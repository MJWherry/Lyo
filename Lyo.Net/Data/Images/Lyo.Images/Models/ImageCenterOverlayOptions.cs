...
public sealed class ImageCenterOverlayOptions
{
    ...
    /// <summary>
    /// Draw a stroke around the overlay. When true, the pad behind the logo uses <see cref="BorderColorHex" />; stroke color uses <see cref="OverlayBorderStrokeHex" /> when set
    /// and parseable, otherwise a dark default so the edge is visible on the light pad.
    /// </summary>
