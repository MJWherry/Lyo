...
/// <summary>Shared PNG encoder settings so indexed or palette output does not flatten overlays.</summary>
internal static class ImagePngEncoding
{
    ...
    /// <summary>Faster encode, larger output (good for QR frames and overlays).</summary>
    ...
    /// <summary>Truecolor RGBA composite encoder from <see cref="Models.ImageServiceOptions.UseFastPngForQrComposites" />.</summary>
