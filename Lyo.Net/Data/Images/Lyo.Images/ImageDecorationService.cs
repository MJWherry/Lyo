...
/// <summary>
/// Default <see cref="IImageDecorationService" />: stream-based overlay/frame/caption/padding primitives plus the <see cref="ImageDecorationPipeline" />
/// factory. Compositors live in <c>Lyo.Images.Decoration</c>.
/// </summary>
public class ImageDecorationService : IImageDecorationService
{
    ...
    /// <summary>Builds a new <see cref="ImageDecorationService" />.</summary>
    /// <param name="options">Image-service options; defaults when null.</param>
    /// <param name="logger">Optional logger.</param>
    /// <param name="metrics">Optional metrics sink (used only when <see cref="ImageServiceOptions.EnableMetrics" /> is true).</param>
