...
/// <summary>Builder-style extensions for <see cref="IImageDecorationPipeline" />: each method takes a configurator on the matching fluent builder and queues that stage.</summary>
public static class ImageDecorationPipelineBuilderExtensions
{
    /// <summary>Queues an overlay configured through an <see cref="OverlayOptionsBuilder" />.</summary>
    ...
    /// <summary>Queues a frame configured through a <see cref="FrameOptionsBuilder" />.</summary>
    ...
    /// <summary>Queues a caption configured through a <see cref="CaptionOptionsBuilder" />.</summary>
    ...
    /// <summary>Queues outer padding configured through a <see cref="PaddingOptionsBuilder" />.</summary>
