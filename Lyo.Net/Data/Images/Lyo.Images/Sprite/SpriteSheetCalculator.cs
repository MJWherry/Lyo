...
public static class SpriteSheetCalculator
{
    ...
    /// <summary>Splits <paramref name="total" /> pixels across <paramref name="count" /> cells; the first <c>total % count</c> cells get one extra pixel so the grid covers the full span.</summary>
