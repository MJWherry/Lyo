...
/// <summary>Wraps the image in a stroked outline (optional rounded corners and inner fill) and returns the expanded canvas as a new image.</summary>
internal static class FrameDrawer
{
    /// <summary>Builds a new image (caller disposes the original separately) larger than the input by stroke + padding on every side.</summary>
