...
/// <summary>Wraps the image in an outer canvas with optional rounded card fill and drop shadow.</summary>
internal static class OuterPaddingDrawer
{
    /// <summary>Builds a new image whose canvas is larger than the input by margin + padding + shadow offset on every side.</summary>
