...
/// <summary>Process-wide LRU cache of <see cref="Font" /> instances keyed by family + half-point size, shared by decoration primitives.</summary>
internal static class FontCache
{
    ...
    /// <summary>Cached font, creating it (and evicting the oldest entry on overflow) when missing.</summary>
