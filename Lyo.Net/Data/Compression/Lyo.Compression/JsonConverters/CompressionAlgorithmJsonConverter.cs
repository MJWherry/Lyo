...
/// <summary>JSON converter for <see cref="CompressionAlgorithm" /> that serializes and deserializes using the stable algorithm <see cref="CompressionAlgorithm.Name" />.</summary>
