...
/// <summary>
/// DI helpers that register <see cref="CompressionService" /> with Microsoft.Extensions.DependencyInjection. Use <see cref="Extensions.AddDefaultCompressionService{TConcrete}" /> for
...
public static class Extensions
{
    ...
    extension(IServiceCollection services)
    {
        ...
        /// <param name="configSectionName">Section containing <see cref="CompressionServiceOptions" /> keys (starts as <c>CompressionService</c>).</param>
        /// <returns>Service collection for chaining.</returns>
        ...
        /// <summary>
        /// Registers <see cref="ICompressionResolver" /> backed by <see cref="CompressionService" />. Idempotent; already called by
        ...
        /// </summary>
        /// <param name="configuration">Application configuration root.</param>
        /// <param name="policySectionPath">Section path (starts as <c>CompressionOptions:Policy</c>).</param>
        ...
        /// <summary>Registers <see cref="CompressionPolicyAlgorithmSelector" /> with programmatic <see cref="CompressionPolicyOptions" /> setup.</summary>
