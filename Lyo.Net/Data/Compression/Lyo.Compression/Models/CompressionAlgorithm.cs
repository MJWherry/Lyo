...
/// <summary>
/// Identifies which stream compression implementation to use. Maps to default file extensions and compressor bindings in <see cref="Constants.Data.AlgorithmExtensions" />
/// (see <c>Lyo.Compression.Constants.Data</c>).
/// </summary>
