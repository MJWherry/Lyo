...
/// <summary>Turns Code 128 subset B (ASCII 32 through 127) into a module row. False is white, true is black.</summary>
internal static class Code128Encoder
{
    /// <exception cref="ArgumentException">Raised when the payload is empty or contains characters Code 128 B cannot encode.</exception>
    internal static bool[] EncodeCode128B(string contents)
    {
        ...
        // ISO/IEC 15417 / GS1 checksum: (CodeStartB + Σ dataCode_i × weight_i) mod 103, with weights 1 through n for n data characters.
    ...
    /// <summary>Writes alternating black and white runs. The first run is black when <paramref name="startBlack" /> is true.</summary>
