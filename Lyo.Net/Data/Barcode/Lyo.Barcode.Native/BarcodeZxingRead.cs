...
/// <summary>Reads barcode images with ZXing. <see cref="NativeBarcodeService" /> uses this helper.</summary>
public static class BarcodeZxingRead
{
    /// <summary>Reads the first supported linear or 2D barcode found in an image.</summary>
