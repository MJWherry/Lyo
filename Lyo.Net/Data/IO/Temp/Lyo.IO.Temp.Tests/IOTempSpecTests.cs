...
public sealed class IOTempSpecTests : IDisposable
{
    ...
    [Fact]
    public void Builder_Creates_SpecWithFiles()
    {
    ...
    [Fact]
    public void Builder_Creates_SpecWithFileSizeUnit()
    {
    ...
    [Fact]
    public void Builder_Creates_SpecWithFileSizeSelector()
    {
    ...
    [Fact]
    public void Builder_Creates_SpecWithSubdirectories()
    {
    ...
    [Fact]
    public void Random_Creates_FilesWithinCountAndSizeRange()
    {
    ...
    [Fact]
    public void Random_WithFileSizeUnitInfo_CreatesCorrectRange()
    {
        using var session = _service.CreateSession();
    ...
    [Fact]
    public void FileSizeSelector_ControlsPerFile_Size()
    {
        using var session = _service.CreateSession();
