...
/// <summary>Rasterizes a PDF page, runs <see cref="IOcrEngine" />, and maps word boxes into PDF coordinates.</summary>
public sealed class PdfOcrService(IOcrEngine ocrEngine, IPdfPageRasterizer rasterizer, ILogger<PdfOcrService>? logger = null)
{
    ...
    /// <summary>
    /// Rasterizes <paramref name="pageNumber1Based" /> at <paramref name="dpi" />, runs OCR, then maps each <see cref="OcrWord" /> onto a <see cref="PdfWord" /> via
