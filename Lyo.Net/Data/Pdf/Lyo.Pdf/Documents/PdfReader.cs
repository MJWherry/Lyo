...
/// <summary>Caller-owned PdfPig reader plus <see cref="ITextExtractor" />; not safe for concurrent use.</summary>
public sealed class PdfReader : IPdfReader
{
    ...
    /// <summary>PdfPig document released when this reader is disposed.</summary>
