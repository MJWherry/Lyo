...
{
    /// <summary>Clamps key/value vertical band count (netstandard2.0 has no Math.Clamp).</summary>
    internal static int ClampKvColumnBandCount(int value) => value < 1 ? 1 : value > 32 ? 32 : value;

    /// <summary>Unique printable delimiter characters in encounter order; falls back to <c>:</c> and <c>;</c>.</summary>
