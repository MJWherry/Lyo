...
/// <summary>Pairs stroked horizontal paths with word boxes to mark vector underlines.</summary>
internal static class PdfUnderlineDetection
{
    /// <summary>Sets <see cref="PdfWordFormat.FontUnderline" /> when a candidate stroke crosses a band just below the word.</summary>
