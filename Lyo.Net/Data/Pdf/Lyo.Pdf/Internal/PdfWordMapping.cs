...
/// <summary>Converts PdfPig <c>Word</c> instances into Lyo <see cref="PdfWord" />.</summary>
internal static class PdfWordMapping
{
    ...
    public static IReadOnlyList<PdfWord> ToPdfWords(this IEnumerable<Word> words, IReadOnlyList<PdfPath> pagePaths)
    {
        ...
        return pagePaths.Count == 0 ? list : PdfUnderlineDetection.ApplyUnderlines(list, pagePaths);
    }
