...
/// <summary>PdfSharp-backed editable PDF; zero-based page indices; not safe for concurrent use.</summary>
public sealed class PdfWriter : IPdfWriter
{
    ...
    /// <summary>Owned PdfSharp document.</summary>
    ...
    /// <summary>Rebuilds the document from <paramref name="pageIndexesToTakeInOrder" /> (indices into the previous page list).</summary>
