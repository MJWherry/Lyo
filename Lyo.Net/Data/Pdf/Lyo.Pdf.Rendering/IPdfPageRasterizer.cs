...
/// <summary>Renders PDF pages to rasters (typically PNG).</summary>
public interface IPdfPageRasterizer
{
    /// <summary>Renders one page to PNG at the given DPI.</summary>
    /// <param name="pdfBytes">Entire PDF file as bytes.</param>
    /// <param name="pageNumber1Based">1-based page index.</param>
    /// <param name="dpi">Raster resolution on both axes.</param>
