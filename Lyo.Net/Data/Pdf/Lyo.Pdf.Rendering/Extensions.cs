...
/// <summary>DI helpers that register PDF rasterization services.</summary>
public static class PdfRenderingServiceCollectionExtensions
{
    /// <param name="services">The service collection.</param>
    extension(IServiceCollection services)
    {
        /// <summary>Registers <see cref="PdfToImagePageRasterizer" /> for <see cref="IPdfPageRasterizer" />.</summary>
