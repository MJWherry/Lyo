...
/// <summary>Opens a PDF in the browser for bounding-box annotation. Serves the file over HTTP and waits until the user submits regions.</summary>
public sealed class BrowserPdfAnnotator(ILogger<BrowserPdfAnnotator>? logger = null) : IPdfAnnotatorService
{
    ...
    {
        ArgumentHelpers.ThrowIfNull(pdfStream);
