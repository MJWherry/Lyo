...
public partial class LyoPdfAnnotator : IAsyncDisposable
{
    ...
    /// can treat the first column as the key.
    /// </summary>
    ...
    /// <summary>Distinct delimiter characters for <see cref="IPdfDocumentText.InferKeyValuePairsFromFormatting" />, or <c>null</c> to keep the defaults.</summary>
