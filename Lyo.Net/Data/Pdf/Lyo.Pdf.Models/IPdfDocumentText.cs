...
/// <summary>
/// Text, layout, and table extraction for one <see cref="IPdfReader" /> (via <see cref="IPdfReader.Text" />). Word-only overloads skip a PdfPig rescan; omitted tolerances
/// use <see cref="PdfServiceOptions" /> captured at load time.
/// </summary>
