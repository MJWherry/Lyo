...
/// <summary>
/// End-to-end behavior of <see cref="S3UploadStream" /> using a hand-rolled <see cref="IAmazonS3" /> stub so we can assert which upload path was selected (single PUT vs
