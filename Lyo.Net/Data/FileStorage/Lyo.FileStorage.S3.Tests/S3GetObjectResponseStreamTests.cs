...
/// <summary>Confirms the response-disposing read stream forwards reads and disposes the underlying <see cref="GetObjectResponse" /> once on both sync and async disposal.</summary>
public sealed class S3GetObjectResponseStreamTests
{
    ...
    public void Dispose_DisposesBackingStreamAndResponse_Once()
    {
        ...
        // Second dispose must be a no-op (no double-dispose throw from the base stream).
        wrapper.Dispose();
    }
