...
/// <summary>Adapts <see cref="ISftpClient" /> to the transport surface that <see cref="RemoteFileStorageServiceBase" /> uses.</summary>
/// <param name="client">Pooled SFTP client. Its root directory becomes the storage root.</param>
public sealed class SftpRemoteFileTransport(ISftpClient client) : IRemoteFileTransport
{
    private readonly ISftpClient _client = ArgumentHelpers.ThrowIfNullReturn(client);
