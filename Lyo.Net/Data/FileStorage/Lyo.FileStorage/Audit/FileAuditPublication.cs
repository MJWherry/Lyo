...
/// <summary>Raises file audit events to sync subscribers and DI-registered <see cref="IFileAuditEventHandler" /> instances, using the same failure policy as storage.</summary>
