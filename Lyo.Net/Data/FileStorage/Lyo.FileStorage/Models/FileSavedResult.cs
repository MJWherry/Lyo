...
/// <summary>
/// Event payload for <c>FileSaved</c>. <see cref="File" /> is a redacted snapshot — sensitive fields such as the wrapped DEK and KEK salt are omitted. Subscribers needing
/// those fields should call <c>GetMetadataAsync</c> through an authorized service.
/// </summary>
