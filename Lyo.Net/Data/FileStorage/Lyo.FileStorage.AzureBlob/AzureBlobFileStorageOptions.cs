...
/// <summary>Configuration for <see cref="AzureBlobFileStorageService" /> backed by Azure Blob Storage.</summary>
public sealed class AzureBlobFileStorageOptions : FileStorageServiceBaseOptions
{
    ...
    /// <summary>Legacy section name from <c>Lyo.FileStorage.Blob</c> before the AzureBlob rename.</summary>
    public const string LegacyBlobConfigurationSectionName = "BlobFileStorage";

    /// <summary>Legacy subsection name when migrating from the pre-<c>Lyo.FileStorage.AzureBlob</c> packages.</summary>
