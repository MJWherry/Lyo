...
public sealed class CloudObjectKeyBuilderTests
{
    ...
    public void Build_BlobPrefix_PrependsCorrectly()
    {
        ...
        var key = CloudObjectKeyBuilder.Build(id, extension: ".bin", pathPrefix: null, storagePrefix: "files");
    ...
    {
        var id = new Guid("12345678-1234-1234-1234-123456789012");
        var key = CloudObjectKeyBuilder.Build(id, extension: "");
    ...
    public void Build_WithExplicitPathPrefix_OverridesShardSplit()
    {
        ...
        var key = CloudObjectKeyBuilder.Build(id, extension: ".gz", pathPrefix: "tenant/alpha", storagePrefix: null);
