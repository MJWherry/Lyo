...
/// <summary>Reads file ids from projected query rows (dynamic JSON or Guid).</summary>
public static class FileStorageGridRowHelper
{
    ...
    /// <summary>UTC tombstone timestamp text, or empty when the file is active.</summary>
    ...
    /// <summary>Reads <c>PathPrefix</c> from a projected row; blank is treated as unset (default shard layout).</summary>
