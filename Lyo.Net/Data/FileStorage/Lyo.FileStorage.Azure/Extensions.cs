...
public static class Extensions
{
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddAzureFileStorageService(AzureFileStorageOptions options)
        {
        ...
        public IServiceCollection AddAzureFileStorageService(string configSectionName = AzureFileStorageOptions.SectionName)
        {
            ArgumentHelpers.ThrowIfNull(services);
        ...
        public IServiceCollection AddAzureMultipartUploadService()
        {
            ArgumentHelpers.ThrowIfNull(services);
