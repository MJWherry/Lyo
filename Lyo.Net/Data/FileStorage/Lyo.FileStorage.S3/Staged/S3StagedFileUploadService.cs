...
public sealed class S3StagedFileUploadService : IStagedFileUploadService
{
    ...
    private sealed class S3StagedFilePhysicalIo : IStagedFilePhysicalIo
    {
        ...
        public string BuildStageStorageLocation(Guid stageId, string? pathPrefix) => StagedObjectKeyBuilder.Build(stageId, pathPrefix, _options.KeyPrefix);
        ...
        public Task DeleteStageObjectAsync(StagedFileUploadRecord record, CancellationToken ct) => _s3.DeleteObjectAsync(_options.BucketName, record.StorageLocation, ct);
    }
}