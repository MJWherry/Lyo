...
/// <summary>Test sink that records every audit event for later inspection. Thread-safe enough for the single-test scope it is used in (xUnit serializes by default per class).</summary>
