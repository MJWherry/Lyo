...
/// the ad-hoc <c>Directory.CreateDirectory</c> + <c>try/finally</c> blocks that were copied across every test file.
/// </summary>
public sealed class LocalFileStorageTestScope : IDisposable
{
        ...
        ITwoKeyEncryptionService? twoKeyEncryptionService = null)
    {
        ...
        var storage = new LocalFileStorageService(
            ...
            auditHandlers: auditHandlers, contentPolicy: contentPolicy, metadataService: metadataService);
