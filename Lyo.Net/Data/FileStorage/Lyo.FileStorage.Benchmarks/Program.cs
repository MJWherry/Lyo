...
[assembly:
    BenchmarkReport(
        ...
        Description = "Local disk LocalFileStorageService save/get/delete throughput for Lyo.FileStorage. Save inputs use " +
            ...
            "Storage root lives under the suite IOTemp session from LyoBenchmarkBase. Every save also hashes (SHA-256) and " + "writes JSON metadata via LocalFileMetadataStore.")]
