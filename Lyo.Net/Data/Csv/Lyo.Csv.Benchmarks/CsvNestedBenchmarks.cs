...
/// <summary>Times CSV serialization/parsing of a record with nested reference members (the writer flattens nested objects into columns).</summary>
...
/// <summary>Record with nested reference members used to drive CSV flattening of nested objects.</summary>
...
/// <summary>Address nested on <see cref="NestedRecord" /> (writer flattens it into CSV columns).</summary>
...
/// <summary>Geo point nested inside <see cref="NestedAddress" /> (nesting depth 2).</summary>
