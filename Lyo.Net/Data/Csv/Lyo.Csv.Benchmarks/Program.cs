...
[assembly: BenchmarkReport(
    ...
    "CSV",
    Description =
        "CSV write and read paths for Lyo.Csv over a flat 7-column SampleRecord (int/string/decimal/bool/DateTime). "
        ...
        + "SampleRecord here is flat - nested objects/collections would add per-row flattening cost not represented "
        + "by row count alone.")]
