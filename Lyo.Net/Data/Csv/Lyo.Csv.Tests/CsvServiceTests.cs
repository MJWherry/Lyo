...
public class CsvServiceTests : IDisposable, IAsyncDisposable
{
    ...
    public void ExportToCsvBytes_UsesSpecifiedEncoding(string encodingName)
    {
        ...
        // Confirm the encoding by reading the bytes back
    ...
    // Feature 1: streaming parse coverage
    [Fact]
    ...
    // Feature 3: per-row error handling coverage
    [Fact]
    ...
    // Feature 4: CSV statistics coverage
    [Fact]
    ...
    // Feature 6: chunked/batch processing coverage
    [Fact]
    ...
    // Feature 7: CSV validation coverage
    [Fact]
    ...
    // Feature 8: column mapping coverage
    [Fact]
    ...
    // Feature 9: CSV comparison coverage
    [Fact]
    ...
    // Feature 10: append-to-CSV coverage
    [Fact]
    ...
    // Feature 12: multi-file operations coverage
    [Fact]
    ...
    // Feature 2: progress reporting coverage
    // Sync progress reporter so async callback timing does not flake
