...
/// <summary>Outcome of a CSV parse, plus CSV-specific fields.</summary>
/// <typeparam name="T">Type of objects parsed from CSV.</typeparam>
public sealed record CsvParseResult<T> : Result<IReadOnlyList<T>>
{
    /// <summary>File path that was parsed (if applicable).</summary>
    public string? FilePath { get; init; }

    /// <summary>Number of rows parsed.</summary>
    public int? RowCount { get; init; }

    /// <summary>Parse errors encountered (if any).</summary>
    ...
    /// <summary>Builds a successful CsvParseResult with parsed data.</summary>
    ...
    /// <summary>Builds a failed CsvParseResult from an exception.</summary>
    ...
    /// <summary>Builds a failed CsvParseResult with a custom error message.</summary>
