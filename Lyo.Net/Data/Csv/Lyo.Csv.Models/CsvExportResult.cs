...
/// <summary>Outcome of a CSV export, plus CSV-specific fields.</summary>
public sealed record CsvExportResult : Result<byte[]>
{
    /// <summary>File path where the CSV was exported (if applicable).</summary>
    public string? FilePath { get; init; }

    /// <summary>Number of rows exported.</summary>
    ...
    /// <summary>Builds a successful CsvExportResult with exported data.</summary>
    ...
    /// <summary>Builds a failed CsvExportResult from an exception.</summary>
    ...
    /// <summary>Builds a failed CsvExportResult with a custom error message.</summary>
