...
/// <summary>Reads, writes, and processes CSV files: export, import, validation, and batch operations.</summary>
public interface ICsvService
{
    /// <summary>Owned CSV writer used for export.</summary>
    ICsvWriter Writer { get; }

    /// <summary>Owned CSV reader used for parse and import.</summary>
    ICsvReader Reader { get; }

    /// <summary>Applies the encoding used for file and stream I/O.</summary>
    /// <param name="encoding">Encoding to apply. Must not be null.</param>
