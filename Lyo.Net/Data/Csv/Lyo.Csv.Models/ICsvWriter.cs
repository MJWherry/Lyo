...
/// <summary>Writes data as CSV. Supports enumerables, row/column dictionaries, <see cref="DataTable.Models.DataTable" />, property selection, and async export with progress.</summary>
