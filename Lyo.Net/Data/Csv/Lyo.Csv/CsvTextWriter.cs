...
/// <summary>Emits CSV fields and rows under <see cref="CsvOptions" /> delimiter, quote, and escape rules.</summary>
internal sealed class CsvTextWriter
    : IDisposable
#if !NETSTANDARD2_0
        , IAsyncDisposable
#endif
...
#if !NETSTANDARD2_0
    /// <summary>Writes a field via the sync path (preferred for memory and file streams).</summary>
