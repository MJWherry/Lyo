...
/// <summary>File metadata store backed by SQLite via Entity Framework Core. Matches <see cref="Postgres.PostgresFileMetadataStore" /> for embedded and local-dev use.</summary>
