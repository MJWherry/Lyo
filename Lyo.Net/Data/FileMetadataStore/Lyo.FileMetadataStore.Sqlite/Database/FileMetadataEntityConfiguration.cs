...
public class FileMetadataEntityConfiguration : IEntityTypeConfiguration<FileMetadataEntity>
{
    public void Configure(EntityTypeBuilder<FileMetadataEntity> builder)
    {
        ...
        builder.Property(e => e.Id).IsRequired().HasConversion(v => Guid.Parse(v), v => v.ToString()).HasColumnName("id");
        ...
        builder.Property(e => e.OriginalFileHash).IsRequired().HasColumnName("original_file_hash");
        ...
        builder.Property(e => e.SourceFileHash).IsRequired().HasColumnName("source_file_hash");
        ...
        builder.Property(e => e.CompressedFileHash).HasColumnName("compressed_file_hash");
        ...
        builder.Property(e => e.EncryptedFileHash).HasColumnName("encrypted_file_hash");
        builder.Property(e => e.EncryptedDataEncryptionKey).HasColumnName("encrypted_data_encryption_key");
        ...
        builder.Property(e => e.KeyEncryptionKeySalt).HasColumnName("key_encryption_key_salt");
        builder.Property(e => e.DekKeyMaterialBytes).HasColumnName("dek_key_material_bytes");
        ...
        builder.Property(e => e.Charset).HasMaxLength(64).HasColumnName("charset");
        ...
        builder.HasIndex(e => e.OwnerId).HasDatabaseName("ix_file_metadata_owner_id");
    }
}