...
/// <summary>EF Core <see cref="IStagedFileUploadStore" /> backed by the <c>staged_file_upload</c> SQLite table.</summary>
public sealed class SqliteStagedFileUploadStore : IStagedFileUploadStore
{
    private readonly IDbContextFactory<SqliteFileMetadataStoreDbContext> _dbFactory;

    public SqliteStagedFileUploadStore(IDbContextFactory<SqliteFileMetadataStoreDbContext> dbFactory)
    {
