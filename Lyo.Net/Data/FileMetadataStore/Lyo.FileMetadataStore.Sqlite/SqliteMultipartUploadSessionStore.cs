...
public sealed class SqliteMultipartUploadSessionStore : IMultipartUploadSessionStore
{
    private readonly IDbContextFactory<SqliteFileMetadataStoreDbContext> _dbFactory;

    public SqliteMultipartUploadSessionStore(IDbContextFactory<SqliteFileMetadataStoreDbContext> dbFactory)
    {
        ArgumentHelpers.ThrowIfNull(dbFactory);
