...
public class SqliteFileMetadataStoreTests
{
    private readonly FileMetadataSqliteFixture _fixture;

    public SqliteFileMetadataStoreTests(FileMetadataSqliteFixture fixture) => _fixture = fixture;
    ...
    public async Task SaveMetadataAsync_AndGetMetadataAsync_PersistsAndRetrieves()
    {
        ...
        var store = new SqliteFileMetadataStore(scope.ServiceProvider.GetRequiredService<SqliteFileMetadataStoreDbContext>());
    ...
    public async Task DeleteMetadataAsync_WhenExists_ReturnsTrue()
    {
        ...
        var store = new SqliteFileMetadataStore(context);
        var fileId = Guid.NewGuid();
