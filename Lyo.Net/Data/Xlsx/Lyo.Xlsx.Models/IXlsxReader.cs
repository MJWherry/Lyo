...
public interface IXlsxReader
{
    ...
    /// <summary>Parses the first worksheet into a Lyo data table (values + spans only; no cell styles). When <paramref name="useFooterRow" /> is true the last body row becomes <see cref="DataTable.Models.DataTable.Footer" />.</summary>
