...
/// <summary>
/// A cell value with optional merge spans extracted from XLSX.
/// Formatting is applied to <see cref="DataTable.Models.DataTable" /> via <see cref="DataTable.Models.DataTableCellFormat" />, not stored on this type.
/// </summary>
