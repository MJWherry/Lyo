...
/// <summary><see cref="IOptionsMonitor{TOptions}" /> sourced from one definition key on the shared <see cref="ResolvedConfigRecord" /> ledger.</summary>
    ...
    where TOptions : class, new()
{
    ...
    /// <inheritdoc />
    /// <remarks>Calls <paramref name="listener" /> right away with the cached value under <see cref="Options.DefaultName" />.</remarks>
    ...
    /// <remarks>Use <see cref="ResolvedConfigRecord.TryGetValue" /> so a missing key is handled by <see cref="ConfigApiMissingDefinitionKeyBehavior" />.</remarks>
