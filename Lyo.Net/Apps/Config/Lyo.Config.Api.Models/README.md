...
- **`IConfigApiClient`**, **`ConfigPolling`**, and DI registration **`AddConfigApiClientFromConfiguration`** live in **[`Lyo.Config.Api.Client`](../Lyo.Config.Api.Client)** ([`README`](../Lyo.Config.Api.Client/README.md)).
