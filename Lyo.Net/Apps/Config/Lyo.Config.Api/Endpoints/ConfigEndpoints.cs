...
internal static class ConfigEndpoints
{
    ...
    internal static RouteGroupBuilder MapLyoConfiguredEndpoints(this RouteGroupBuilder group)
    {
    ...
    private static RouteGroupBuilder MapPublicEndpoints(this RouteGroupBuilder parent)
    {
        parent.MapMethods(
                "/{appKind}/{appId}",
    ...
    private static RouteGroupBuilder MapManageEndpoints(this RouteGroupBuilder parent)
    {
        var manage = parent.MapGroup("/manage");
        ...
        manage.MapGet(
                ...
                async Task<Results<Ok<IReadOnlyList<ConfigBindingRecord>>, BadRequest<string>>> (
                    ...
                    if (!AppConfigEntity.TryCreate(appKind, appId, out var refs, out var msg))
                        return TypedResults.BadRequest(msg ?? string.Empty);
