...
/// <summary>Args for a component-rendered-to-bytes event.</summary>
[DebuggerDisplay("{ToString(),nq}")]
public sealed record ComponentRenderedToBytesResult(
    Type ComponentType,
    byte[] HtmlBytes,
    string Html,
    IReadOnlyDictionary<string, object>? ParameterDictionary,
