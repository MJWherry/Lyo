# Lyo.Web.Components.Export.Csv

Blazor/MudBlazor menu item that exports a Lyo data grid as CSV via `Lyo.Web.Components.Export`.
...
```csharp
@* add ExportCsvMenuItem to a LyoDataGrid toolbar *@
```
