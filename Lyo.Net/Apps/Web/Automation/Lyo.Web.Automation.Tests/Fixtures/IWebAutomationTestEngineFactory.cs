...
/// <summary>Creates automation sessions for a concrete engine (Selenium, Playwright, and so on) so shared contract tests can run against each implementation.</summary>
