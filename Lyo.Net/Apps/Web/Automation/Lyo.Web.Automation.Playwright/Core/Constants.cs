...
/// <summary>Shared constants for the WebAutomation.Playwright library.</summary>
public static class Constants
{
    /// <summary>Playwright-specific metric series (see <see cref="Automation.Core.Constants.Metrics" /> for the logical keys).</summary>
