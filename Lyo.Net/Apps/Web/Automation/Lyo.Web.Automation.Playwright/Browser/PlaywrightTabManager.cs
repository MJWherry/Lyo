...
/// <summary>Page and tab operations inside a Playwright <see cref="IBrowserContext" />.</summary>
public sealed class PlaywrightTabManager
{
    ...
    /// <summary>Returns the active tab snapshot.</summary>
    ...
    /// <summary>Lists every page in the context.</summary>
    ...
    /// <summary>Assigns a friendly display name for a page (keyed on <see cref="PlaywrightBrowserTabInfo.PageKey" />).</summary>
    ...
    /// <summary>Switches to the page at the given zero-based index.</summary>
    ...
    /// <summary>Switches to the page that has the given key (<see cref="PlaywrightBrowserTabInfo.PageKey" />).</summary>
    ...
    /// <summary>Opens a new page and optionally navigates to a URL.</summary>
        ...
        await RunTabOpAsync(
                "open_page", async () => {
                    ...
                    if (!url.IsNullOrWhitespace())
                        await page.GotoAsync(url, new() { WaitUntil = _browser.Options.NavigationWaitUntil }).ConfigureAwait(false);
    ...
    /// <summary>Closes the current page and activates another when any remain.</summary>
