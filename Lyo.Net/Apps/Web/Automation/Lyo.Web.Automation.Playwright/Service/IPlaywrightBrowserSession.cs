...
/// <summary>Playwright browser scope; dispose to release resources. Extends <see cref="IWebAutomationSession" /> with tab handling.</summary>
public interface IPlaywrightBrowserSession : IWebAutomationSession
{
    ...
    /// <summary>
    /// Tab and page handling (same as <see cref="PlaywrightBrowser.NativeTabs" />); engine-native APIs beyond <see cref="Lyo.Web.Automation.Abstractions.IWebAutomationTabs" />
    /// .
    /// </summary>
