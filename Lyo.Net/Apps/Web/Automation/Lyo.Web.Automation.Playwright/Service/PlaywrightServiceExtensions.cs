...
{
    /// <summary>Adds <see cref="PlaywrightBrowserOptions" /> and a scoped <see cref="PlaywrightBrowser" /> for direct injection.</summary>
    ...
    /// <summary>
    /// Adds <see cref="PlaywrightBrowserOptions" />, scoped <see cref="PlaywrightBrowser" />, and singleton <see cref="IPlaywrightBrowserService" /> for session-based
    /// usage.
    /// </summary>
    ...
    /// <summary>Adds explicit options plus <see cref="IPlaywrightBrowserService" />.</summary>
    ...
    /// <summary>Adds explicit options and a scoped <see cref="PlaywrightBrowser" />.</summary>
    ...
    {
        var opts = sp.GetRequiredService<PlaywrightBrowserOptions>().Clone();
