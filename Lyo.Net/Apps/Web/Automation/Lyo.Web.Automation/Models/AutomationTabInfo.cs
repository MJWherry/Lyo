...
/// <summary>
/// Engine-neutral snapshot of one tab or page (see <see cref="Lyo.Web.Automation.Abstractions.IWebAutomationTabs" />). <see cref="TabKey" /> is opaque: Selenium window handle
