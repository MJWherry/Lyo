...
/// <summary>What to do with a resolved element (JSON polymorphic on the <c>type</c> field).</summary>
...
/// <summary>Sends keys without a prior clear (use for special key sequences).</summary>
[DebuggerDisplay("{ToString(),nq}")]
...
/// <summary>
/// Generic dropdown: native <c>&lt;select&gt;</c> or a custom menu. Default <see cref="DropdownElementAction.Mode" /> is <see cref="DropdownSelectionMode.Auto" /> (uses tag
/// name).
/// </summary>
[DebuggerDisplay("{ToString(),nq}")]
