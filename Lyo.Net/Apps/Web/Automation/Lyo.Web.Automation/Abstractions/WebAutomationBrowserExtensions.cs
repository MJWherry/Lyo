...
/// <summary>Convenience utility methods for <see cref="IWebAutomationBrowser" />, <see cref="IBrowserCookies" />, and <see cref="IBrowserHeaders" />.</summary>
public static class WebAutomationBrowserExtensions
{
    /// <summary>Yields cookies via <see cref="IWebAutomationBrowser.CookieJar" />, or an empty list when not supported.</summary>
    ...
    /// <summary>Returns session cookies formatted as a <c>Cookie</c> header value (for example <c>"name=value; name2=value2"</c>), or <see langword="null" /> when not
    /// supported.</summary>
