...
/// <summary>Engine-neutral element handle for automation plans (implemented by Selenium, Playwright, and so on).</summary>
public interface IWebAutomationElement
{
    ...
    /// <summary>DOM attribute value (for example <c>src</c>, <c>href</c>, <c>data-*</c>); <see langword="null" /> when absent.</summary>
