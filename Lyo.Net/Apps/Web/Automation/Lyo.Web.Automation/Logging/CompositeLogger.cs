...
/// <summary>Fans log calls out to two <see cref="ILogger" /> instances. Writes to both the injected application logger and the per-session file logger at the same time.</summary>
