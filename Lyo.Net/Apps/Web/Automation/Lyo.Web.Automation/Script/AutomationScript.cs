...
/// <summary>A named step in a delegate-based automation script (see <see cref="AutomationScriptBuilder" />).</summary>
...
/// <summary>Optional retry policy for one step.</summary>
[DebuggerDisplay("{ToString(),nq}")]
...
/// <summary>Fluent configuration for <see cref="AutomationScriptRetryPolicy" /> (similar to the query builders).</summary>
...
/// <summary>Fluent builder for sequences of <see cref="AutomationScriptStep" />.</summary>
...
/// <summary>
/// Runs <see cref="AutomationScriptStep" /> sequences using structured logging scopes and optional retries (calls <see cref="IWebAutomationSession.StartBrowserAsync" />
/// first).
/// </summary>
public static class AutomationScriptRunner
{
    /// <summary>Runs each step in order using the session's cancellation token.</summary>
