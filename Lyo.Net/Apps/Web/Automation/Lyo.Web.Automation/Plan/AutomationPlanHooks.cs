...
/// <summary>Correlation fields for nested logging during a step (file I/O, downloads) when the ambient logger scope may not flow (for example <see cref="Task.Run(Action)"
/// />).</summary>
