...
/// <summary>Per-run files under <see cref="AutomationPlanRunDirectoryOptions.RootDirectory" /> (log transcript, PNGs, and variable JSON).</summary>
internal sealed class AutomationPlanRunArtifacts : IDisposable
{
    ...
    private static string SanitizeFileName(string value) => PathHelpers.SanitizeFileName(value) ?? "unnamed";
