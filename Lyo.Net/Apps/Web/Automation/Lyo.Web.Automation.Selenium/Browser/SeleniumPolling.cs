...
/// <see cref="SeleniumBrowser.GetElementAsync(OpenQA.Selenium.By,System.Threading.CancellationToken)" /> (and chained resolution on <see cref="SeleniumBrowser" />).
/// </summary>
internal static class SeleniumPolling
{
    /// <summary>A single bounded <see cref="WebDriverWait" /> for <paramref name="by" />.</summary>
    ...
    /// <summary>Waits for <paramref name="by" /> relative to <paramref name="context" /> (a nested search).</summary>
