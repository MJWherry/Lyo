...
public interface ISeleniumBrowserService : IDisposable
{
    ...
    /// <summary>
    /// Creates a new browser session with a dedicated <see cref="SeleniumBrowser" />; call <see cref="IWebAutomationSession.StartBrowserAsync" /> before navigation (or use
    /// automation runners, which start the browser for you).
    /// </summary>
    /// <param name="sessionOptions">If null, uses a clone of the registered <see cref="SeleniumBrowserOptions" />.</param>
