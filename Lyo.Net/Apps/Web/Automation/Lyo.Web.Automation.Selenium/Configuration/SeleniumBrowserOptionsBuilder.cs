...
/// <summary>Fluent builder for <see cref="SeleniumBrowserOptions" /> (chain <see cref="Headless" />, <see cref="WindowSize" />, <see cref="Home" />, and so on).</summary>
public sealed class SeleniumBrowserOptionsBuilder
{
    ...
    /// <summary>Yields a deep copy of the configured options (safe to mutate independently).</summary>
    ...
    /// <inheritdoc cref="SeleniumBrowserOptions.RandomizeViewportOnSessionStart" />
    public SeleniumBrowserOptionsBuilder RandomizeViewportOnSessionStart(bool enabled = true)
    {
        _options.RandomizeViewportOnSessionStart = enabled;
        return this;
    }

    /// <inheritdoc cref="SeleniumBrowserOptions.ViewportJitterPixels" />
    public SeleniumBrowserOptionsBuilder ViewportJitterPixels(int pixels)
    {
        ArgumentHelpers.ThrowIfNegative(pixels);
        _options.ViewportJitterPixels = pixels;
        return this;
    }
    ...
    {
        ArgumentHelpers.ThrowIfNotInRange(delay, TimeSpan.Zero);
    ...
    /// <summary>Appends a user agent string (besides the default rotating list).</summary>
