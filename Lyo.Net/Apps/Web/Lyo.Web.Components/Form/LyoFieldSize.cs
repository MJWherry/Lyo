...
/// (bools, numerics, and times are narrow; strings are wide).
/// </summary>
public enum LyoFieldSize
{
    /// <summary>Derive column width from the property type.</summary>
    Auto,
    ...
    /// <summary>Full-width row, for multiline text and editors (xs=12).</summary>
    Full
}