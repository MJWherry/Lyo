...
/// <summary>Docs catalog package record (mirrors <c>docs/catalog/schema/package.schema.json</c>).</summary>
...
/// <summary>A single dependency row from a generated package catalog document.</summary>
...
/// <summary>A code sample under Examples.</summary>
...
/// <summary>Optional block of benchmarks.</summary>
...
/// <summary>A benchmark link row.</summary>
...
/// <summary>A related link.</summary>
...
/// <summary>Discriminated section (paragraph, list, code, or markdown).</summary>
...
/// <summary>A catalog index row from <c>wwwroot/catalog/index.json</c>.</summary>
...
/// <summary>A lightweight package row in the catalog index.</summary>
...
/// <summary>Shared JSON settings for catalog files.</summary>
