...
public interface IDataGridExportHost
{
    ...
    /// <summary>If set, column selector derives fields from type reflection (typed grids).</summary>
    Type? ExportDataType { get; }

    /// <summary>If set, column selector uses these field paths (projected grids).</summary>
