# Lyo.Web.Components.Export.Xlsx

Blazor/MudBlazor menu item that exports a Lyo data grid as XLSX via `Lyo.Web.Components.Export`.
...
```csharp
@* add ExportXlsxMenuItem to a LyoDataGrid toolbar *@
```
