...
public static class SeriesEndpoints
{
    ...
    private static async Task<IResult> GetSeriesById(Guid id, IComicStore store, ComicEnrichmentService enricher, CancellationToken ct = default)
    {
    ...
    private static async Task<IResult> GetSeriesBySlug(string slug, IComicStore store, ComicEnrichmentService enricher, CancellationToken ct = default)
    {
    ...
    private static async Task<IResult> Search(ComicSeriesQuery query, IComicStore store, ITagStore tagStore, ComicEnrichmentService enricher, CancellationToken ct = default)
    {
    ...
    private static async Task<IResult> GetChapters(Guid id, IComicStore store, string? language = null, CancellationToken ct = default)
    {
