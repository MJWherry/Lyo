...
/// <summary>Worker instance register and heartbeat calls for the job worker grid.</summary>
public sealed class JobWorkerInstanceClient(IApiClient client, string? routePrefix = null)
{
    private string Route => ApiRouteBuilder.Build(routePrefix, JobRoutes.WorkerInstances);
    ...
    /// <summary>Patches heartbeat fields. When <paramref name="metadata"/> is given it replaces the stored bag (used to refresh working set / GC heap).</summary>
