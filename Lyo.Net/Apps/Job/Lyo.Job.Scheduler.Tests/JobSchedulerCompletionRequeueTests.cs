...
/// <summary>
/// Completion-queue poison handling: 404 acks, 500s use a counted envelope requeue (max 3) instead of an unbounded broker nack, and unparseable bytes are discarded.
/// </summary>
