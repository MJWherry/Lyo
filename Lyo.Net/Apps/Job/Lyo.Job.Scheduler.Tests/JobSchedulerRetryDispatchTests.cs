...
/// delayed one), retry/trigger creation is idempotent across duplicate completion messages, timeouts count as failures, and deleted definitions are evicted from the in-memory
/// cache
/// on 404.
/// </summary>
