...
Thin host: AddPostgresDriftManagementFromConfiguration, AddDriftRetentionService, and BuildDriftGroup. Prefer embedding those calls in another host when composing APIs.
