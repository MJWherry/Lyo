...
/// <summary>
/// Runs the default model build (<c>OnModelCreating</c>), then applies <see cref="CrossSchemaNavigationOptionsExtension" /> registrations so hosts can add same-DB or
...
{
    /// <summary>Creates a customizer that takes EF Core dependencies.</summary>
