...
/// <summary>Fluent registration of same-context and cross-schema navigations on <typeparamref name="TContext" />.</summary>
    ...
    where TContext : DbContext
{
    ...
    /// <summary>
    /// Adds a relationship to a related type already mapped on <typeparamref name="TContext" /> (same database model). Does not change table mapping or migrations.
    /// </summary>
    ...
    {
        ArgumentHelpers.ThrowIfNull(expression);
