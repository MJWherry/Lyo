...
/// <summary>Holds DI-registered cross-schema navigations on <see cref="Microsoft.EntityFrameworkCore.DbContextOptions" /> for the model customizer.</summary>
public sealed class CrossSchemaNavigationOptionsExtension : IDbContextOptionsExtension
{
    /// <summary>Navigations applied after <c>OnModelCreating</c>.</summary>
    public IReadOnlyList<CrossSchemaNavigationRegistration> Registrations { get; }

    /// <summary>Creates an extension that holds the given registrations.</summary>
