...
/// <summary>HTTP-aware helpers for <see cref="LyoProblemDetailsBuilder" /> (trace plus RFC 7807 <c>instance</c>).</summary>
public static class LyoProblemDetailsBuilderHttpExtensions
{
    /// <summary>Fills trace and span from <see cref="Activity.Current" /> (when present) and <c>instance</c> from the request path.</summary>
