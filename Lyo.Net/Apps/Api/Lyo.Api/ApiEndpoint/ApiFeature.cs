...
public sealed record ApiFeatureSet : IEnumerable<ApiFeature>
{
    ...
    /// <summary>Standard CRUD plus bulk endpoints (no Export, Metadata, or ProjectionComputedFields).</summary>
    ...
    /// <summary>Default dynamic/typed CRUD preset: <see cref="CoreAll" /> plus upsert and patch inheritance flags.</summary>
