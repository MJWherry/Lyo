...
/// <summary>
/// Fluent settings for
/// <see cref="ApiEndpointBuilder{TDbContext,TDbEntity,TRequest,TResponse,TKey}.WithCreate(Action{CreateEndpointConfigBuilder{TRequest,TDbEntity,TDbContext}})" />.
/// </summary>
...
/// <summary>
/// Fluent settings for <see cref="ApiEndpointBuilder{TDbContext,TDbEntity,TRequest,TResponse,TKey}.WithGet(Action{GetEndpointConfigBuilder{TDbEntity,TDbContext}})" />.
/// </summary>
...
/// <summary>
/// Fluent settings for
/// <see cref="ApiEndpointBuilder{TDbContext,TDbEntity,TRequest,TResponse,TKey}.WithUpdate(Action{UpdateEndpointConfigBuilder{TRequest,TDbEntity,TDbContext}})" />.
/// </summary>
    ...
    where TDbContext : DbContext where TEntity : class
{
    ...
    /// <summary>Per-property write rules applied to the properties this update actually changes.</summary>
    public UpdateEndpointConfigBuilder<TRequest, TEntity, TDbContext> PropertyAuthorization(PatchPropertyAuthorization authorization)
    {
        PropertyRules = authorization;
        return this;
    }

    /// <summary>Per-property write rules taken from a policy-to-property map.</summary>
    public UpdateEndpointConfigBuilder<TRequest, TEntity, TDbContext> PropertyAuthorization(Action<PatchPropertyAuthorizationBuilder> configure)
    {
...
/// <summary>
/// Fluent settings for <see cref="ApiEndpointBuilder{TDbContext,TDbEntity,TRequest,TResponse,TKey}.WithPatch(Action{PatchEndpointConfigBuilder{TDbEntity,TDbContext}})" />.
/// </summary>
...
/// <summary>
/// Fluent settings for <see cref="ApiEndpointBuilder{TDbContext,TDbEntity,TRequest,TResponse,TKey}.WithDelete(Action{DeleteEndpointConfigBuilder{TDbEntity,TDbContext}})" />.
/// </summary>
...
/// <summary>
/// Fluent settings for
/// <see cref="ApiEndpointBuilder{TDbContext,TDbEntity,TRequest,TResponse,TKey}.WithUpsert(Action{UpsertEndpointConfigBuilder{TRequest,TDbEntity,TDbContext}})" />.
/// </summary>
    ...
    where TDbContext : DbContext where TEntity : class
{
    ...
    /// <summary>Per-property write rules applied to the properties this upsert actually changes.</summary>
    public UpsertEndpointConfigBuilder<TRequest, TEntity, TDbContext> PropertyAuthorization(PatchPropertyAuthorization authorization)
    {
        PropertyRules = authorization;
        return this;
    }
    ...
    /// <summary>Per-property write rules taken from a policy-to-property map.</summary>
    public UpsertEndpointConfigBuilder<TRequest, TEntity, TDbContext> PropertyAuthorization(Action<PatchPropertyAuthorizationBuilder> configure)
    {
        PropertyRules = PatchPropertyAuthorization.ForPolicies(configure);
        return this;
    }
...
/// <summary>
/// Fluent settings for <see cref="ApiEndpointBuilder{TDbContext,TDbEntity,TRequest,TResponse,TKey}.WithQuery(Action{QueryEndpointConfigBuilder{TDbEntity}})" /> (group name
/// and default order are set by the endpoint builder).
/// </summary>
public sealed class QueryEndpointConfigBuilder<TDbEntity>
{
    ...
    /// <summary>Turns on SmartFormat computed fields on QueryProject (same as <c>WithProjectionComputedFields()</c> after query is registered).</summary>
...
/// <summary>
/// Fluent settings for <see cref="ApiEndpointBuilder{TDbContext,TDbEntity,TRequest,TResponse,TKey}.WithExport(Action{ExportEndpointConfigBuilder{TDbEntity}})" />.
/// </summary>
...
/// <summary>
/// Fluent settings for
/// <see cref="ApiEndpointBuilder{TDbContext,TDbEntity,TRequest,TResponse,TKey}.WithMetadata(Action{MetadataEndpointConfigBuilder{TDbContext,TDbEntity}})" />.
/// </summary>
