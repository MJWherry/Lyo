...
/// <summary>Builds <see cref="LyoProblemDetails" /> envelopes with RFC 7807 <c>instance</c> and an optional <c>keys</c> extension for not-found and error responses.</summary>
public static class ApiErrorResponseFactory
{
    /// <summary>Merges <paramref name="error" /> with the request path as <c>instance</c> and optional <c>keys</c> in extensions.</summary>
    ...
    /// <summary>Produces a not-found problem with trace and instance populated from <paramref name="httpContext" />.</summary>
    ...
    /// <summary>Builds a problem via <see cref="CreateForError" /> and throws <see cref="ApiErrorException" /> so middleware can write and log it.</summary>
    ...
    /// <summary>Builds a not-found problem and throws <see cref="ApiErrorException" /> so middleware can write and log it.</summary>
    [System.Diagnostics.CodeAnalysis.DoesNotReturn]
