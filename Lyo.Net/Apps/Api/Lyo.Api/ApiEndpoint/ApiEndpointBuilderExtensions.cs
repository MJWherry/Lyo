...
public static class ApiEndpointBuilderExtensions
{
    ...
    /// <summary>Same as <see cref="WithReadOnlyEndpoints{TDbContext,TDbEntity,TResponse,TKey}" /> when <c>TKey</c> is <c>Guid</c>.</summary>
    ...
    /// <summary>Route template suffix for GET/DELETE by primary key (for example <c>/{id:guid}</c> for <see cref="Guid" />).</summary>
    ...
    extension(WebApplication app)
    {
        ...
        /// <param name="baseRoute">URL prefix without a trailing slash (for example <c>api/items</c>).</param>
        ...
        /// <summary>
        /// Starts a typed CRUD endpoint group for <typeparamref name="TDbEntity" /> with request/response DTOs and primary-key type <typeparamref name="TKey" />.
        /// </summary>
        /// <param name="baseRoute">URL prefix without a trailing slash.</param>
        /// <param name="groupName">OpenAPI / endpoint group display name.</param>
        ...
        /// <summary>
        /// Starts a read-only typed builder (<c>TRequest = object</c>, <c>TKey = Guid</c>). Call <see cref="WithReadOnlyEndpoints{TDbContext,TDbEntity,TResponse}" /> or an equivalent.
        /// </summary>
        ...
        /// <summary>Starts a read-only typed builder with an explicit <typeparamref name="TKey" /> for GET/DELETE routes.</summary>
