...
/// <summary>Shared dependencies and helpers used by CRUD services: context factory, mapper, logging scopes, and API-shaped errors.</summary>
    ...
    where TContext : DbContext
{
    ...
    /// <summary>Maps source to TResult, or casts when TSource and TResult are the same type (mapping is skipped).</summary>
    ...
    /// CRUD endpoints deserialize request bodies into the entity type itself, so update/upsert would otherwise ask the mapper for an entity-to-entity mapping that domain mappers do not
    /// configure.
    /// </summary>
