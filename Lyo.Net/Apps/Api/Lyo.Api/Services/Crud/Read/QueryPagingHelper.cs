...
/// <summary>Result of an ID-first include paging attempt.</summary>
public sealed record IdFirstPagingResult<TDbModel>(TDbModel[] Results, bool HasMore)
    where TDbModel : class;

/// <summary>Handles paging, ID-first include paging, and batch hydration. Shared with QueryService.</summary>
...
/// <summary>Handles paging, ID-first include paging, and batch hydration for query execution.</summary>
