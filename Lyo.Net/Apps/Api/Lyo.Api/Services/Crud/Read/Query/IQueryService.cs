...
/// <summary>
/// Query and get operations: filtered, sorted, and paged <see cref="QueryConcreteReq" />, projected <see cref="ProjectionQueryReq" />, and single-entity loads with optional
/// includes.
/// </summary>
public interface IQueryService<TContext>
    where TContext : DbContext
{
    /// <summary>Runs a query and maps each row to <typeparamref name="TResult" /> via <see cref="ILyoMapper" />.</summary>
    ...
    /// <summary>Returns raw entities without mapping. Entities stay untracked by the context.</summary>
    ...
    /// <summary>Runs <see cref="ProjectionQueryReq" /> (sparse <c>Select</c>, optional computed fields) and returns the projected rows.</summary>
    ...
    /// <summary>Loads one entity by primary key values, applies optional hooks, and maps to <typeparamref name="TResult" />.</summary>
