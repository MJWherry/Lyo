...
/// <summary>Per-context map of allowlisted entity type names to CLR/EF metadata, built when endpoints are mapped.</summary>
public sealed class RootQueryEntityRegistry
{
        ...
        where TContext : DbContext
    {
        ...
        foreach (var clr in allowlistedEntityTypes.Distinct()) {
            ...
            // Accept short names used in clients (Person and PersonEntity).
...
/// <summary>One allowlisted entity used by root Query.</summary>
