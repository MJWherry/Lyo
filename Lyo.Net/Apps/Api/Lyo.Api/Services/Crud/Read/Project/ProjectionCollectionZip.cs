...
{
    /// <summary>Builds merge steps: unified root collection (mixed path depths), sibling merges under a common prefix, then augment from parallel columns (including computed).</summary>
