...
/// <summary>Checks <c>Start</c> / <c>Amount</c> against <see cref="QueryOptions" /> min/max bounds.</summary>
public static class QueryPagingBoundsValidator
{
    /// <summary>Standard list, query, or projected query. <paramref name="maxAmount" /> is typically <see cref="QueryOptions.MaxPageSize" />.</summary>
