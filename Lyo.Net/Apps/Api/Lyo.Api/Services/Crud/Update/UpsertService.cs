    ...
    where TContext : DbContext
{
        ...
        where TDbModel : class
    {
        ...
        // For a single upsert, just update the first entity.
        ...
        where TDbModel : class
    {
        try {
            ...
            foreach (var request in requests) {
                ...
                // Update every matching entity when AllowMultiple is true.
            ...
            // Replace placeholders with the actual results.
        ...
        where TDbModel : class
    {
        ...
        // Partial retry: distinct PKs cannot be collected reliably for granular invalidation.
        ...
        where TDbModel : class
    {
        try {
            ...
            // For an individual retry, just upsert the first entity.
            var entity = entities[0];
