...
/// <summary>Adds the XLSX export format handler.</summary>
public static class Extensions
{
    extension(IServiceCollection services)
    {
        /// <summary>Adds <see cref="XlsxExportFormatHandler" /> as an <see cref="IExportFormatHandler" />. Needs <see cref="Lyo.Xlsx.Models.IXlsxService" />.</summary>
