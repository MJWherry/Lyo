...
public static class QueryRequestScorer
{
    ...
    /// <summary>Scores a list of paths (Include or Select). Counts navigations (.), wildcards (*), depth, and segment count.</summary>
    ...
    /// <summary>Scores computed columns: a base per formatted field plus cost for distinct placeholder refs across templates.</summary>
    ...
    /// <summary>Mutable accumulator used while walking query nodes; converted to immutable WhereClauseAnalysis when done.</summary>
