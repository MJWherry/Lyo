...
/// <summary>End-to-end checks for <see cref="LoggingMiddleware" /> exception-to-status mapping and the empty-body problem details fallback, using an in-memory test
/// server.</summary>
