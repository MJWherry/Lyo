...
public sealed class PatchPropertyAuthorizationTests
{
    ...
    public void TryGetForbiddenPropertyKeys_UnionOfSucceedingPolicies_AllowsUnion()
    {
        var policyMap = new Dictionary<string, IReadOnlySet<string>>(StringComparer.Ordinal) {
            ["User"] = new HashSet<string>(StringComparer.OrdinalIgnoreCase) { "Name", "Email" }, ["Admin"] = new HashSet<string>(StringComparer.OrdinalIgnoreCase) { "RoleId" }
        };
    ...
    {
        var policyMap = new Dictionary<string, IReadOnlySet<string>>(StringComparer.Ordinal) { ["User"] = new HashSet<string>(StringComparer.OrdinalIgnoreCase) { "Name" } };
    ...
    {
        var policyMap = new Dictionary<string, IReadOnlySet<string>>(StringComparer.Ordinal) { ["Editor"] = new HashSet<string>(StringComparer.OrdinalIgnoreCase) { "*" } };
