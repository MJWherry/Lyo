...
/// <summary>Twilio SMS log grid (projected) with an inline conversation pane for the two numbers on a row.</summary>
public partial class TwilioSmsLogGrid
{
    ...
    private readonly List<FilterPropertyDefinition> _propertyDefinitions = [
        ...
        new("DateSent", "Sent", LyoTypeInfo.DateTime), new("CreatedTimestamp", "Logged", LyoTypeInfo.DateTime)
    ];
    ...
    /// <summary>Client for QueryProject reads and for inserting a log row after send.</summary>
    [Parameter]
    [EditorRequired]
    public IApiClient ApiClient { get; set; } = null!;

    /// <summary>Dynamic CRUD prefix for the Twilio SMS DbContext (defaults to <c>Twilio</c>).</summary>
    [Parameter]
