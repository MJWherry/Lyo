# Lyo.Job.Worker.Example

Standalone example worker. Reports lifecycle to the Job API (typically Lyo.TestApi). Not packed to NuGet.
...
```csharp
dotnet run --project Lyo.Net/Examples/Lyo.Job.Worker.Example
```
