# Lyo.Drift.Agent.Example

Runnable example for `Lyo.Drift.Agent`. Not packed to NuGet.
...
```csharp
dotnet run --project Lyo.Net/Examples/Lyo.Drift.Agent.Example
```
...
- `Lyo.FileSystemWatcher` (transitive, lyo)
