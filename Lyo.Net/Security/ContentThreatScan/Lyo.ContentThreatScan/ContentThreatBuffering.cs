...
/// <summary>Stream-buffering helpers used by malware adapters.</summary>
public static class ContentThreatBuffering
{
    /// <returns>Copied bytes limited to the max length; the stream position moves forward.</returns>
