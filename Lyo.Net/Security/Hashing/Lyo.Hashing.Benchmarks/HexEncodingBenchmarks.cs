...
/// <summary>Hex encode/decode round-trips over digest-sized buffers.</summary>
[BenchmarkDescription("Hex encode (lowercase) and decode of digest-sized seeded buffers; isolates the encoding cost from the hash itself.")]
...
public class HexEncodingBenchmarks
{
    ...
    public void Setup()
    {
        _digest = BenchmarkData.DeterministicBytes(DigestSize);
