...
{
    /// <summary>SHA-2 digest of <paramref name="data" />. Supported <paramref name="digestBits" />: <c>256</c>, <c>384</c>, <c>512</c>.</summary>
    ...
    /// <summary>SHA-2 digest of bytes from <paramref name="stream" /> (current position through EOF). Does not close or dispose <paramref name="stream" />.</summary>
    ...
    /// <summary>MD5 digest of a stream (current position through end). <strong>Not for security</strong>. Does not dispose <paramref name="stream" />.</summary>
