...
/// <summary>Adler-32 (zlib / RFC 1950). Two 16-bit sums modulo 65521 packed as <c>(b &lt;&lt; 16) | a</c>. Check value of <c>"123456789"</c> is <c>0x091E01DE</c>.</summary>
internal sealed class Adler32Calculator : ChecksumCalculator
{
    private const uint ModAdler = 65521u;

    // Longest run that can be folded before the b accumulator overflows a 32-bit register.
