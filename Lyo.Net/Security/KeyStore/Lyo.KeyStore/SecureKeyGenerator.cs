...
/// <summary>Helpers for generating secure encryption keys.</summary>
public static class SecureKeyGenerator
{
    /// <summary>Generates a cryptographically secure random key.</summary>
    /// <param name="sizeInBytes">Key size in bytes. Default is 32 (256 bits).</param>
    ...
    /// <summary>Generates a key plus an associated salt for key derivation.</summary>
    /// <param name="sizeInBytes">Key size in bytes. Default is 32 (256 bits).</param>
    /// <param name="saltSizeInBytes">Salt size in bytes. Default is 16 (128 bits).</param>
    /// <returns>A tuple of the generated key and salt</returns>
    ...
    /// <param name="sizeInBytes">Nonce size in bytes. Default is 12 (96 bits).</param>
