...
public class XChaCha20Poly1305EncryptionBenchmarks
{
    ...
    [Benchmark] public byte[] Encrypt_1KB() => _encryptionService.Encrypt(_smallData, key: _key);
    [Benchmark] public byte[] Encrypt_1MB() => _encryptionService.Encrypt(_mediumData, key: _key);
    [Benchmark] public byte[] Encrypt_10MB() => _encryptionService.Encrypt(_largeData, key: _key);
    [Benchmark] public byte[] Decrypt_1KB() => _encryptionService.Decrypt(_encryptedSmall, key: _key);
    [Benchmark] public byte[] Decrypt_1MB() => _encryptionService.Decrypt(_encryptedMedium, key: _key);
    [Benchmark] public byte[] Decrypt_10MB() => _encryptionService.Decrypt(_encryptedLarge, key: _key);
}
