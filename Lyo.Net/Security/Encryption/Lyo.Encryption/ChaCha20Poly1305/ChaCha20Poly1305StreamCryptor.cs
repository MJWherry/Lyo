...
/// <summary>ChaCha20-Poly1305 instance kept for every chunk of one streaming call (see <see cref="IAeadStreamCryptor" />).</summary>
...
#else
    // one cipher, one key schedule, and grow-once scratch for the stream; only Init (cheap) runs per chunk.
