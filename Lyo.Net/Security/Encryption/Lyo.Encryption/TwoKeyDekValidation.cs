...
public static class TwoKeyDekValidation
{
    ...
    /// <summary>
    /// Describes valid plaintext key material sizes for a symmetric <see cref="EncryptionAlgorithm" /> (same rules as DEK/KEK when both are symmetric). KEK material size is not
    /// stored in the two-key header; this lists what the unwrap key must be.
    /// </summary>
