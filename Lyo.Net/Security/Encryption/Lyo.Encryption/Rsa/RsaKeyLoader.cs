...
public static class RsaKeyLoader
{
    ...
    /// <summary>Loads an RSA public-only instance from a SubjectPublicKeyInfo PEM. Use for encrypt-only.</summary>
    ...
    /// <summary>Loads an RSA instance with the private key from a PKCS#8 PEM. Use for decrypt.</summary>
