...
/// <summary>
/// Dependency-injection extensions for the XChaCha20-Poly1305 addon. Mirrors the keyed-registration shape from <see cref="EncryptionServiceExtensions" /> but specialized to
...
public static class XChaCha20Poly1305EncryptionServiceExtensions
{
    ...
    {
        /// <summary>
        /// Registers <see cref="XChaCha20Poly1305EncryptionService" /> as a singleton resolved from the provided <see cref="IKeyStore" />. Use
