...
/// <summary>Protects single-shot wire compatibility and the allocation floor after MemoryStream/ToArray was removed.</summary>
public sealed class SingleShotFramingTests
{
    ...
    public void AesGcm_Encrypt_1MiB_AllocatesLessThan125PercentOfPayload()
    {
        ...
        // warm JIT / paths so first-call noise does not dominate the measurement.
    ...
    /// <summary>Surfaces <see cref="EncryptionServiceBase" /> BinaryWriter-string helpers for format-compat asserts.</summary>
    private sealed class FramingProbe : EncryptionServiceBase
    {
        ...
        protected override void ValidateSymmetricKey(byte[] key) => throw new NotSupportedException();
