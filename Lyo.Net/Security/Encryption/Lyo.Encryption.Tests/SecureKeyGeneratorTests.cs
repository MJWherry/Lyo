...
public class SecureKeyGeneratorTests
{
    ...
    [InlineData(15)]
    [InlineData(65)]
    public void GenerateKey_OutOfRange_Throws(int size)
    {
        var ex = Assert.Throws<ArgumentOutsideRangeException>(() => SecureKeyGenerator.GenerateKey(size));
    ...
    {
        // mint a large set of keys and assert pairwise uniqueness
