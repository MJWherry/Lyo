...
/// <summary>Turns Google id_token claims into an <see cref="OidcClaimMappingResult" />.</summary>
public static class GoogleClaimMapper
{
    /// <summary>Pulls the standard Google claims: <c>name</c>, <c>email</c>, <c>email_verified</c>, <c>picture</c>, and <c>locale</c>.</summary>
