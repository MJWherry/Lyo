...
/// <summary>Lyo-internal user. Backed by <c>[user].[user]</c> when persisted via <c>Lyo.Authentication.Postgres</c>.</summary>
...
/// <param name="DisabledAt">When set, every existing token and JWT for this user is rejected immediately (Option C kill-switch).</param>
