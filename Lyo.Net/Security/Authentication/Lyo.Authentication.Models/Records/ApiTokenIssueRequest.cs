...
/// <summary>Request shape for <see cref="Services.Opaque.IApiTokenIssuer.IssueAsync" />.</summary>
/// <param name="Kind">One of <see cref="Format.ApiTokenKind" />. Controls display routing (PATs vs internal vs webhook).</param>
