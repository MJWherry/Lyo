...
/// <summary>Persistent shape of a Format-B token. Backed by <c>[user].[token]</c> when stored via <c>Lyo.Authentication.Postgres</c>.</summary>
/// <param name="Id">11-character Crockford base32 id (PK).</param>
...
/// <param name="Scopes">Scope snapshot at issuance (Option C — never re-intersected at validation).</param>
