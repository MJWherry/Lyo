...
/// <summary>Result of <see cref="Services.Jwt.ILyoJwtIssuer.IssueAsync" />: an access JWT, a paired refresh token, and their expirations.</summary>
/// <param name="AccessToken">Compact-serialized Lyo JWT (<c>header.payload.signature</c>).</param>
/// <param name="AccessTokenJti"><c>jti</c> of <paramref name="AccessToken" />. Used to correlate refresh tokens to their access tokens.</param>
