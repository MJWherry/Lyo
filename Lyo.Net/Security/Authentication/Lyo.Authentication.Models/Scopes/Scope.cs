...
/// <param name="Name">Wire name. Must be lowercase ASCII with optional dot separators.</param>
/// <param name="Description">Human-readable description shown in token-management UIs.</param>
/// <param name="Implies">Other scope names this scope grants transitively. Resolved at registration into <see cref="TransitiveImplies" />.</param>
/// <param name="TransitiveImplies">Fully flattened implied scopes (including this scope's name). Populated by the registry.</param>
