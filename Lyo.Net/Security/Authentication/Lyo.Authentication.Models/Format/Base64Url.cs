...
/// <summary>Base64url (RFC 4648 §5) without padding. Used for the Format-B opaque token <c>secret</c> segment and for Lyo JWT components.</summary>
public static class Base64Url
{
    /// <summary>Encodes <paramref name="bytes" /> as base64url with no trailing <c>=</c> padding.</summary>
    ...
    /// <summary>Decodes a base64url string to bytes. Throws <see cref="FormatException" /> on malformed input.</summary>
