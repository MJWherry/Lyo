...
/// <summary>
/// Forwarder kept for backward compatibility. The canonical implementation now lives in <see cref="Records.LyoJwtClaimsParser" /> so it can be shared with the WASM auth
/// runtime.
/// </summary>
