...
/// <summary>
/// Blazor Server <see cref="AuthenticationStateProvider" /> that re-projects the consumer's session-cookie principal into Blazor's auth state. Effectively a thin adapter —
/// the heavy lifting (cookie unsealing + session lookup) happens in <see cref="LyoAuthCookieAuthenticationHandler" />; this just hands back whatever ASP.NET already established for
