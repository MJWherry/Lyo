...
/// <summary>Keycloak realm <see cref="IOpenIdConnectProvider" /> profile.</summary>
public sealed class KeycloakOpenIdConnectProvider : IOpenIdConnectProvider
{
    ...
    /// <summary>Builds a provider from <see cref="KeycloakOptions" />.</summary>
    public KeycloakOpenIdConnectProvider(KeycloakOptions options)
    {
