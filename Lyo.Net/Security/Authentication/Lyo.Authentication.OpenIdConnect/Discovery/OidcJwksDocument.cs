...
/// <summary>JWKS document returned by a provider <c>jwks_uri</c>.</summary>
public sealed class OidcJwksDocument
{
    /// <summary>Set of keys.</summary>
    [JsonPropertyName("keys")]
    public List<OidcJsonWebKey> Keys { get; set; } = [];
}

/// <summary>A single JSON Web Key from a provider JWKS.</summary>
public sealed class OidcJsonWebKey
{
    ...
    /// <summary>Key id (matches the JWT header <c>kid</c>).</summary>
