...
/// <summary>Minimal subset of the OIDC discovery document Lyo cares about.</summary>
public sealed class OidcDiscoveryDocument
{
    ...
    /// <summary><c>/token</c> endpoint URL.</summary>
    [JsonPropertyName("token_endpoint")]
    public string TokenEndpoint { get; set; } = string.Empty;

    /// <summary>JWKS URI used to verify id_token signatures.</summary>
