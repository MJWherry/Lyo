...
/// <summary>
/// In-memory, time-bounded cache of OIDC discovery documents. Cuts traffic to the provider <c>/.well-known/openid-configuration</c> endpoint. Hosts that scale out share
/// nothing (each replica fetches once per TTL).
/// </summary>
public sealed class OidcDiscoveryCache
{
    /// <summary>Default time-to-live for a cached discovery document.</summary>
    ...
    /// <summary>Builds a new cache backed by <paramref name="http" />. TTL defaults to <see cref="DefaultTtl" />.</summary>
