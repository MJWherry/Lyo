...
/// <summary>Typed HTTP client that exchanges an authorization code for an id_token / access_token at the provider <c>/token</c> endpoint.</summary>
public sealed class OidcTokenExchangeClient
{
    ...
    /// <summary>POSTs the authorization-code grant to <paramref name="provider" />'s token endpoint with the PKCE verifier.</summary>
