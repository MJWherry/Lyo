...
public sealed class UserEventEntity
{
    ...
    /// <summary>Stored as the enum's string name (e.g. <c>JwtIssued</c>) so logs/queries stay readable. Width is bounded to 64 chars.</summary>
    ...
    /// <summary>Optional tenant scope. <see langword="null" /> means system / no tenant; non-null is a tenant-scoped event.</summary>
