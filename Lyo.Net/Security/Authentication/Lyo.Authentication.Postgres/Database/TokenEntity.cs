...
public sealed class TokenEntity
{
    ...
    /// <summary>Scope snapshot at issuance, serialized as a JSON string array (Option C).</summary>
    public string ScopesJson { get; set; } = "[]";

    /// <summary>Caller-supplied metadata bag serialized as a JSON object (null when none).</summary>
