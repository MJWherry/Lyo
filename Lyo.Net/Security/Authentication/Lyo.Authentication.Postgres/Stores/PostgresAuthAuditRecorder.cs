...
/// <summary>
/// PostgreSQL-backed <see cref="IAuthAuditRecorder" />. Persists to <c>[user].[event]</c> via <see cref="UserDbContext" />. Non-throwing — any persistence exception is
/// caught and (debug) logged because audit failures must never break the authentication path.
/// </summary>
public sealed class PostgresAuthAuditRecorder : IAuthAuditRecorder
{
    ...
    /// <summary>Builds a new recorder.</summary>
