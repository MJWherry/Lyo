...
/// <summary>PostgreSQL <see cref="IExternalIdentityStore" />. Persists OIDC identity links to <c>[user].[linked_identity]</c>.</summary>
public sealed class PostgresExternalIdentityStore : IExternalIdentityStore
{
    ...
    public PostgresExternalIdentityStore(IDbContextFactory<UserDbContext> contextFactory, EntityRefOptions entityRefOptions, PostgresUserOptions userOptions)
    {
