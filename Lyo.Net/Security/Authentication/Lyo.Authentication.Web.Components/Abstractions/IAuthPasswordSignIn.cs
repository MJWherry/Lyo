...
/// <summary>
/// Optional username + password sign-in strategy. Not registered by default — the BFF / API stack has no password grant today, so this is a placeholder for apps
...
{
    /// <summary>Tries to sign in with the given credentials. Must not throw on bad credentials — return <see cref="AuthPasswordSignInResult.Failure" /> instead.</summary>
    ...
    /// <param name="rememberMe">User's "remember me" preference; implementations may ignore it.</param>
