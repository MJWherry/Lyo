...
/// <summary>
/// Optional username + password sign-in strategy. Not registered by default — the BFF / API stack has no password grant today, so this is a placeholder contract for apps that
/// want to bolt local password auth onto the same login page. When no implementation is registered the password form is omitted entirely.
/// </summary>
