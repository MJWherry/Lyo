...
/// <summary>Diagnostic snapshot of the active session, surfaced through <c>IAuthSessionAccessor</c> for the debug page. The refresh token is never echoed — only its presence is.</summary>
