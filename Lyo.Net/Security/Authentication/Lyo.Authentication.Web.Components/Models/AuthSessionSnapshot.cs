...
/// <summary>Diagnostic snapshot of the active session via <c>IAuthSessionAccessor</c> for the debug page. Refresh token is never echoed — only its presence.</summary>
