...
/// <summary>
/// Result of <c>POST /tokens</c>: wire-form plaintext (shown to the user exactly once and never persisted client-side) plus the display-safe record pinned into
/// the token list. Mirror of <c>TokenManagementEndpointsMapper.CreateTokenResponse</c>.
/// </summary>
...
/// <param name="Record">Persisted, display-safe record.</param>
