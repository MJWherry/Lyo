...
/// <summary>
/// Result of <c>POST /tokens</c>: the wire-form plaintext (shown to the user exactly once and never persisted client-side) plus the display-safe record that gets pinned into
