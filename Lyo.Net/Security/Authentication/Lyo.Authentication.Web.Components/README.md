...
The Lyo BFF / API stack does **not** currently ship a password grant. Consumers that want this card supply their own `IAuthPasswordSignIn` (e.g. against a custom `/account/login`
endpoint).
