...
/// sign-out is a POST submitted via a dynamically built form because the consumer <c>/auth/sign-out</c> endpoint is POST-only by design (CSRF protection).
/// </summary>
public sealed class ServerAuthSignInLauncher : IAuthSignInLauncher
{
    ...
    public ServerAuthSignInLauncher(NavigationManager navigation, IJSRuntime js, LyoAuthClientOptions options)
    {
