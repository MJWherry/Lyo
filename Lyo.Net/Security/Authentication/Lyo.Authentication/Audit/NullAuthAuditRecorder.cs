...
/// <summary>
/// Sentinel <see cref="IAuthAuditRecorder" /> that drops every event on the floor. Registered as the default so that callers can unconditionally inject
/// <see cref="IAuthAuditRecorder" /> without forcing a persistence story onto every host.
/// </summary>
