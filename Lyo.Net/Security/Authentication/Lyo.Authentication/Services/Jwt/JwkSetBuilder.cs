...
public sealed class JwkSetBuilder
{
    ...
    /// <summary>Builds a new builder.</summary>
    public JwkSetBuilder(IKeyStore keys, LyoJwtOptions options)
    {
    ...
    /// <summary>Builds the JWKS payload. Returns a dictionary ready to serialize as JSON.</summary>
