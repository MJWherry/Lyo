...
{
    /// <summary>Byte length of an Ed25519 private seed (32).</summary>
    public const int PrivateSeedLength = 32;

    /// <summary>Byte length of an Ed25519 public key (32).</summary>
    public const int PublicKeyLength = 32;

    /// <summary>Byte length of an Ed25519 signature (64).</summary>
