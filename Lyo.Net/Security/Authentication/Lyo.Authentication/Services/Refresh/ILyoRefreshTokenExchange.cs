...
/// <summary>
/// Exchanges a presented refresh token for a fresh access JWT (and a fresh refresh token — rotating refresh by default). Reuse of an already-revoked refresh token triggers
