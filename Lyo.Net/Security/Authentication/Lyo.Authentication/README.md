...
- **Google** — see [`Lyo.Authentication.Google/README.md`](../Lyo.Authentication.Google/README.md) (includes a full Google Cloud + `Lyo.TestApi` + `Lyo.TestGateway` local walkthrough).
