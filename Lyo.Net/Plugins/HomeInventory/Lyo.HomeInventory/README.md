...
- `GetItemByIdAsync(Guid id, CancellationToken ct = default)` one item by id.
...
- `DeleteItemAsync(Guid id, CancellationToken ct = default)` hard delete. Item rows have no soft-delete column.
