...
/// <summary>Postgres-backed <see cref="IFavoriteStore" />.</summary>
public sealed class PostgresFavoriteStore : EntityRefPostgresStoreBase, IFavoriteStore, IHealth
{
    ...
    /// <summary>Constructs a new PostgresFavoriteStore.</summary>
    public PostgresFavoriteStore(
        IDbContextFactory<FavoriteDbContext> contextFactory,
        EntityRefOptions entityRefOptions,
        PostgresFavoriteOptions favoriteOptions,
        IEnumerable<IEntityRefActionInterceptor>? interceptors = null)
        : base(entityRefOptions, favoriteOptions.Tenancy ?? throw new ArgumentNullException(nameof(favoriteOptions)), interceptors)
    {
    ...
    public Task<HealthResult> CheckHealthAsync(CancellationToken ct = default)
        => PostgresHealth.CheckAsync(_contextFactory, PostgresFavoriteOptions.Schema, ct);
