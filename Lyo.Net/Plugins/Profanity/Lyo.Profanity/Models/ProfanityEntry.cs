...
/// <summary>One profanity-filter entry with regex-based matching and optional exceptions.</summary>
...
public record ProfanityEntry(string Id, string Match, IReadOnlyList<string> Tags, int Severity, IReadOnlyList<string> Exceptions, bool IsLiteral)
{
    ...
    /// <summary>Produces a default entry for a plain word: id=match=word, tags=[], severity=1, exceptions=[], IsLiteral=true.</summary>
