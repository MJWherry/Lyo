...
/// <summary>Outcome of a URL statistics retrieval operation with statistics-specific properties.</summary>
public sealed record UrlStatisticsResult : Result<UrlStatistics>
{
    /// <summary>Alias short URL.</summary>
    public string? ShortUrl { get; init; }

    /// <summary>Destination long URL.</summary>
    ...
    /// <summary>Produces a successful UrlStatisticsResult with statistics.</summary>
    ...
    /// <summary>Produces a failed UrlStatisticsResult from an exception.</summary>
    ...
    /// <summary>Builds a failed UrlStatisticsResult with a custom error message.</summary>
