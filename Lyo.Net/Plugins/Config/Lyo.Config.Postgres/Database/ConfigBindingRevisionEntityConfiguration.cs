...
public sealed class ConfigBindingRevisionEntityConfiguration : IEntityTypeConfiguration<ConfigBindingRevisionEntity>
{
    public void Configure(EntityTypeBuilder<ConfigBindingRevisionEntity> builder)
    {
        ...
        builder.Property(e => e.EncryptedValue).HasColumnName("encrypted_value").HasColumnType("bytea");
        ...
        builder.HasIndex(e => e.TenantId).HasDatabaseName("ix_config_binding_revision_tenant").HasFilter("\"tenant_id\" IS NOT NULL");
    }
}