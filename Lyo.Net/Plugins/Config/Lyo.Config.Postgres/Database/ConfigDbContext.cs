...
public class ConfigDbContext : DbContext
{
    ...
    public DbSet<ConfigDefinitionRevisionEntity> ConfigDefinitionRevisions { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new ConfigDefinitionRevisionEntityConfiguration());
    }
