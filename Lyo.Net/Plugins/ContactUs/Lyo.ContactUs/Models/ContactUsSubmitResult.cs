...
/// <summary>Outcome of a contact form submission.</summary>
public sealed record ContactUsSubmitResult : Result<Guid?>
{
    /// <summary>The ID for the submitted contact form entry (when successful).</summary>
    ...
    /// <summary>Builds a successful ContactUsSubmitResult.</summary>
    ...
    /// <summary>Builds a failed ContactUsSubmitResult from an exception.</summary>
    ...
    /// <summary>Makes a failed ContactUsSubmitResult with a custom error message.</summary>
