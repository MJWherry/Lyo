...
/// <summary>
/// Regression checks for the maintenance-service review fixes: dead-job timeouts publish run-finished events (so retries/triggers/circuit breaker fire), stuck <c>Queued</c>
