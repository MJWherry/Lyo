...
/// <summary>
/// In-memory <see cref="IJobEventPublisher" /> for integration checks. Captures every publish call so checks can assert what was sent, and exposes <see cref="SetConnected" />
