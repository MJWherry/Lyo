...
/// <summary>
/// Regression checks for the encrypted-parameter round trip: values are stored as ciphertext, masked on public API responses, decrypted on the worker-trusted
