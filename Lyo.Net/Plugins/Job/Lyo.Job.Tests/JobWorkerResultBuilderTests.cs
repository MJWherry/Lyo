...
public class JobWorkerResultBuilderTests
{
    ...
    public void Build_DefaultOutcome_IsSuccess()
    {
        ...
        Assert.Contains(results, r => r.Key == Constants.Data.JobRunResultKey.Result && r.Value == LyoTypeInfo.String.ToJson(nameof(JobRunResult.Success)));
    }
    ...
    public void Fail_SetsFailureOutcome()
    {
        ...
        Assert.Contains(results, r => r.Key == Constants.Data.JobRunResultKey.Result && r.Value == LyoTypeInfo.String.ToJson(nameof(JobRunResult.Failure)));
    }
    ...
    public void Cancel_SetsCancelledOutcome()
    {
        ...
        Assert.Contains(results, r => r.Key == Constants.Data.JobRunResultKey.Result && r.Value == LyoTypeInfo.String.ToJson(nameof(JobRunResult.Cancelled)));
    }
    ...
    public void SucceedWithWarnings_SetsSuccessWithWarningsOutcome()
    {
        ...
        Assert.Contains(results, r => r.Key == Constants.Data.JobRunResultKey.Result && r.Value == LyoTypeInfo.String.ToJson(nameof(JobRunResult.SuccessWithWarnings)));
    }
    ...
    public void AddResult_AddsCustomEntry()
    {
        ...
        Assert.Contains(results, r => r.Key == "CustomKey" && r.Value == LyoTypeInfo.String.ToJson("value") && r.Type == LyoTypeInfo.String.FullName);
    }
    ...
    public void AddCount_AddsIntegerEntry()
    {
        ...
        Assert.Contains(results, r => r.Key == "Processed" && r.Value == "42" && r.Type == LyoTypeInfo.Int.FullName);
    }
    ...
    public void AddError_RecordsFailureReasonAndFails()
    {
        ...
        Assert.Contains(results, r => r.Key == Constants.Data.JobRunResultKey.FailureReason(2) && r.Value == LyoTypeInfo.String.ToJson("Something broke"));
        Assert.Contains(results, r => r.Key == Constants.Data.JobRunResultKey.Result && r.Value == LyoTypeInfo.String.ToJson(nameof(JobRunResult.Failure)));
    }
    ...
    public void AddFailedItem_RecordsItemAndOptionalReason()
    {
        ...
        Assert.Contains(results, r => r.Key == Constants.Data.JobRunResultKey.FailedItem(1) && r.Value == LyoTypeInfo.String.ToJson("item-42"));
        Assert.Contains(results, r => r.Key == Constants.Data.JobRunResultKey.FailureReason(1) && r.Value == LyoTypeInfo.String.ToJson("bad data"));
        Assert.Contains(results, r => r.Key == Constants.Data.JobRunResultKey.Result && r.Value == LyoTypeInfo.String.ToJson(nameof(JobRunResult.Failure)));
    }
    ...
    public void AddApiCallTime_UsesApiCallTimeKey()
    {
        ...
        Assert.Contains(results, r => r.Key == Constants.Data.JobRunResultKey.ApiCallTime("ExternalApi") && r.Value == "1234" && r.Type == LyoTypeInfo.Long.FullName);
    }
