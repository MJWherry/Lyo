...
public class JobScheduleBuilder
{
    ...
    public JobScheduleBuilder AddScheduleParameter(string key, LyoTypeInfo type, object? value = null, string? description = null, bool enabled = true)
    {
    ...
    /// <summary>Applies a standard cron expression (5- or 6-field) and switches the schedule type to Cron.</summary>
    ...
    /// <summary>Sets how slots missed while no scheduler was running are treated.</summary>
    ...
    /// <summary>Limits the schedule to a UTC validity window. Either bound may be null.</summary>
    ...
    /// <summary>Sets the IANA/Windows time zone id used when this schedule's times are evaluated.</summary>
    ...
    /// <summary>Attaches an existing blackout calendar by id.</summary>
    ...
    /// <summary>Creates and attaches a new inline blackout calendar when this schedule is persisted.</summary>
    ...
    /// <summary>Appends a do-not-run window to this schedule's inline blackout calendar.</summary>
    ...
    /// <summary>Builds the request used for API/DB persistence.</summary>
    public JobScheduleReq Build() => _schedule;

    /// <summary>Builds a ScheduleDefinition for Lyo.Scheduler.AddSchedule.</summary>
