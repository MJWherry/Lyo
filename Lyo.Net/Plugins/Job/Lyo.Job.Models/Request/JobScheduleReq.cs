...
public sealed class JobScheduleReq
{
    ...
    /// <summary>Standard cron expression (5- or 6-field). Required only when <see cref="Type" /> is <c>Cron</c>.</summary>
    public string? CronExpression { get; set; }

    /// <summary>How slots missed while no scheduler was running are treated.</summary>
    ...
    /// <summary>Inline blackout calendar to create and attach when this schedule is persisted. Mutually exclusive with <see cref="JobBlackoutCalendarId" />.</summary>
