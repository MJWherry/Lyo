...
/// <summary>Extensions that convert job schedule models to ScheduleDefinition for Lyo.Scheduler.</summary>
public static class JobScheduleExtensions
{
    /// <summary>Converts JobScheduleReq to ScheduleDefinition. The schedule's <c>TimeZoneId</c> (when set and valid) becomes the definition time zone.</summary>
    ...
    /// <summary>Converts JobScheduleRes to ScheduleDefinition. The schedule's <c>TimeZoneId</c> (when set and valid) becomes the definition time zone.</summary>
    ...
    /// <summary>Resolves a time zone id to a <see cref="TimeZoneInfo" />, or null when the id is missing or unknown.</summary>
