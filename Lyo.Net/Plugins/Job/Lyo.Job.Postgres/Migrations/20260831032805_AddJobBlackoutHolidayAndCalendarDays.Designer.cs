...
namespace Lyo.Job.Postgres.Migrations
{
    ...
    [Migration("20260831032805_AddJobBlackoutHolidayAndCalendarDays")]
    partial class AddJobBlackoutHolidayAndCalendarDays
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lyo.Job.Postgres.Database.JobBlackoutWindow", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("DaysOfMonth")
                    ...
                    b.Property<string>("HolidaySlug")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("holiday_slug");

                    b.Property<bool>("IncludeObservedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("include_observed_date");
            ...
            modelBuilder.Entity("Lyo.Job.Postgres.Database.JobRun", b =>
                {
                    ...
                    b.Property<string>("WorkerMachineName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("worker_machine_name");

                    b.Property<int?>("WorkerProcessId")
                        .HasColumnType("integer")
                        .HasColumnName("worker_process_id");

                    b.HasKey("Id")
                        .HasName("pk_job_run");

                    b.HasIndex("FinishedTimestamp")
                        .HasDatabaseName("ix_job_run_finished_timestamp");

                    b.HasIndex("ReRanFromJobRunId");

                    b.HasIndex("JobDefinitionId", "CreatedTimestamp")
                        .IsDescending(false, true)
                        .HasDatabaseName("ix_job_run_definition_created_desc");
                    ...
                    b.HasIndex("JobDefinitionId", "State")
                        .HasDatabaseName("ix_job_run_definition_state");
                    ...
                    b.HasIndex("State", "LastHeartbeatUtc")
                        .HasDatabaseName("ix_job_run_state_last_heartbeat");

                    b.HasIndex("JobDefinitionId", "Result", "CreatedTimestamp")
                    ...
                    b.HasIndex(new[] { "WorkerInstanceId" }, "ix_job_run_worker_instance_id");
