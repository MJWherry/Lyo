...
/// <see cref="InFlightCount" />), and mark it <c>Stopped</c> on a graceful shutdown. <see cref="JobMaintenanceService" /> removes rows whose heartbeat has gone stale.
/// </summary>
public class JobWorkerInstance
{
    public Guid Id { get; set; }

    /// <summary>Worker type this instance pulls from (matches <see cref="JobDefinition.WorkerType" />).</summary>
    [Required]
    [MaxLength(100)]
    ...
    /// <summary>Lifecycle state: Running, Draining, or Stopped. Stored as a string.</summary>
    [Required]
    [MaxLength(10)]
    public string State { get; set; } = null!;

    /// <summary>How many runs this instance is executing (as of the last heartbeat).</summary>
    ...
    /// <summary>JSON object of worker-reported metadata keys (os, framework, and host extras).</summary>
