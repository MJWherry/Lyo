...
/// operations that require the transport return an appropriate error rather than throwing. Override by calling <c>AddMqJobEventPublisher()</c> (or registering your own
