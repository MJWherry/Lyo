...
/// <summary>
/// Connects <see cref="IJobEventPublisher" /> to the message queue when the host starts. The <c>AddMqJobEventPublisher</c> overloads register this automatically so API hosts
