...
{
    /// <summary>Series shown on this card.</summary>
    [Parameter]
    [EditorRequired]
    public ComicSeries Series { get; set; } = default!;

    /// <summary>The cover image a pre-resolved display-ready URL.</summary>
    [Parameter]
    ...
    /// <summary>Opens the reader from the cover or Read.</summary>
    [Parameter]
    public EventCallback<ComicSeries> OnRead { get; set; }

    /// <summary>Opens series browse from the card body or Details.</summary>
    [Parameter]
