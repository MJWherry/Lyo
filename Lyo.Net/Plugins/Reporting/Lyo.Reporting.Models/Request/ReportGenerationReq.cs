...
/// <summary>Legacy update payload for a report generation. Prefer <see cref="GenerateReportReq" />. Generations are not created or updated through generic CRUD.</summary>
public sealed class ReportGenerationReq
{
    ...
    /// <summary>Optional opaque id of a persisted output (defined by the consumer).</summary>
