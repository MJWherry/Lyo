...
/// <summary>Minimal in-memory <see cref="IFileStorageService" /> for generation checks.</summary>
public sealed class FakeFileStorageService : IFileStorageService
{
    ...
    public Task<FileStoreResult> GetMetadataAsync(Guid fileId, CancellationToken ct = default)
    {
        ...
        return Task.FromResult(CreateResult(fileId, null, data.LongLength, null, null, null));
    }
