...
/// <summary>One generated report output. Optional <see cref="OutputFileId" /> is set by consumer hooks.</summary>
public sealed class ReportGeneration
{
    ...
    /// <summary>Snapshot of the composition JSON used for this generation.</summary>
    [Required]
    ...
    /// <summary>Optional opaque id of a persisted output (consumer-defined, for example FileStorage).</summary>
