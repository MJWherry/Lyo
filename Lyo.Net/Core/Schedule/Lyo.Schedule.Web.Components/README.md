...
`<ScheduleWorkbench />` is a pure component. Pass a `ScheduleDefinition?` initial value via parameter and receive the updated value through the value-changed callback. MudBlazor layout primitives come from [`Lyo.Web.Components`](../../../Integration/Web/Lyo.Web.Components/README.md).
