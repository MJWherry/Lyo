...
`<ScheduleWorkbench />` is a pure component — pass a `ScheduleDefinition?` initial value via parameter and receive the updated value through the value-changed callback. MudBlazor layout primitives are inherited from [`Lyo.Web.Components`](../../../Integration/Web/Lyo.Web.Components/README.md).
