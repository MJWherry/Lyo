...
/// <summary>Shared helpers and payload types used by cache benchmarks.</summary>
internal static class CacheBenchmarkSupport
{
    ...
    /// <summary>Builds a repeating, compressible ASCII string of about <paramref name="sizeBytes" /> bytes.</summary>
    ...
    /// <summary>Builds a nested payload (object, collection, and dictionary) whose <see cref="NestedCachePayload.Data" /> body is about <paramref name="approxBytes" /> bytes.</summary>
...
/// <summary>Small flat cached value used on the object and payload cache paths.</summary>
...
/// <summary>
/// Cached value with a realistic nested graph: a nested <see cref="Address" /> (itself nesting a <see cref="CacheGeo" />), a <see cref="Contacts" /> collection of
/// objects, an <see cref="Attributes" /> dictionary, and a size-scalable <see cref="Data" /> body. Used to exercise serialization and compression of non-trivial graphs.
/// </summary>
...
/// <summary>Address that nests a geo coordinate (depth-2 object graph).</summary>
...
/// <summary>Latitude/longitude nested inside <see cref="CacheAddress" />.</summary>
...
/// <summary>Contact row nested in the payload contacts collection.</summary>
