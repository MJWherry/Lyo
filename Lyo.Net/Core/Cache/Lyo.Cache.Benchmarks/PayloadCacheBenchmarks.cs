...
/// <summary>Times the serialized byte-payload cache path (JSON plus optional compression framing) across payload sizes on a nested payload graph.</summary>
...
public class PayloadCacheBenchmarks
{
    ...
    public void Setup()
    {
        ...
        // Seed the cache so the timed calls hit read/decode/deserialize rather than the factory.
