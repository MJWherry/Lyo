...
/// <summary>Default <see cref="ICachePayloadSerializer" /> backed by <see cref="JsonSerializer" />.</summary>
/// <param name="options">JSON options applied to serialize and deserialize.</param>
