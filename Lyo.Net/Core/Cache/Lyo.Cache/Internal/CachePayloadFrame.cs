...
/// <summary>Binary frame: magic "LYO1", flags, little-endian uint32 payload length, then payload.</summary>
internal static class CachePayloadFrame
{
    ...
    /// <summary>Reads flags and payload length from a framed blob without throwing. Returns false when magic, header, or length do not match.</summary>
