...
/// <summary>
/// Converts application values to plaintext bytes stored by <see cref="ICachePayloadCodec" /> (after optional compression/encryption). Replace with a custom implementation
