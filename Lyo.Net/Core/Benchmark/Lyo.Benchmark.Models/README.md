...
Models and builders for the Lyo benchmark report schema (`lyo.bench/v1`). One polymorphic document represents both BenchmarkDotNet micro-benchmarks and k6 load tests. A viewer or portfolio / test gateway can render any report file by switching on one discriminator.
