...
/// <summary>
/// Thin wrapper around a throwaway Redis Testcontainers container for Docker-dependent benchmarks
/// (cache backplane, distributed lock). Start it in <c>[GlobalSetup]</c> and dispose in <c>[GlobalCleanup]</c>.
/// </summary>
public sealed class RedisBenchmarkContainer : IDisposable
{
    ...
    public RedisBenchmarkContainer(string image = "redis:7-alpine")
    {
