...
/// <summary>In-process counting semaphore per key: up to <c>maxConcurrency</c> concurrent permit holders per key inside this process.</summary>
public sealed class LocalKeyedSemaphoreService : IKeyedSemaphoreService
{
    ...
    /// <param name="metrics">When <see cref="KeyedSemaphoreOptions.EnableMetrics" /> is true and this is non-null, timings and counters are written.</param>
