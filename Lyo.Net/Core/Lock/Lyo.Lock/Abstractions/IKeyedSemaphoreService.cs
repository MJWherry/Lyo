...
/// <summary>
/// Limits how many operations may run concurrently per logical key (counting semaphore per key).
/// Local implementations scope concurrency to a single process.
/// </summary>
/// <remarks>
/// For a given normalized key, the <c>maxConcurrency</c> argument must stay consistent while any permit or waiter is active;
/// otherwise implementations throw to avoid undefined behavior.
/// </remarks>
