...
/// <summary>Releases the per-key <see cref="SemaphoreSlim" /> used by <see cref="LocalLockService" /> and drops the dictionary entry when the last reference ends.</summary>
    ...
    : ILockHandle
{
    ...
    // Conditional remove: ICollection<KeyValuePair<>>.Remove exists on netstandard2.0; TryRemove(KeyValuePair<>) arrived in netstandard2.1.
