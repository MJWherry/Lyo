...
public class RedisLockOptions : LockOptions
{
    ...
    /// <summary>
    /// When <see langword="true" />, competing acquirers subscribe to a per-key channel and retry immediately when the holder publishes on release. When <see langword="false" />
