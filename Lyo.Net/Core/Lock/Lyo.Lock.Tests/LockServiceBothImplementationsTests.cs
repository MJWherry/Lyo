...
/// <summary>Runs the same core lock behavior suite against <see cref="LocalLockService" /> and <see cref="RedisLockService" />.</summary>
public class LockServiceBothImplementationsTests : RedisContainerFixtureBase
{
