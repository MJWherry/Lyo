...
**Typical usage:** show user-facing “what changed” snippets, render red/green code review panes, produce patch-like summaries for moderation or audit logs—**not** a unified diff
file format for `patch(1)`.
...
**Typical usage:** “settings before vs after”, “sync drift” detection, Discord/bot integrations that need to describe **what changed** in a structured model (see [
`Lyo.Discord.Bot`](../../../Integration/Discord/Lyo.Discord.Bot/README.md) for a real consumer).
