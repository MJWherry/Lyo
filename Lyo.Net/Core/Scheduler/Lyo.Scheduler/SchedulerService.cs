...
/// <summary>In-process scheduler that fires actions at scheduled times, with logging, metrics, and optional persisted state.</summary>
public sealed class SchedulerService : ISchedulerService, IDisposable
{
    ...
    /// <summary>Mints a scheduler service.</summary>
    ...
    /// <summary>Disposes the scheduler and stops it when it is still running.</summary>
    public void Dispose()
    {
        if (_disposed)
            return;
