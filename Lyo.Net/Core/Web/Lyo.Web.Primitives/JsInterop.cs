...
public sealed class JsInterop(IJSRuntime js) : IJsInterop
{
    ...
    {
        await using var module = await js.InvokeAsync<IJSObjectReference>("import", "./_content/Lyo.Web.Primitives/scripts/lyoClipboard.js");
    ...
    {
        await using var module = await js.InvokeAsync<IJSObjectReference>("import", "./_content/Lyo.Web.Primitives/scripts/lyoTimeZone.js");
