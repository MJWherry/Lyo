...
namespace Lyo.Web.Primitives.ChipInput;
...
public partial class LyoChipInput
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender) {
            ...
            try {
                _pasteModule = await JsRuntime.InvokeAsync<IJSObjectReference>("import", "./_content/Lyo.Web.Primitives/scripts/lyoChipInputPaste.js");
