...
/// <summary>Default <see cref="IValidationSchemaCompiler" />: checks the target type, then builds a <see cref="WhereClauseValidator{T}" />.</summary>
public sealed class ValidationSchemaCompiler : IValidationSchemaCompiler
{
    ...
    /// <summary>Mints a compiler that loads from <paramref name="store" /> and evaluates with <paramref name="evaluator" />.</summary>
