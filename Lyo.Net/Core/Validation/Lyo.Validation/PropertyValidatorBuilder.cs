...
public sealed class PropertyValidatorBuilder<T, TProperty>
{
    ...
    /// <summary>Fails when the property value is null.</summary>
    ...
    /// <summary>Fails when the property value equals default(TProperty).</summary>
    ...
    /// <summary>Fails when the property value is empty. Works for strings and collections.</summary>
    ...
    /// <summary>Fails when the string property is null, empty, or whitespace.</summary>
    ...
    /// <summary>Fails when the string property length is outside the inclusive range.</summary>
    ...
    /// <summary>Fails when the string property does not match the supplied regex.</summary>
    ...
    /// <summary>Fails when the string property is not a valid email.</summary>
    ...
    /// <summary>Fails when the string property is not a valid URI.</summary>
    ...
    /// <summary>Fails when the property value is not greater than the supplied minimum.</summary>
    ...
    /// <summary>Fails when the property value is less than the supplied minimum.</summary>
    ...
    /// <summary>Fails when the property value is not less than the supplied maximum.</summary>
    ...
    /// <summary>Fails when the property value is outside the inclusive range.</summary>
    ...
    /// <summary>Fails when the enumerable property does not contain the supplied item.</summary>
    ...
    /// <summary>Fails when the property value is not among <paramref name="allowed" />.</summary>
    ...
    /// <summary>Fails when the property value is not among the given <paramref name="allowed" /> values.</summary>
    public PropertyValidatorBuilder<T, TProperty> In(params TProperty[] allowed) => In((IEnumerable<TProperty>)allowed);

    /// <summary>Fails when the property value is among <paramref name="disallowed" />.</summary>
    ...
    /// <summary>Fails when the property value is among the given <paramref name="disallowed" /> values.</summary>
    public PropertyValidatorBuilder<T, TProperty> NotIn(params TProperty[] disallowed) => NotIn((IEnumerable<TProperty>)disallowed);

    /// <summary>Fails when the enumerable property contains the supplied item.</summary>
    ...
    /// <summary>Appends a custom property-level predicate.</summary>
    ...
    /// <summary>Appends a custom property-level predicate that can inspect the parent instance.</summary>
    ...
    /// <summary>Runs another validator on the property value and remaps errors onto this property path.</summary>
    ...
    /// <summary>Pulls in another model-level validator.</summary>
    ...
    /// <summary>Begins another property rule chain.</summary>
    ...
    /// <summary>Appends a model-level rule.</summary>
