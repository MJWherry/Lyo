...
/// <summary>Abstract attribute that declares a property-level validation rule.</summary>
[AttributeUsage(AttributeTargets.Property, AllowMultiple = true)]
public abstract class ValidationAttributeBase(string errorCode) : Attribute
{
    /// <summary>Error code returned when validation fails.</summary>
    public string ErrorCode { get; } = errorCode;

    /// <summary>Optional custom error message.</summary>
    public string? ErrorMessage { get; set; }

    /// <summary>Validates the given property value.</summary>
...
/// <summary>Fails when the property value is empty.</summary>
...
/// <summary>Fails when the string property is not a valid email address.</summary>
...
/// <summary>Fails when the string property is not a valid phone number.</summary>
...
/// <summary>Fails when the property value is outside the inclusive numeric range.</summary>
