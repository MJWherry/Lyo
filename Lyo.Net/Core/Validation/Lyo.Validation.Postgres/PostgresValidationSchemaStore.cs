...
/// <summary>PostgreSQL <see cref="IValidationSchemaStore" /> that opens a context via <see cref="IDbContextFactory{TContext}" />.</summary>
public sealed class PostgresValidationSchemaStore : IValidationSchemaStore
{
    ...
    /// <summary>Mints a store that opens a context per operation.</summary>
