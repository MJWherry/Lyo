...
public sealed class AuditEventEntityConfiguration : IEntityTypeConfiguration<AuditEventEntity>
{
    public void Configure(EntityTypeBuilder<AuditEventEntity> builder)
    {
        ...
        builder.HasIndex(e => new { e.SubjectEntityType, e.SubjectEntityId, e.Timestamp }).HasDatabaseName("ix_audit_events_for_entity_timestamp");
        builder.HasIndex(e => new { e.ActorEntityType, e.ActorEntityId }).HasDatabaseName("ix_audit_events_from_entity");
