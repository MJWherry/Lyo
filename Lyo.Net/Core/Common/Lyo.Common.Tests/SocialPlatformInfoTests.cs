...
public class SocialPlatformInfoTests
{
    ...
    [InlineData("twitter")]
    [InlineData("x")]
    public void FromAlias_ResolvesX(string alias) => Assert.Equal(SocialPlatformInfo.X, SocialPlatformInfo.FromAlias(alias));

    [Fact]
    public void FromSlug_UnknownSlug_ReturnsUnknown() => Assert.Equal(SocialPlatformInfo.Unknown, SocialPlatformInfo.FromSlug("not-a-platform"));
    ...
    [Fact]
    public void TryBuildProfileUri_GitHub_BuildsExpectedUrl() => Assert.Equal("https://github.com/octocat", SocialPlatformInfo.GitHub.TryBuildProfileUri("octocat"));

    [Fact]
    public void TryBuildProfileUri_StripsLeadingAtSign() => Assert.Equal("https://github.com/octocat", SocialPlatformInfo.GitHub.TryBuildProfileUri("@octocat"));

    [Fact]
    public void TryBuildProfileUri_MastodonFederated_BuildsExpectedUrl()
        => Assert.Equal("https://mastodon.social/@alice", SocialPlatformInfo.Mastodon.TryBuildProfileUri("alice@mastodon.social"));

    [Fact]
    public void TryBuildProfileUri_MastodonIncompleteHandle_ReturnsNull() => Assert.Null(SocialPlatformInfo.Mastodon.TryBuildProfileUri("alice"));

    [Fact]
    public void TryBuildProfileUri_Discord_ReturnsNull() => Assert.Null(SocialPlatformInfo.Discord.TryBuildProfileUri("someuser"));

    [Fact]
    public void TryBuildProfileUri_BlankUsername_ReturnsNull() => Assert.Null(SocialPlatformInfo.GitHub.TryBuildProfileUri("   "));
