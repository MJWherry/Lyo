...
/// <summary>DI helpers that register encoding services.</summary>
public static class EncodingServiceCollectionExtensions
{
    extension(IServiceCollection services)
    {
        /// <summary>
        /// Registers <see cref="IBinaryEncodingService" />: uses <see cref="BinaryEncodingService.Shared" /> when <paramref name="configure" /> is null; otherwise registers a
        ...
        /// <summary>Registers <see cref="IBinaryEncodingService" /> with an explicit options instance.</summary>
        ...
        /// <summary>
        /// Registers <see cref="ICharsetEncodingService" />: uses <see cref="CharsetEncodingService.Shared" /> when <paramref name="configure" /> is null; otherwise registers a
        /// configured singleton.
        /// </summary>
        ...
        /// <summary>Registers <see cref="ICharsetEncodingService" /> with an explicit options instance.</summary>
        ...
        /// <summary>Registers both binary and charset encoding services using defaults.</summary>
        ...
        /// <summary>Registers both services, applying optional configure callbacks.</summary>
