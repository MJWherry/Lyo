...
public sealed class BinaryEncodingOptions
{
    ...
    /// <summary>When greater than zero, Base64/Base64Url encode output is wrapped with CRLF every N characters (e.g. 76 for MIME). Hex is never wrapped. Zero means no wrapping.</summary>
