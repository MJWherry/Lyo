...
/// <summary>Binary-to-text codec kind for <see cref="IBinaryEncodingService" /> / <see cref="BinaryEncoding" />.</summary>
public enum BinaryEncodingKind
{
    ...
    /// <summary>Hexadecimal (two characters per byte).</summary>
    Hex = 2
}