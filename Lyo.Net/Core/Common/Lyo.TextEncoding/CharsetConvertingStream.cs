...
/// <summary>
/// Write-through stream that decodes written bytes with <see cref="From" /> and encodes to <see cref="To" /> on the inner stream. Read is not supported in v1. Suitable for
...
public sealed class CharsetConvertingStream : Stream
{
    ...
    /// <summary>Mints a converting write stream.</summary>
    ...
    /// <summary>Source encoding of the written bytes.</summary>
    public Encoding From { get; }

    /// <summary>Destination encoding written onto the inner stream.</summary>
