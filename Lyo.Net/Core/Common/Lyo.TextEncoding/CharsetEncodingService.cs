...
public sealed class CharsetEncodingService : ICharsetEncodingService
{
    ...
    /// <summary>Shared instance using <see cref="CharsetEncodingOptions.Default" />.</summary>
    public static CharsetEncodingService Shared { get; } = new(CharsetEncodingOptions.Default);

    /// <summary>Mints a service with optional options (registers CodePages when enabled).</summary>
