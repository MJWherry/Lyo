...
public sealed class FileTypeInfo
{
    ...
    public static readonly FileTypeInfo Doc = new("DOC", "application/msword", ".doc", null, FileTypeCategory.Documents, "Microsoft Word document", ["application/x-msword"]);
    ...
    public static readonly FileTypeInfo Xls = new(
        "XLS", "application/vnd.ms-excel", ".xls", null, FileTypeCategory.Documents, "Microsoft Excel spreadsheet",
    ...
    public static readonly FileTypeInfo Csv = new(
        "CSV", "text/csv", ".csv", null, FileTypeCategory.DataFiles, "Comma-separated values file", ["text/comma-separated-values", "application/csv"]);
    ...
    public static readonly FileTypeInfo Json = new("JSON", "application/json", ".json", null, FileTypeCategory.DataFiles, "JSON data file", ["text/json", "application/x-json"]);

    public static readonly FileTypeInfo Xml = new("XML", "application/xml", ".xml", null, FileTypeCategory.DataFiles, "XML data file", ["text/xml"]);
    ...
    public static readonly FileTypeInfo Graphql = new("GraphQL", "application/graphql", ".graphql", [".gql"], FileTypeCategory.DataFiles, "GraphQL schema, query, or request body");

    public static readonly FileTypeInfo WwwFormUrlEncoded = new(
        "WWW form URL-encoded", "application/x-www-form-urlencoded", ".form", null, FileTypeCategory.DataFiles,
    ...
    // 🖼️ Image Formats
    public static readonly FileTypeInfo Jpeg = new("JPEG", "image/jpeg", ".jpg", [".jpeg"], FileTypeCategory.Images, "JPEG image file", ["image/jpg", "image/pjpeg"]);

    public static readonly FileTypeInfo Png = new("PNG", "image/png", ".png", null, FileTypeCategory.Images, "Portable Network Graphics image", ["image/x-png"]);
    ...
    public static readonly FileTypeInfo Bmp = new("BMP", "image/bmp", ".bmp", null, FileTypeCategory.Images, "Bitmap image file", ["image/x-ms-bmp", "image/x-bmp"]);

    public static readonly FileTypeInfo Svg = new("SVG", "image/svg+xml", ".svg", null, FileTypeCategory.Images, "Scalable Vector Graphics image", ["image/svg"]);

    public static readonly FileTypeInfo Tiff = new("TIFF", "image/tiff", ".tif", [".tiff"], FileTypeCategory.Images, "Tagged Image File Format", ["image/tif"]);

    public static readonly FileTypeInfo Webp = new("WEBP", "image/webp", ".webp", null, FileTypeCategory.Images, "WebP image file");

    public static readonly FileTypeInfo Ico = new("ICO", "image/vnd.microsoft.icon", ".ico", null, FileTypeCategory.Images, "Windows icon file", ["image/x-icon"]);

    // 📦 Compressed Formats
    public static readonly FileTypeInfo Zip = new("ZIP", "application/zip", ".zip", null, FileTypeCategory.Compressed, "ZIP archive file", ["application/x-zip-compressed"]);

    public static readonly FileTypeInfo Rar = new("RAR", "application/x-rar-compressed", ".rar", null, FileTypeCategory.Compressed, "RAR archive file", ["application/vnd.rar"]);
    ...
    public static readonly FileTypeInfo Tar = new("TAR", "application/x-tar", ".tar", null, FileTypeCategory.Compressed, "TAR archive file", ["application/gtar"]);

    public static readonly FileTypeInfo Gz = new("GZ", "application/gzip", ".gz", [".gzip"], FileTypeCategory.Compressed, "GZIP compressed file", ["application/x-gzip"]);

    public static readonly FileTypeInfo Bz2 = new(
        "BZ2", "application/x-bzip2", ".bz2", [".bzip2"], FileTypeCategory.Compressed, "BZIP2 compressed file", ["application/bzip2", "application/x-bzip"]);
    ...
    public static readonly FileTypeInfo Brotli = new(
        "Brotli", "application/x-brotli", ".br", null, FileTypeCategory.Compressed, "Brotli compressed stream", ["application/brotli"]);
    ...
    public static readonly FileTypeInfo ZstdStream = new(
        "Zstandard", "application/zstd", ".zst", null, FileTypeCategory.Compressed, "Zstandard compressed stream", ["application/x-zstd"]);
    ...
    public static readonly FileTypeInfo NuGetPackage = new("NuGet package", "application/x-nupkg", ".nupkg", null, FileTypeCategory.PackageManager, "NuGet package archive");
    ...
    public static readonly FileTypeInfo JavaJar = new("JAR", "application/java-archive", ".jar", null, FileTypeCategory.PackageManager, "Java archive (JAR)");

    public static readonly FileTypeInfo JavaWar = new("WAR", "application/x-java-war", ".war", null, FileTypeCategory.PackageManager, "Java web application archive (WAR)");

    public static readonly FileTypeInfo JavaEar = new("EAR", "application/x-java-ear", ".ear", null, FileTypeCategory.PackageManager, "Java enterprise archive (EAR)");

    public static readonly FileTypeInfo AndroidAar = new("AAR", "application/vnd.android.aar", ".aar", null, FileTypeCategory.PackageManager, "Android library archive (AAR)");
    ...
    public static readonly FileTypeInfo WindowsInstallerMsi = new("MSI", "application/x-msi", ".msi", null, FileTypeCategory.PackageManager, "Windows Installer package (MSI)");
    ...
    public static readonly FileTypeInfo LyoRsa = new("Lyo RSA", "application/x-lyo-ciphertext-rsa", ".rsa", null, FileTypeCategory.Encrypted, "Lyo RSA ciphertext");

    public static readonly FileTypeInfo LyoTwoKeyEnvelope = new(
        "Lyo two-key envelope", "application/x-lyo-two-key-envelope", ".ag2k", [".chacha2k", ".ccm2k", ".siv2k", ".xchacha2k", ".agr2k", ".rsa2k"], FileTypeCategory.Encrypted,
        "Lyo envelope: data encrypted with a DEK and key-wrapped by a KEK");

    // 🎵 Audio Formats
    public static readonly FileTypeInfo Wav = new("WAV", "audio/wav", ".wav", null, FileTypeCategory.Audio, "WAV audio file", ["audio/x-wav", "audio/wave"]);

    public static readonly FileTypeInfo Mp3 = new("MP3", "audio/mpeg", ".mp3", null, FileTypeCategory.Audio, "MP3 audio file", ["audio/mp3", "audio/x-mpeg", "audio/x-mp3"]);

    public static readonly FileTypeInfo Ogg = new("OGG", "audio/ogg", ".ogg", [".oga"], FileTypeCategory.Audio, "OGG audio file", ["application/ogg"]);

    public static readonly FileTypeInfo Flac = new("FLAC", "audio/flac", ".flac", null, FileTypeCategory.Audio, "FLAC audio file", ["audio/x-flac"]);

    public static readonly FileTypeInfo Aac = new("AAC", "audio/aac", ".aac", null, FileTypeCategory.Audio, "AAC audio file", ["audio/x-aac"]);

    public static readonly FileTypeInfo M4a = new("M4A", "audio/mp4", ".m4a", null, FileTypeCategory.Audio, "M4A audio file", ["audio/m4a", "audio/x-m4a"]);
    ...
    /// <summary>Encryption-related suffixes stripped from a filename before inferring compression (longest first; includes two-key and asymmetric variants).</summary>
    ...
    public FileTypeInfo(string name, string mimeType, string defaultExtension, string[]? aliases, FileTypeCategory category, string description, string[]? mimeTypeAliases = null)
    {
        Name = name;
        MimeType = mimeType;
