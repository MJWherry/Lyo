...
/// <summary>Catalog row for a social platform; <see cref="Slug" /> is the canonical key.</summary>
...
public sealed record SocialPlatformInfo(string Name, string Slug, string Description, string? WebsiteUri, string? ProfileUriTemplate, bool IsFederated, string[] Aliases)
{
    ...
    /// <summary>Registered platforms, excluding <see cref="Unknown" />.</summary>
    public static IReadOnlyList<SocialPlatformInfo> All => AllPlatforms;

    static SocialPlatformInfo()
    {
        var fields = typeof(SocialPlatformInfo).PublicStaticFields<SocialPlatformInfo>();
    ...
    /// <summary>Looks up a platform by canonical slug.</summary>
    ...
    /// <summary>Looks up a platform by display name.</summary>
    ...
    /// <summary>Looks up a platform by slug, display name, or alias.</summary>
    ...
    /// <summary>Mints a profile URL from a username or ActivityPub-style handle when a template exists.</summary>
