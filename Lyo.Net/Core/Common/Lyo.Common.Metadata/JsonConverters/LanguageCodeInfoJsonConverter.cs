...
/// <summary>System.Text.Json converter that stores <see cref="LanguageCodeInfo" /> as its BCP 47 token.</summary>
public class LanguageCodeInfoJsonConverter : JsonConverter<LanguageCodeInfo>
{
    public override LanguageCodeInfo Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        if (reader.TokenType == JsonTokenType.String) {
            ...
            // Resolve BCP 47 first, then ISO 639-1, then ISO 639-3.
...
/// <summary>System.Text.Json converter for a nullable <see cref="LanguageCodeInfo" />.</summary>
