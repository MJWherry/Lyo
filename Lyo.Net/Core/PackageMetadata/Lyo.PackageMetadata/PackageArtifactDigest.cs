...
/// <summary>Hex digest helpers for package artifact bytes (for example <c>.nupkg</c>, <c>.jar</c>). NuGet feed <c>packageHash</c> uses SHA-512 lowercase hex.</summary>
public static class PackageArtifactDigest
{
    /// <summary>Returns a lowercase hex digest of <paramref name="contents" /> using <paramref name="algorithm" />.</summary>
    ...
    /// <summary>Returns a lowercase hex digest of the remainder of <paramref name="stream" /> from its current position.</summary>
