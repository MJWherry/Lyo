...
/// <summary>Thread-safe in-memory <see cref="IPackageMetadataStore" /> keyed by namespace prefixes (longest match wins). Intended for tests or seed data.</summary>
public sealed class InMemoryPackageMetadataStore : IPackageMetadataStore
{
    ...
    /// <summary>Registers prefixes for one package. Prefixes that lack a trailing <c>.</c> are normalised to include one.</summary>
