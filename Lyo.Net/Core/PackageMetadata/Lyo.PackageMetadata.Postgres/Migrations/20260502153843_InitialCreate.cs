        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    package_types_json = table.Column<string>(type: "text", nullable: true),
                    ...
                    repository_url = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    license_url = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    license_expression = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    package_details_url = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
