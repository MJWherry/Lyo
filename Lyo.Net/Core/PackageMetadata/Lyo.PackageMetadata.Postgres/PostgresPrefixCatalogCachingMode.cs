...
public enum PostgresPrefixCatalogCachingMode
{
    ...
    /// <summary>Caches the ordered prefix list in memory. Entries are invalidated when <see cref="IPackageMetadataStore.RegisterManyAsync" /> succeeds on this instance, or when <see cref="PostgresPackageMetadataStore.ClearPrefixCatalogCache" /> is called.</summary>
