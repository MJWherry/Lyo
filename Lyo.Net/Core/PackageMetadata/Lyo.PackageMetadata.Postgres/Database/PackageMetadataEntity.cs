...
/// <summary>EF entity for one registered package artifact row.</summary>
public sealed class PackageMetadataEntity
{
    ...
    /// <summary>Lowercase hex digest stored when <see cref="ArtifactDigestAlgorithm" /> is not <see cref="ArtifactDigestAlgorithm.None" />.</summary>
    [MaxLength(128)]
    ...
    /// <summary>JSON tree for <see cref="LicenseExpression" /> using <c>and</c>, <c>or</c>, <c>with</c>, <c>license</c>, and <c>exception</c>.</summary>
    [MaxLength(16384)]
