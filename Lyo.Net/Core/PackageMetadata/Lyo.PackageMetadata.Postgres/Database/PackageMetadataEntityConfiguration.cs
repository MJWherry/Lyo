...
public sealed class PackageMetadataEntityConfiguration : IEntityTypeConfiguration<PackageMetadataEntity>
{
    public void Configure(EntityTypeBuilder<PackageMetadataEntity> builder)
    {
        ...
        builder.Property(e => e.Description).HasColumnType("text").HasColumnName("description").HasMaxLength(4000);
        builder.Property(e => e.AuthorsJson).HasColumnType("text").HasColumnName("authors_json").HasMaxLength(4096);
        builder.Property(e => e.PackageTypesJson).HasColumnType("text").HasColumnName("package_types_json").HasMaxLength(4096);
        builder.Property(e => e.TagsJson).HasColumnType("text").HasColumnName("tags_json").HasMaxLength(4096);
        builder.Property(e => e.ProjectUrl).HasMaxLength(512).HasColumnName("project_url");
        builder.Property(e => e.RepositoryUrl).HasMaxLength(512).HasColumnName("repository_url");
        builder.Property(e => e.LicenseUrl).HasMaxLength(512).HasColumnName("license_url");
        builder.Property(e => e.LicenseExpression).HasMaxLength(500).HasColumnName("license_expression");
        builder.Property(e => e.LicenseExpressionSyntaxJson).HasColumnType("text").HasColumnName("license_expression_syntax_json").HasMaxLength(16384);
        builder.Property(e => e.PackageDetailsUrl).HasMaxLength(512).HasColumnName("package_details_url");
