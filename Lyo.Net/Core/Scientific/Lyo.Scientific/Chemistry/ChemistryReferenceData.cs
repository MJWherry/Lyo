...
/// <summary>Nuclide row: symbol, mass number, atomic mass, and optional terrestrial abundance.</summary>
...
public sealed record Isotope
{
    ...
    /// <summary>Mass number A (protons plus neutrons); must be positive.</summary>
    public int MassNumber { get; init; }

    /// <summary>Atomic mass for this nuclide (dalton-scale numeric used by this catalog).</summary>
    public double AtomicMass { get; init; }

    /// <summary>Natural terrestrial abundance in percent when known; otherwise <see langword="null" />.</summary>
    public double? NaturalAbundancePercent { get; init; }

    /// <summary>Mints an isotope after checking inputs.</summary>
    /// <param name="symbol">Chemical element symbol.</param>
    /// <param name="massNumber">Strictly positive mass number A.</param>
...
{
    /// <summary>Case-insensitive lookup from element symbol to standard relative atomic weight.</summary>
...
/// <summary>Hand-picked isotope rows for common chemistry and nuclear examples.</summary>
public static class Isotopes
{
    /// <summary>Representative isotopes of hydrogen, carbon, oxygen, and uranium, with masses and abundances.</summary>
