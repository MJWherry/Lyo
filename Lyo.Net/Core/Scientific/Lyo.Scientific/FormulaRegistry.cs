...
/// <summary>Hand-picked catalog of scientific formulas implemented in <c>Lyo.Scientific.Functions</c>.</summary>
/// <remarks>
/// <see cref="All" /> is deliberately short: use it for UI discovery, capability flags, or onboarding — not as a complete index of every function. Rows reuse
/// <see cref="FormulaDescriptor" /> from <c>Lyo.Mathematics</c> so the scientific and mathematics registries share one metadata shape.
/// </remarks>
public static class ScientificFormulaRegistry
{
    /// <summary>Stable ids, display names, and signature hints for a representative set of scientific calculations.</summary>
