...
public class BadRequestExceptionTests
{
    ...
    public void Default_Has400AndDefaultMessage()
    {
        ...
        HttpExceptionAssert.DefaultHas(ex, 400, "The request is invalid.");
    ...
    {
        HttpExceptionAssert.MessageIs(new BadRequestException("Body is malformed."), "Body is malformed.");
    }
    ...
    public void MessageConstructor_WithInner_SetsInnerException()
    {
        ...
        HttpExceptionAssert.InnerIs(new BadRequestException("Body is malformed.", inner), inner);
    }
...
public class UnprocessableEntityExceptionTests
{
    ...
    public void Default_Has422AndEmptyErrors()
    {
        ...
        HttpExceptionAssert.DefaultHas(ex, 422, "The request could not be processed.");
    ...
    public void MessageConstructor_UsesMessage()
    {
        ...
        HttpExceptionAssert.MessageIs(ex, "Cannot process.");
        Assert.Empty(ex.Errors);
    }
    ...
    public void MessageConstructor_WithInner_SetsInnerException()
    {
        ...
        HttpExceptionAssert.InnerIs(new UnprocessableEntityException("Cannot process.", inner), inner);
    }
...
public class GoneExceptionTests
{
    ...
    public void Default_Has410AndDefaultMessage()
    {
        ...
        HttpExceptionAssert.DefaultHas(ex, 410, "The requested resource is no longer available.");
    ...
    {
        var inner = new InvalidOperationException("cause");
        HttpExceptionAssert.InnerIs(new GoneException("Removed.", inner), inner);
    }
...
public class GatewayTimeoutExceptionTests
{
    ...
    public void Default_Has504AndDefaultMessage()
    {
        ...
        HttpExceptionAssert.DefaultHas(ex, 504, "The upstream service did not respond in time.");
    }
...
public class HttpExceptionsFactoryTests
{
    ...
    public void FromStatusCode_PropagatesInnerException()
    {
        ...
        HttpExceptionAssert.InnerIs(HttpExceptions.FromStatusCode(504, "boom", inner), inner);
    }
...
public class ForResourceFactoryTests
{
    ...
    {
        // Regression: new NotFoundException("User", null) binds to (message, Exception?) and never assigns ResourceName.
    ...
    {
        var inner = new InvalidOperationException("cause");
        HttpExceptionAssert.InnerIs(NotFoundException.ForResource("User", 42, inner), inner);
    }
