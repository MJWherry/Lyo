...
/// <summary>
/// Helper methods for argument validation that throw <see cref="ArgumentException" />, <see cref="ArgumentNullException" />, <see cref="ArgumentOutsideRangeException" />,
...
public static class ArgumentHelpers
{
    ...
    /// Thrown when argument is null (non–.NET Standard 2.0), empty, or consists only of white-space characters; or when empty or whitespace-only (.NET
    /// Standard 2.0).
    /// </exception>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
    ...
    /// <summary>Throws an ArgumentOutsideRangeException if the reference-type value is not within the specified range.</summary>
    /// <param name="value">The value to check.</param>
    /// <param name="min">The minimum allowed value (inclusive). Omit or pass null to skip the minimum check.</param>
    /// <param name="max">The maximum allowed value (inclusive). Omit or pass null to skip the maximum check.</param>
    /// <param name="paramName">Supplies <see cref="ArgumentException.ParamName" />. Omitted: caller expression for <paramref name="value" />.</param>
    ...
    /// <summary>Throws an ArgumentOutsideRangeException if the value is not within the specified range. Overload for non-nullable values, where the null check is vacuous.</summary>
    /// <param name="value">The value to check.</param>
    /// <param name="min">Inclusive minimum; omit or pass null to skip the minimum check.</param>
    /// <param name="max">Inclusive maximum; omit or pass null to skip the maximum check.</param>
    /// <param name="paramName">Supplies <see cref="ArgumentException.ParamName" />. Omitted: caller expression for <paramref name="value" />.</param>
    ...
    /// <remarks>
    /// Delegates to <see cref="ThrowIfNull" /> for a null reference, then checks for an empty sequence. For single-use enumerables (e.g. LINQ without ToList), prefer passing
    ...
    /// <summary>Throws an ArgumentException if the value equals <c>default(T)</c> (e.g. an unset <see cref="DateTime" /> or a default struct).</summary>
    ...
    /// <summary>Throws an ArgumentException if the enum value is not a defined member of <typeparamref name="TEnum" /> (e.g. after casting from an int or parsing user input).</summary>
