...
/// <summary>
/// Guards for operation validation that throw <see cref="InvalidOperationException" />, <see cref="ObjectDisposedException" />,
...
public static class OperationHelpers
{
    ...
    /// <summary>Throws InvalidOperationException when the condition is true.</summary>
    /// <param name="condition">Condition under test. When true, InvalidOperationException is thrown.</param>
    /// <param name="message">Message used for the exception.</param>
    /// <exception cref="InvalidOperationException">Thrown if the condition is true.</exception>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    ...
    /// <summary>Throws InvalidOperationException when the value is null.</summary>
    ...
    /// <summary>Throws InvalidOperationException when the string is null or whitespace.</summary>
    /// <param name="value">String under test.</param>
    /// <param name="message">Exception message. When null, a default message is used.</param>
    /// <exception cref="InvalidOperationException">Thrown if the value is null or whitespace.</exception>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws InvalidOperationException when the string is null or empty.</summary>
    /// <param name="value">String under test.</param>
    /// <param name="message">Exception message. When null, a default message is used.</param>
    /// <exception cref="InvalidOperationException">Thrown if the value is null or empty.</exception>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws InvalidOperationException when the collection is null or empty.</summary>
    /// <typeparam name="T">Element type of the collection.</typeparam>
    /// <param name="collection">Collection under test.</param>
    /// <param name="paramName">Parameter name included in the error message, when provided.</param>
    /// <remarks>Calls <see cref="ThrowIfNull" /> when the collection reference is null, then checks for an empty sequence.</remarks>
    /// <exception cref="InvalidOperationException">Thrown if the collection is null (via <see cref="ThrowIfNull" />) or empty.</exception>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws InvalidOperationException when the stream is null or not readable.</summary>
    /// <param name="stream">Stream under test.</param>
    /// <param name="message">Exception message. When null, a default message is used.</param>
    /// <exception cref="InvalidOperationException">Thrown if the stream is null or not readable.</exception>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws InvalidOperationException when the stream is null or not writable.</summary>
    /// <param name="stream">Stream under test.</param>
    /// <param name="message">Exception message. When null, a default message is used.</param>
    /// <exception cref="InvalidOperationException">Thrown if the stream is null or not writable.</exception>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws ObjectDisposedException when the disposed flag is true.</summary>
    /// <param name="disposed">Flag indicating whether the object has been disposed.</param>
    /// <param name="objectName">Name of the disposed object. When null, a generic message is used.</param>
    ...
    /// <summary>Throws OperationCanceledException when the cancellation token has been cancelled.</summary>
    /// <param name="ct">Cancellation token under test.</param>
    /// <exception cref="OperationCanceledException">Thrown if the token has been cancelled.</exception>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws NotSupportedException when the condition is true.</summary>
    /// <param name="condition">Condition under test. When true, NotSupportedException is thrown.</param>
    /// <param name="message">Exception message. When null, a default message is used.</param>
    /// <exception cref="NotSupportedException">Thrown if the condition is true.</exception>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the value is not within the specified range.</summary>
    /// <param name="value">Value under test.</param>
    ...
    /// <param name="message">Optional override for the exception message.</param>
    /// <exception cref="InvalidOperationException">Thrown if the value is not in the range [min, max].</exception>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the reference-type value is not within the specified range.</summary>
    /// <param name="value">Value under test.</param>
    /// <param name="min">Inclusive minimum. Omit or pass null to skip the minimum check.</param>
    /// <param name="max">Inclusive maximum. Omit or pass null to skip the maximum check.</param>
    /// <param name="paramName">Omitted: caller expression for <paramref name="value" />. Included in the exception message when provided.</param>
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the nullable value is null or not within the specified range.</summary>
    ...
    /// <summary>
    /// Throws <see cref="InvalidOperationException" /> when the value is not within the specified range. Overload for non-nullable values, where the null
    /// check is vacuous.
    /// </summary>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the value is null or not within the specified range.</summary>
    /// <remarks>Delegates to <see cref="ThrowIfNull(System.Object,string?)" />; if not null, applies <see cref="ThrowIfNotInRange{T}(T,T?,T?,string?,string?)" />.</remarks>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the <see cref="DateTime" /> value is not within the specified range.</summary>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the nullable <see cref="DateTime" /> value is null or not within the specified range.</summary>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the <see cref="TimeSpan" /> value is not within the specified range.</summary>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the nullable <see cref="TimeSpan" /> value is null or not within the specified range.</summary>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the array length is null or not within the specified range.</summary>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the array length is not within the specified range.</summary>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>Throws <see cref="InvalidOperationException" /> when the value is zero.</summary>
#if NET6_0_OR_GREATER
    [StackTraceHidden]
#endif
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
