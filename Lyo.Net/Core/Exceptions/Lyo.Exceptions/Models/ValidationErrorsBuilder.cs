...
/// <summary>
/// Accumulates field-level validation errors and throws one <see cref="ValidationException" /> only when errors exist. Avoids hand-building the errors dictionary and
...
public sealed class ValidationErrorsBuilder
{
    ...
    /// <summary>True when any errors have been added.</summary>
    ...
    /// <summary>Adds an error message for a field. Several messages may be added for the same field.</summary>
    ...
    /// <summary>Adds several error messages for a field. Null, empty, and whitespace-only messages are skipped.</summary>
    /// <param name="fieldName">The name of the field that failed validation.</param>
    ...
    /// <summary>Returns the accumulated errors in the dictionary shape used by <see cref="ValidationException.Errors" />.</summary>
    ...
    /// <summary>Throws a <see cref="ValidationException" /> containing every accumulated error when any exist; otherwise does nothing.</summary>
