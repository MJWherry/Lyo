...
/// <summary>
/// Seeded, reproducible byte payloads for xUnit suites. Prefer this over an unseeded <see cref="Random" /> or <see cref="System.Security.Cryptography.RandomNumberGenerator" />
...
{
    /// <summary>Shared payload seed (<c>0x4C594F42</c> / "LYOB"). Matches the benchmark suites.</summary>
    public const int Seed = DeterministicPayloadStream.DefaultSeed;

    /// <summary>Fills <paramref name="buffer" /> with deterministic bytes from <paramref name="seed" /> (falls back to <see cref="Seed" />).</summary>
