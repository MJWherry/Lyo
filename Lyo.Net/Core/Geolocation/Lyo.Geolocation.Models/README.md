...
[`Addresses.Address`](Addresses/Address.cs) exposes `ICollection<EntitySourceRecord> Sources`. Persisted via [`address_source`](../Lyo.Geolocation.Postgres/README.md). The **`source_entity_type`** string is chosen by the **importing application** (e.g. a constant in `Lyo.Google.Geolocation.Client`), not hard-coded in this package.
