...
{
    [Fact]
    public void Iban_WhenMod97Valid_Redacts()
    {
    ...
    [Fact]
    public void Iban_InvalidChecksum_Skips()
    {
        var r = new TextRedactor(PrivacyPolicies.Minimal(b => b.AddRule(new IbanRedactionRule())));
    ...
    [Fact]
    public void BankAccount_Heuristic_MasksLongDigitRun()
    {
    ...
    [Fact]
    public void BankAccount_MinNumeric_FiltersSmallNumbers()
    {
    ...
    [Fact]
    public void ApiSecret_AwsGithubAndAssignment_Redacts()
    {
    ...
    [Fact]
    public void ApiSecret_LowEntropyAssignment_Skips()
    {
    ...
    [Fact]
    public void ApiSecret_LyoTokenFormatB_Redacts()
    {
    ...
    [Fact]
    public void ApiSecret_NonMatchingPrefix_Ignores()
    {
        var rule = new ApiSecretRedactionRule(ApiSecretPatterns.LyoToken);
        var r = new TextRedactor(PrivacyPolicies.Minimal(b => b.AddRule(rule)));
    ...
    [Fact]
    public void NationalId_UsPack_MatchesSsnShape()
    {
    ...
    [Fact]
    public void PaymentCard_AllowedBinOnly_RedactsMatchingPrefix()
    {
    ...
    [Fact]
    public void PaymentCard_BlockedBin_Skips()
    {
    ...
    [Fact]
    public void NeverRedact_Literals_PreserveSubstrings()
    {
    ...
    [Fact]
    public void RedactText_SpanOverload_MatchesStringPath()
    {
    ...
    [Fact]
    public void RedactJsonUtf8_Utf8Input_DoesNotUseStringCtor()
    {
    ...
    [Fact]
    public void RedactJsonStream_Utf8_RoundTrips()
    {
    ...
    [Fact]
    public void PolicyJson_ExpectedRules_Builds()
    {
        const string json = """
                            {
                              "placeholder": "■",
    ...
    [Fact]
    public void Fingerprint_PlaceholderChange_ChangesWithoutSecrets()
    {
    ...
    [Fact]
    public void RedactXml_SensitiveElement_Placeholders()
    {
    ...
    [Fact]
    public void RedactXml_InvalidXml_FallsBackToText()
    {
    ...
    [Fact]
    public void PhoneMask_LastFour_FactoryApplies()
    {
    ...
    [Fact]
    public void EmailMask_PartialLocal_FactoryApplies()
    {
