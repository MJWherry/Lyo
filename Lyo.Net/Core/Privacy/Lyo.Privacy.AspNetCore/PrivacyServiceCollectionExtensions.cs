...
/// <summary>Adds <see cref="ITextRedactor" /> and <see cref="IStructuredRedactor" /> to the DI container.</summary>
public static class PrivacyServiceCollectionExtensions
{
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddLyoPrivacy(
            ...
            Action<RedactionPolicyBuilder>? configureDefaultPolicy = null)
        {
            ...
            services.TryAddSingleton(sp => sp.GetRequiredService<IOptions<PrivacyRedactorOptions>>().Value);
        ...
        /// <summary>Adds a keyed <see cref="ITextRedactor" /> (for example <c>"Support"</c>).</summary>
        public IServiceCollection AddLyoPrivacyPolicy(object serviceKey, Action<RedactionPolicyBuilder> configure)
        {
