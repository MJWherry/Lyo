...
/// <summary>User-supplied pattern, with optional per-match formatting.</summary>
public sealed class RegexRedactionRule : IRedactionRule, IRedactionMatchFormatter
{
    ...
    /// <summary>Pattern string handed to the internal <see cref="Regex" />.</summary>
    public string Pattern => _regex.ToString();

    /// <summary>Effective regex options (includes compiled and culture-invariant flags set by this type).</summary>
