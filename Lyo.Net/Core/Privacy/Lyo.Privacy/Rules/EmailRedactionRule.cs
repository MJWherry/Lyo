...
/// <summary>Finds email-shaped tokens; masking follows <see cref="EmailMaskOptions" />.</summary>
public sealed class EmailRedactionRule : IRedactionRule, IRedactionMatchFormatter
{
    ...
    /// <summary>Compatibility constructor that maps <see cref="EmailMaskStyle" /> onto <see cref="EmailMaskOptions" />.</summary>
