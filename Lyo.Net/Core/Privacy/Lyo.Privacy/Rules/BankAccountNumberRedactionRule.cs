...
/// <summary>Heuristic digit runs that look like account numbers (false positives are expected).</summary>
public sealed class BankAccountNumberRedactionRule : IRedactionRule
{
    ...
    /// <summary>When set, drops candidates whose full digit string parses below this value (cuts small-number noise).</summary>
