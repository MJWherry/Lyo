...
/// <summary>Phone-shaped runs; masking follows <see cref="PhoneMaskOptions" />.</summary>
public sealed class PhoneRedactionRule : IRedactionRule, IRedactionMatchFormatter
{
    /// <summary>Group separators are tab/space only — not <see cref="RegexOptions.Singleline" /> \s — so matches never span newlines.</summary>
    ...
    /// <summary>Builds a rule from explicit options (preferred when you need custom visibility).</summary>
    ...
    /// <summary>Compatibility constructor: maps <see cref="PhoneMaskMode" /> onto <see cref="PhoneMaskOptions" />.</summary>
