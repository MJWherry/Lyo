...
/// <summary>13–19 digit sequences that pass Luhn; the prefix is masked and the last 4 stay visible. Optional BIN filters.</summary>
public sealed class PaymentCardRedactionRule : IRedactionRule
{
    ...
    /// <summary>When non-empty, only runs whose first six digits appear in this set get redacted.</summary>
    public HashSet<string>? AllowedBin6 { get; init; }

    /// <summary>When non-empty, runs whose first six digits appear in this set are left alone.</summary>
