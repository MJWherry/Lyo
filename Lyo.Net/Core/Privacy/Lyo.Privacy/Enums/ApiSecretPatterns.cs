...
public enum ApiSecretPatterns
{
    ...
    /// <summary>
    /// Format-B Lyo opaque tokens such as <c>lyo_pat_live_01HXY...</c>. Matched independently of <see cref="HighEntropyAssignment" /> so they redact even when not assigned to a
    /// variable.
    /// </summary>
    LyoToken = 1 << 3
}