...
/// <summary>
/// Built-in redaction presets. These helpers cover operational hygiene (logs, exports, UI), not statutory compliance frameworks (for example HIPAA Safe Harbor or GDPR
/// pseudonymisation as legal terms).
/// </summary>
public static class PrivacyPolicies
{
    /// <summary>Appends rules for a named preset onto an existing builder (does not clear the builder).</summary>
    ...
    /// <summary>Only the rules you add yourself (plus an optional configure callback).</summary>
    ...
    /// <summary>Typical APM / log shipping: email, partial phone, cards, URL queries, and truncated IPv4.</summary>
    ...
    /// <summary>Tier-1 artifacts: the logging core plus bearer tokens and JWT-shaped strings.</summary>
    ...
    /// <summary>End-user visible strings: full IP and phone masking, plus financial, URL, and email patterns.</summary>
    ...
    /// <summary>Deterministic placeholder intended for snapshot tests.</summary>
    ...
    /// <summary>Builds a policy from a preset name plus optional extra configuration.</summary>
