...
/// <summary>Settings for <see cref="XmlRedactor" /> (element local names are case-insensitive).</summary>
...
public sealed class XmlRedactorOptions
{
    ...
    /// <summary>Runs <see cref="ITextRedactor" /> on text nodes whose element is absent from <see cref="SensitiveElementLocalNames" />.</summary>
