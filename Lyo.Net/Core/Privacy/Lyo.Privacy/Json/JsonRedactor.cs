...
/// <summary>Rewrites JSON, redacting scalars for configured keys.</summary>
public sealed class JsonRedactor : IStructuredRedactor
{
    ...
    /// <summary>Parses UTF-8 JSON without building an intermediate <see cref="string" /> for the document. <see cref="RedactionResult.InputUtf16Length" /> is null.</summary>
    ...
    /// <summary>Buffers the input stream, then redacts via <see cref="RedactJsonUtf8" />; writes UTF-8 to <paramref name="utf8Output" />.</summary>
