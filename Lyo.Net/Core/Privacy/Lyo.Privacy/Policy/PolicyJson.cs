...
/// <summary>Deserializes policy JSON into <see cref="RedactionPolicyBuilder" /> rules, and serializes <see cref="RedactionPolicy" /> back to the same shape.</summary>
public static class PolicyJson
{
    ...
    /// <summary>Builds a policy from JSON. An optional callback mutates the builder before <see cref="RedactionPolicyBuilder.Build" />.</summary>
    ...
    /// <summary>
    /// Serializes a policy to JSON that <see cref="Build" /> can read. Rules must be concrete types this library can map;
    /// <see cref="DelegateRedactionRule" /> is not supported.
    /// </summary>
    ...
    /// <summary>Builds the JSON DTO used by <see cref="SerializePolicy" /> without stringifying.</summary>
