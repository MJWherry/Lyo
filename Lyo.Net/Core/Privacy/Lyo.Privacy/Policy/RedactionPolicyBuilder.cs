...
/// <summary>Fluent builder for composing <see cref="RedactionPolicy" /> instances.</summary>
public sealed class RedactionPolicyBuilder
{
    ...
    /// <summary>
    /// Optional name stored on <see cref="RedactionPolicy.Name" /> for metrics (tag <c>policy</c>) and <see cref="RedactionResult.PolicyName" />. Whitespace-only is treated as
    /// unset.
    /// </summary>
    ...
    /// <summary>Literal substrings that stay unmasked (staging markers, etc.). Compared with <see cref="StringComparison.Ordinal" />.</summary>
    ...
    /// <summary>Registers one never-redact literal.</summary>
    ...
    /// <summary>Equivalent to <see cref="AddRule(IRedactionRule)" />; handy when the rule type is already explicit at the call site.</summary>
    ...
    /// <summary>Copies every rule from an existing policy (this builder's placeholder and never-redact literals stay as they are).</summary>
    ...
    /// <summary>Registers a <see cref="PhoneRedactionRule" /> configured with <see cref="PhoneMaskOptions" />.</summary>
    ...
    /// <summary>Registers a <see cref="PhoneRedactionRule" /> from legacy <see cref="PhoneMaskMode" /> (mapped onto <see cref="PhoneMaskOptions" />).</summary>
    ...
    /// <summary>Registers an <see cref="EmailRedactionRule" /> configured with <see cref="EmailMaskOptions" />.</summary>
    public RedactionPolicyBuilder AddEmailRule(EmailMaskOptions options) => AddRule(new EmailRedactionRule(options));

    /// <summary>Registers an <see cref="EmailRedactionRule" /> from legacy <see cref="EmailMaskStyle" />.</summary>
    ...
    /// <summary>Registers a <see cref="PaymentCardRedactionRule" /> with optional BIN allow/block lists (first six digits).</summary>
    ...
    /// <summary>Registers a <see cref="UrlRedactionRule" />.</summary>
    public RedactionPolicyBuilder AddUrlRule() => AddRule(new UrlRedactionRule());

    /// <summary>Registers an <see cref="IpAddressRedactionRule" />.</summary>
    ...
    /// <summary>Registers an <see cref="AddressRedactionRule" />.</summary>
    public RedactionPolicyBuilder AddAddressRule() => AddRule(new AddressRedactionRule());

    /// <summary>Registers an <see cref="IbanRedactionRule" />.</summary>
    public RedactionPolicyBuilder AddIbanRule() => AddRule(new IbanRedactionRule());

    /// <summary>Registers a <see cref="BankAccountNumberRedactionRule" />.</summary>
    ...
    /// <summary>Registers a <see cref="NationalIdRedactionRule" /> for the supplied <see cref="NationalIdPacks" />.</summary>
    public RedactionPolicyBuilder AddNationalIdRule(NationalIdPacks packs) => AddRule(new NationalIdRedactionRule(packs));

    /// <summary>Registers an <see cref="ApiSecretRedactionRule" />.</summary>
    ...
    /// <summary>Registers a <see cref="LiteralSubstringRedactionRule" />.</summary>
    ...
    /// <summary>Registers a <see cref="RegexRedactionRule" />.</summary>
