...
namespace Lyo.People.Postgres.Migrations
{
    ...
    [Migration("20260728023226_AddPersonQueryIndexes")]
    partial class AddPersonQueryIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lyo.People.Postgres.Database.PersonEntity", b =>
                {
                    ...
                    b.HasIndex("SourceEntityType")
                        .HasDatabaseName("ix_person_source_entity_type");
                    ...
                    b.HasIndex("FirstName", "LastName", "DateOfBirth")
                        .HasDatabaseName("ix_person_first_name_last_name_date_of_birth");

                    b.HasIndex("LastName", "FirstName", "Id")
                        .HasDatabaseName("ix_person_last_name_first_name_id");
