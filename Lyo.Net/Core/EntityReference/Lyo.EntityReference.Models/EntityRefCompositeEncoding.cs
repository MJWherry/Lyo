...
{
    /// <summary>Joins ordered segments into one composite id (multi-part keys only).</summary>
    ...
    /// <returns>Ordered segments as originally joined (after unescaping).</returns>
