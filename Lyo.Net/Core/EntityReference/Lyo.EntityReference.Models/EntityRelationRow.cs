...
public abstract class EntityRelationRow
{
    ...
    /// <summary>Soft-delete timestamp (UTC), when deleted.</summary>
    public DateTime? DeletedAt { get; set; }

    /// <summary>Type of actor that performed the soft-delete.</summary>
    public string? DeletedByType { get; set; }

    /// <summary>Id of the actor that performed the soft-delete.</summary>
    ...
    /// <summary>Entity reference for the subject of this row.</summary>
    public EntityRef SubjectRef => EntityRef.ForKey(SubjectEntityType ?? string.Empty, SubjectEntityId ?? string.Empty);

    /// <summary>Entity reference for the actor of this row.</summary>
