...
/// <summary>Domain type imported from or linked to an external source; local edits may cause it to diverge.</summary>
public interface IEntitySourceDerived
{
    ...
    /// <summary>When set, content was changed after import and may no longer match the external source.</summary>
