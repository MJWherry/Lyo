...
/// <summary>Checks external source keys on provenance records.</summary>
public static class EntitySourceValidation
{
    /// <summary>Requires a non-null external source reference.</summary>
    ...
    /// <summary>Requires a non-null external source on a provenance record.</summary>
