...
/// <summary>Per-feature tenancy configuration. Each property is nullable so feature options can inherit from <see cref="EntityRefOptions" />.</summary>
[DebuggerDisplay("{ToString(),nq}")]
public sealed class TenancyOptions
{
    /// <summary>Overrides the per-feature tenancy mode. When <see langword="null" /> the feature inherits <see cref="EntityRefOptions.Mode" />.</summary>
