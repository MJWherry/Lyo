...
/// <summary>
/// Stable logical name for <see cref="EntityRef.For{T}(object[])" /> and <see cref="EntityRef.For{T}(T, System.Func{T, object?})" />. Prefer this over CLR
/// <see cref="Type.FullName" /> for persisted references so renames and assembly moves do not break keys.
/// </summary>
...
public sealed class EntityRefLogicalTypeAttribute : Attribute
{
    ...
    /// <summary>Mints a new instance of the attribute.</summary>
