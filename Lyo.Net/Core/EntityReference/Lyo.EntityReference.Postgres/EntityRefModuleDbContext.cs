...
/// <summary>Base <see cref="DbContext" /> that stamps <see cref="EntityRelationEntityBase.CreatedAt" /> on insert when it is still default.</summary>
public abstract class EntityRefModuleDbContext : DbContext
{
    /// <summary>Mints the context.</summary>
    ...
    /// <summary>Sets <see cref="EntityRelationEntityBase.CreatedAt" /> to UTC now for added <see cref="EntityRelationEntityBase" /> entries that are still default.</summary>
