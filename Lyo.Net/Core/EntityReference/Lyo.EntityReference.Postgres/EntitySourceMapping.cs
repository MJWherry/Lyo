...
/// <summary>Maps <see cref="EntitySourceRecord" /> to and from <see cref="EntitySourceEntityBase" />.</summary>
public static class EntitySourceMapping
{
    ...
    /// <summary>Marks a source-derived aggregate as locally modified when it has a source and the content changed.</summary>
