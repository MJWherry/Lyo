...
/// <summary>Shared EF mapping for <see cref="EntityRelationEndpointsEntityBase" /> columns.</summary>
public static class EntityRelationEndpointConfigurationExtensions
{
    ...
    /// <summary>Maps nullable subject/actor endpoint columns (stored as for_entity_* / from_entity_*).</summary>
