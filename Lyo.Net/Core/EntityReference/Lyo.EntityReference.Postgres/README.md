...
2. Implement **`IEntityTypeConfiguration<T>`** inheriting **`EntityRelationConfiguration<T>`** or call **`ConfigureEntitySourceColumns`**, then map module-specific columns/indexes
