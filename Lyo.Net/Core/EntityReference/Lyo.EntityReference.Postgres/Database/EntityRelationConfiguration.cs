...
/// <summary>Maps the canonical columns and indexes for <see cref="EntityRelationEntityBase" /> subclasses.</summary>
    ...
    where TEntity : EntityRelationEntityBase
{
    ...
    /// <summary>Mints configuration using <paramref name="indexPrefix" /> for PostgreSQL index names (for example <c>favorite</c>, <c>tag</c>).</summary>
    ...
    /// <summary>Maps shared relation columns; call from <see cref="Configure" /> after <c>ToTable</c> / <c>HasKey</c>.</summary>
