...
/// <summary>
/// EF columns for a string-keyed subject plus an optional actor (for example audit / change history). Not the tenant-scoped <see cref="EntityRelationEntityBase" /> row
/// with lifecycle columns.
/// </summary>
[DebuggerDisplay("{ToString(),nq}")]
public abstract class EntityRelationOptionalActorBase : EntityRelationEndpointsEntityBase
{
    /// <summary>Optional tenant scope. <see langword="null" /> means system or no tenant.</summary>
