...
/// <summary>Shared EF mapping for <see cref="EntitySourceEntityBase" /> columns.</summary>
public static class EntitySourceLinkConfigurationExtensions
{
    ...
    /// <summary>Maps inline provenance columns and lookup indexes on the parent tables.</summary>
    ...
    /// <summary>Maps <see cref="EntitySourceDerivedEntityBase" /> lifecycle columns onto parent aggregates.</summary>
