...
/// <summary>Three-dimensional Euclidean vector whose components are finite.</summary>
/// <remarks>Offers dot/cross products, angles, projections, and normalization in line with graphics and mechanics conventions.</remarks>
...
public readonly record struct Vector3D
{
    ...
    /// <summary>Builds a vector after checking that all components are finite.</summary>
    /// <param name="x">Finite X-axis component.</param>
    /// <param name="y">Finite Y-axis component.</param>
    /// <param name="z">Finite Z-axis component.</param>
    ...
    /// <summary>Returns a unit vector pointing the same way.</summary>
    ...
    /// <summary>Angle between the vectors, in radians (range [0, π]).</summary>
