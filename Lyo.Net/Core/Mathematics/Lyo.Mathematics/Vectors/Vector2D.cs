...
/// <summary>Two-dimensional Euclidean vector whose components are finite.</summary>
/// <remarks>Used by geometry and linear-system helpers; normalization rejects the zero vector.</remarks>
...
public readonly record struct Vector2D
{
    ...
    /// <summary>Builds a vector after checking that both components are finite.</summary>
