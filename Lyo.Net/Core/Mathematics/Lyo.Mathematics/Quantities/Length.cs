...
/// <summary>Typed length used by formulas and engineering models.</summary>
/// <remarks>
...
{
    /// <summary>SI storage scalar in Meters (canonical unit for this Length).</summary>
    public double Meters { get; }

    /// <summary>This quantity in Centimeters.</summary>
    public double Centimeters => Meters * 100d;

    /// <summary>This quantity in Kilometers.</summary>
    public double Kilometers => Meters / 1000d;

    /// <summary>This quantity in Inches.</summary>
    public double Inches => Meters / 0.0254d;

    /// <summary>This quantity in Feet.</summary>
    public double Feet => Meters / 0.3048d;

    /// <summary>This quantity in Miles.</summary>
