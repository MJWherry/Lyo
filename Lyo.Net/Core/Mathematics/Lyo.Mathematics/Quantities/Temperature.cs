...
{
    /// <summary>SI storage scalar in Kelvin (canonical unit for this Temperature).</summary>
    public double Kelvin { get; }

    /// <summary>This quantity in Celsius.</summary>
    public double Celsius => Kelvin - 273.15d;

    /// <summary>This quantity in Fahrenheit.</summary>
