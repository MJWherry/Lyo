...
/// <summary>A discoverable mathematics capability: stable id, taxonomy, owning assembly, and a readable signature hint.</summary>
/// <remarks>Same shape as the scientific registries so tooling can treat mathematics and scientific formulas the same way.</remarks>
...
/// <param name="Description">One-line note of what the formula computes.</param>
