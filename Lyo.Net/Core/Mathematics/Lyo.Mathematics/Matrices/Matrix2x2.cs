...
/// <remarks>Used by <c>LinearAlgebraFunctions</c> for determinants, inversion, eigenvalues, and solves.</remarks>
...
public readonly record struct Matrix2x2
{
    ...
    /// <summary>Builds a matrix from row-major components; each must be finite.</summary>
