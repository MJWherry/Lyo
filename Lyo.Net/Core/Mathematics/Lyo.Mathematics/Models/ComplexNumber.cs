...
/// <remarks>Components must be finite. Polar construction requires a non-negative magnitude.</remarks>
[DebuggerDisplay("{ToString(),nq}")]
public readonly record struct ComplexNumber
{
    /// <summary>Real (in-phase) part.</summary>
    public double Real { get; }

    /// <summary>Imaginary (quadrature) part.</summary>
    ...
    /// <summary>Builds a complex number after checking that both parts are finite.</summary>
    ...
    /// <summary>Builds a complex number from polar coordinates.</summary>
