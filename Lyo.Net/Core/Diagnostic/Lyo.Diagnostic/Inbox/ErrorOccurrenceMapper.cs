...
/// <summary>Maps <see cref="DiagnosticContext" /> plus optional breadcrumbs into an <see cref="ErrorOccurrenceRecord" />.</summary>
public static class ErrorOccurrenceMapper
{
    ...
    /// <summary>
    /// Builds a record from a diagnostic context. When <paramref name="sanitiser" /> is provided, crash site and exception message come from the
    /// sanitised trace.
    /// </summary>
