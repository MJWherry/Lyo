...
/// <summary>Fully enriched diagnostic payload produced for one exception occurrence. Safe to serialise and return in an API error response (after sanitisation).</summary>
...
{
    /// <summary>True when this exception is expected control flow (for example cancellation) and likely does not represent a bug.</summary>
    ...
    /// <summary>Shortcut to the most likely crash location summary, for example "OrderService.cs:87".</summary>
