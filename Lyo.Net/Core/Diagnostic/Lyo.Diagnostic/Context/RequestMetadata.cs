...
/// <summary>Captures HTTP / gRPC request metadata at the point of exception. Every property is optional; populate what your host provides.</summary>
...
{
    /// <summary>Builds an empty metadata record for non-HTTP contexts.</summary>
