...
{
    /// <summary>Short file name without a directory path, or <see langword="null" />.</summary>
    public string? ShortFileName => SourceFile is null ? null : Path.GetFileName(SourceFile);

    /// <summary>Human-readable location, for example <c>OrderService.cs:87</c>.</summary>
    ...
    /// <summary>
    /// True when this frame is compiler-generated and does not represent a line the developer wrote directly (async state machines or lambdas without
    /// PDB source info).
    /// </summary>
