...
public interface IStackTraceDecoder
{
    ...
    /// <exception cref="System.InvalidOperationException">When <see cref="StackTraceDecoderOptions.PackageMetadataStore" /> is configured; use <see cref="DecodeAsync(string, CancellationToken)" /> instead.</exception>
    ...
    /// <exception cref="System.InvalidOperationException">When <see cref="StackTraceDecoderOptions.PackageMetadataStore" /> is configured; use <see cref="DecodeAsync(Exception, CancellationToken)" /> instead.</exception>
