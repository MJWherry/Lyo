...
{
    /// <summary>Decodes one raw stack-trace string.</summary>
    ...
    /// <summary>Convenience overload: decodes directly from a live <see cref="Exception" />, walking the full inner-exception chain on its own.</summary>
    /// <exception cref="System.InvalidOperationException">
    /// When <see cref="StackTraceDecoderOptions.PackageMetadataStore" /> is configured; use
    ...
    /// <summary>Decodes from a live <see cref="Exception" />, including inner exceptions. Required when <see cref="StackTraceDecoderOptions.PackageMetadataStore" /> is configured.</summary>
