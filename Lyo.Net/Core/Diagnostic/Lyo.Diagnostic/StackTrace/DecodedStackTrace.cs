...
/// <summary>Fully decoded, structured representation of one exception and its inner chain.</summary>
    ...
    IReadOnlyList<DecodedStackTrace> InnerExceptions)
{
    ...
    /// <summary>True when every frame is system / third-party.</summary>
