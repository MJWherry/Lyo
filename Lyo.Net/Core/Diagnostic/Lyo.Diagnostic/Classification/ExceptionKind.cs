...
{
    /// <summary>Null dereference or a missing object.</summary>
    NullReference,

    /// <summary>Cast or type-conversion failure.</summary>
    TypeMismatch,

    /// <summary>Collection index out of range, or a key that was not found.</summary>
    CollectionAccess,

    /// <summary>Race condition, deadlock, or concurrent modification.</summary>
    Concurrency,

    /// <summary>File, stream, network, or database IO failure.</summary>
    IO,

    /// <summary>JSON, XML, binary, or other serialization failure.</summary>
    Serialisation,
    ...
    /// <summary>Memory pressure or an allocation failure.</summary>
    Memory,

    /// <summary>Stack overflow caused by unbounded recursion.</summary>
    StackOverflow,

    /// <summary>Argument-validation failure.</summary>
    ArgumentValidation,

    /// <summary>Operation was cancelled through a <see cref="System.Threading.CancellationToken" />.</summary>
    Cancellation,
