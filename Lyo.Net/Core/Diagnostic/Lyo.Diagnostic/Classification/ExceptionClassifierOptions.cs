...
/// <summary>Controls <see cref="ExceptionClassifier" /> behaviour.</summary>
[DebuggerDisplay("{ToString(),nq}")]
public sealed record ExceptionClassifierOptions
{
    /// <summary>Additional mappings from exception type name (simple or fully-qualified) to <see cref="ExceptionKind" />. These take priority over the built-in rules.</summary>
