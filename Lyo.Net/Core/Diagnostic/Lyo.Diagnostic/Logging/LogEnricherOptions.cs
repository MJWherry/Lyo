...
{
    /// <summary>When true, the full frame list is written to the log as a structured array. Can be verbose; disable in high-throughput services. Defaults to false.</summary>
    public bool IncludeAllFrames { get; init; } = false;

    /// <summary>When true, inner exceptions are each written as a nested structured object. Defaults to true.</summary>
