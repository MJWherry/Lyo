...
public sealed class CorrelationHandlerOptions
{
    ...
    /// <summary>
    /// Header names checked on the outbound request. If any are already populated by the caller (e.g. via the typed-client's <c>before:</c> hook), the handler does nothing.
