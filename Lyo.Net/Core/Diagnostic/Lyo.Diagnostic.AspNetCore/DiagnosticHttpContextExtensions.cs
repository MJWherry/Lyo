...
/// <summary>Maps the current HTTP context into <see cref="RequestMetadata" />.</summary>
public static class DiagnosticHttpContextExtensions
{
    /// <summary>Copies correlation id, method, path, query, identity, client IP, and user-agent into request metadata.</summary>
