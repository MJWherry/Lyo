...
/// <summary>An <see cref="IMetrics" /> that exports samples through OpenTelemetry.</summary>
public class OpenTelemetryMetrics : IMetrics, IDisposable
{
    ...
    /// <summary>Builds an OpenTelemetry-backed metrics recorder.</summary>
    /// <param name="meterName">Meter name (for example "Lyo.Metrics")</param>
    /// <param name="meterVersion">Optional meter version</param>
