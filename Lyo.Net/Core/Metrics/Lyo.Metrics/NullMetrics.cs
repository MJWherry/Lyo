...
/// <summary>An <see cref="IMetrics" /> that drops every sample. Suitable as the default when you do not need metrics.</summary>
public class NullMetrics : IMetrics
{
    /// <summary>Shared singleton <see cref="NullMetrics" />.</summary>
