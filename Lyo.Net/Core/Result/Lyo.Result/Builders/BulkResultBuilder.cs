...
/// <summary>Fluent builder for assembling a <see cref="BulkResult{T}" /> incrementally.</summary>
/// <typeparam name="T">Data type for each individual result.</typeparam>
public sealed class BulkResultBuilder<T>
{
    private readonly List<Result<T>> _results = [];

    /// <summary>Number of results added so far.</summary>
    ...
    /// <summary>Adds several pre-built results.</summary>
...
/// <summary>Fluent builder for assembling a <see cref="BulkResult{TRequest, TResult}" /> incrementally.</summary>
/// <typeparam name="TRequest">Request type.</typeparam>
/// <typeparam name="TResult">Data type for each individual result.</typeparam>
