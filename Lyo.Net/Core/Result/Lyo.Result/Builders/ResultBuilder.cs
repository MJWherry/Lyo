...
/// <summary>Fluent builder for minting Result instances.</summary>
...
public class ResultBuilder<T>
{
    ...
    /// <summary>Mints a new builder instance.</summary>
    public static ResultBuilder<T> Create() => new();

    /// <summary>Marks the result as successful with data.</summary>
    ...
    /// <summary>Marks the result as failed with errors.</summary>
    ...
    /// <summary>Marks the result as failed with a single error.</summary>
    ...
    /// <summary>Marks the result as failed with error details.</summary>
    ...
    /// <summary>Marks the result as failed from an exception.</summary>
    ...
    /// <summary>Adds several metadata entries.</summary>
...
/// <summary>Fluent builder for minting Result instances with request and result data.</summary>
...
public class ResultBuilder<TRequest, TResult>
{
    ...
    /// <summary>Marks the result as successful with request and data.</summary>
    ...
    /// <summary>Marks the result as failed with request and errors.</summary>
    ...
    /// <summary>Marks the result as failed with request and a single error.</summary>
    ...
    /// <summary>Marks the result as failed with request and error details.</summary>
    ...
    /// <summary>Marks the result as failed with request from an exception.</summary>
