...
/// <summary>Fluent builder for minting Error instances.</summary>
public class ErrorBuilder
{
    ...
    /// <summary>Builds a builder from an existing exception.</summary>
    ...
    /// <summary>Sets the exception. When message or stacktrace aren't set, they are populated from the exception.</summary>
