...
/// <summary>Helpers for logging Results.</summary>
public static class ResultLoggingExtensions
{
    extension<T>(Result<T> result)
    {
        /// <summary>Logs success when the result is successful. Uses a simple action-based logger.</summary>
        ...
        /// <summary>Logs failure when the result failed. Uses a simple action-based logger.</summary>
