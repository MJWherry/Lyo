...
/// <summary>Error with a message, code, type, optional stack trace, inner error, metadata, timestamp, and optional exception.</summary>
...
public sealed record Error
{
    ...
    /// <summary>Builds an Error from an exception.</summary>
    ...
    /// <summary>Builds a validation error.</summary>
    ...
    /// <summary>Builds a not-found error.</summary>
    ...
    /// <summary>Builds a conflict error.</summary>
    ...
    /// <summary>Builds an unauthorized error.</summary>
    ...
    /// <summary>Builds a forbidden error.</summary>
    ...
    /// <summary>Builds an internal error, optionally wrapping an exception.</summary>
    ...
    /// <summary>Builds a timeout error.</summary>
    ...
    /// <summary>Builds a service-unavailable error.</summary>
