...
/// <summary>Helpers for composing and awaiting async Result operations.</summary>
public static class AsyncResultExtensions
{
    /// <summary>Chains an asynchronous operation onto a result. Runs only on success.</summary>
    ...
    /// <summary>Chains an asynchronous operation onto a task result. Runs only on success.</summary>
    ...
    /// <summary>Chains an asynchronous operation that returns a plain value. Wraps the value in a success result.</summary>
    ...
    /// <summary>Chains an asynchronous operation that returns a plain value (task overload).</summary>
    ...
    /// <summary>Chains an asynchronous operation that accepts a CancellationToken. Runs only on success.</summary>
    ...
    /// <summary>Chains an asynchronous operation that accepts a CancellationToken (task overload).</summary>
    ...
    /// <summary>Runs an asynchronous side-effect when the result is successful.</summary>
    ...
    /// <summary>Runs an asynchronous side-effect when the result is successful (task overload).</summary>
    ...
    /// <summary>Runs an asynchronous side-effect when the result failed.</summary>
    ...
    /// <summary>Runs an asynchronous side-effect when the result failed (task overload).</summary>
    ...
    /// <summary>Awaits every task in parallel. Succeeds only when every result succeeds; otherwise returns all errors.</summary>
    ...
    /// <summary>Awaits every task in parallel (enumerable overload).</summary>
    ...
    /// <summary>
    /// Runs every task in parallel and returns the first successful result. If none succeed, returns all collected errors. Renamed from the previously misnamed <c>WhenAny</c>
    ...
    /// <summary>Runs every task in parallel and returns the first successful result (enumerable overload).</summary>
    ...
    /// <summary>Runs an asynchronous side-effect on a task result without changing it (success or failure).</summary>
    ...
    /// <summary>Transforms a task result's success value using an asynchronous mapper.</summary>
    ...
    {
        /// <summary>Combines two asynchronous results into a tuple. Both must succeed.</summary>
        ...
        /// <summary>Combines three asynchronous results into a tuple. All must succeed.</summary>
