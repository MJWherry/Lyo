...
/// <summary>Categorises the nature of an error to support consistent handling at boundaries (for example HTTP mapping).</summary>
public enum ErrorType
{
    ...
    /// <summary>The operation conflicts with current state (for example duplicate, concurrency violation).</summary>
    Conflict = 3,
