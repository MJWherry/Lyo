...
/// <summary>Helpers and aggregation for Result types.</summary>
public static class ResultExtensions
{
    ...
    extension<T>(IEnumerable<Result<T>>? results)
    {
        ...
        /// <summary>Returns the first successful result, or a combined failure when all failed.</summary>
    ...
    {
        /// <summary>Chains two results together. When the first result is successful, applies the function to get the next result.</summary>
        ...
        /// <summary>Runs an action when the result is successful.</summary>
        ...
        /// <summary>Runs an action when the result is successful and returns a new result.</summary>
        ...
        /// <summary>Runs an action when the result failed.</summary>
        ...
        /// <summary>Runs an action when the result failed and returns a new result.</summary>
        public Result<TIn> OnFailure(Func<IReadOnlyList<Error>, Result<TIn>> func) => !result.IsSuccess ? func(result.Errors ?? []) : result;

        /// <summary>All error messages from the result's errors.</summary>
        ...
        /// <summary>All error codes from the result's errors.</summary>
    ...
    {
        /// <summary>First error from the result, if any.</summary>
        public Error? GetFirstError() => result.Errors?.FirstOrDefault();

        /// <summary>True when the result has any errors with the specified severity.</summary>
    ...
    extension<T>(Result<T> result)
    {
        /// <summary>Groups errors by error code.</summary>
        ...
        /// <summary>Groups errors by severity.</summary>
