...
/// <summary>Runs actions through named resilience pipelines from the registry.</summary>
public sealed class ResilientExecutor : IResilientExecutor
{
    private readonly IMetrics _metrics;
    private readonly ResiliencePipelineProvider<string> _pipelineProvider;

    /// <summary>Mints a resilient executor.</summary>
    /// <param name="pipelineProvider">Registry used to resolve pipelines by name.</param>
