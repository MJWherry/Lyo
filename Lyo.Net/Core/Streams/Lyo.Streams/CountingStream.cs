...
/// <summary>A stream wrapper that tracks the number of bytes read and/or written.</summary>
public class CountingStream : Stream
{
    ...
    /// <summary>Resets the byte counters to zero. Can be called at any time during the stream's lifetime.</summary>
