...
/// <summary>Read-only stream that reads several input streams in order until each is exhausted.</summary>
public class ConcatenatedStream : Stream
{
    ...
    /// <summary>Mints a ConcatenatedStream from a collection of streams.</summary>
    /// <param name="streams">Streams to read in order</param>
    /// <param name="ownsStreams">True to dispose those streams when this stream is disposed</param>
    ...
    /// <summary>Mints a ConcatenatedStream from the given streams.</summary>
    /// <param name="ownsStreams">True to dispose those streams when this stream is disposed</param>
    /// <param name="streams">Streams to read in order</param>
