...
/// <summary><see cref="JsonConverter{T}" /> for <see cref="DateOnlyModel" /> using ISO-8601 calendar dates.</summary>
/// <remarks>Null JSON tokens and empty strings deserialize to <see langword="null" />; non-null values write as <c>yyyy-MM-dd</c>.</remarks>
