...
/// <summary>
/// Mutable singleton holding the active PostgreSQL connection string for the session.
/// All consumers read ConnectionString at the time of use so changes take effect immediately.
/// </summary>
public sealed class ConnectionStringProvider
{
    ...
    public string GetOrThrow() =>
        ConnectionString ?? throw new InvalidOperationException(
            "No connection string is configured. Use 'C. Change Connection String' from the main menu.");
