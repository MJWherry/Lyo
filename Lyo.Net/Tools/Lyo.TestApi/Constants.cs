...
public static class Constants
{
    ...
    public static class FileStorageWorkbench
    {
        ...
        /// <summary>Route prefix for Lyo.Api Query/QueryProject against Postgres <c>file_metadata</c> (append <c>/QueryConcrete</c> or <c>/QueryProject</c>).</summary>
        public const string FileMetadata = "Workbench/FileStorage/FileMetadata";
    }

    /// <summary>App-root streaming upload using the same query string and multipart shape as <see cref="FileStorageWorkbench.Route" />/files/save-stream.</summary>
