...
public static class Constants
{
    ...
    {
        /// <summary>REST prefix for Test API file-workbench endpoints.</summary>
        public const string ApiRoutePrefix = "Workbench/FileStorage";

        /// <summary>Route prefix for file-metadata Query/QueryProject (matches Test API <c>Workbench/FileStorage/FileMetadata</c>).</summary>
