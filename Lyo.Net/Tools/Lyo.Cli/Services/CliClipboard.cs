...
/// <summary>Sends text to the OS clipboard using built-in platform tools instead of a NuGet clipboard package.</summary>
internal static class CliClipboard
{
    /// <summary>Feeds <paramref name="text" /> to the host clipboard utility on stdin.</summary>
