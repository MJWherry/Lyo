...
/// <summary>Compress/decompress helpers with every built-in and add-on factory wired the same way Gateway does.</summary>
internal static class CliCompression
{
    ...
    {
        // Force add-on algorithm singletons to load so TryFromName can find them.
