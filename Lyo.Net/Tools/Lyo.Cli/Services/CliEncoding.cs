...
/// <summary>Helpers for binary and character-set encodings built on <see cref="BinaryEncoding" /> and <see cref="CharsetEncoding" />.</summary>
internal static class CliEncoding
{
    ...
    public static async Task EncodeAsync(BinaryEncodingKind kind, Stream input, TextWriter output, TextLetterCase hexCase, CancellationToken ct)
    {
        ...
        // Stream EncodeAsync may ignore hex case; buffer first so hex casing can be chosen.
