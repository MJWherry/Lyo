...
/// <summary>Thin wrappers for merge, split, statistics, and validation of CSV files.</summary>
internal static class CliCsv
{
    ...
    public static async Task<string> StatsAsync(string? input, CsvService csv, CancellationToken ct)
    {
        ...
        // CsvStatistics carries Encoding / Type, which System.Text.Json cannot serialize; flatten to primitives.
        var payload = new {
            stats.RowCount,
            stats.ColumnCount,
            stats.Headers,
