...
/// <summary>Reads key bytes from <c>--key</c> or <c>--key-file</c> as hex, base64, or a UTF-8 passphrase hashed with SHA-256.</summary>
internal static class KeyMaterial
{
    /// <summary>Produces raw key bytes. Even-length hex or base64 is preferred; anything else is treated as a UTF-8 passphrase and hashed with SHA-256.</summary>
    ...
    /// <summary>Like <see cref="ResolveAsync" />, then shortens or lengthens the digest with SHA-2 to <paramref name="byteLength" /> the way Gateway derives secrets.</summary>
