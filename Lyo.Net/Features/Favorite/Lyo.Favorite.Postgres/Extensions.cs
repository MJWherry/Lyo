...
public static class Extensions
{
    ...
    public static IServiceCollection AddPostgresFavoriteStore(this IServiceCollection services, PostgresFavoriteOptions options)
    {
        ...
        services.AddSingleton<IFavoriteStore>(sp => new PostgresFavoriteStore(
            sp.GetRequiredService<IDbContextFactory<FavoriteDbContext>>(), sp.GetRequiredService<IOptions<EntityRefOptions>>(),
            sp.GetRequiredService<IOptions<PostgresFavoriteOptions>>(), sp.GetServices<IEntityRefActionInterceptor>()));
