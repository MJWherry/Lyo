...
Contact-form submission contracts. `IContactUsService` and `ContactUsServiceBase` handle validation, error-code mapping, and logging. Storage implementations live in sibling packages such as [`Lyo.ContactUs.Postgres`](../Lyo.ContactUs.Postgres/README.md).
