...
Abstractions for threaded, reactable comments on any entity. Each comment has a **subject** (what it is about), an **actor** (author), optional `ReplyToCommentId` for threads, and cached like/dislike counters maintained by the reaction methods.
