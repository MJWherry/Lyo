...
public interface IJobScheduler
{
    ...
    /// <summary>Reloads all enabled job definitions from the API. Safe to call externally; acquires the internal lock automatically.</summary>
    Task RefreshDefinitionsAsync(CancellationToken ct = default);

    /// <summary>Evaluates all loaded schedules and creates job runs for any that are due. Safe to call externally; acquires the internal lock automatically.</summary>
