...
{
    public static Color ForState(JobState state) => state switch {
    ...
    public static Color ForResult(JobRunResult? result) => result switch {
    ...
    public static Color ForLogLevel(JobLogLevel level) => level switch {
    ...
    public static string StateIcon(JobState state) => state switch {
    ...
    public static string ResultIcon(JobRunResult? result) => result switch {
