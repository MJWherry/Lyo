...
/// <summary>
/// No-op <see cref="IJobEventPublisher" /> registered by default when no message-queue transport is configured. Always reports as disconnected so <see cref="JobService" />
/// operations that require the transport will return an appropriate error rather than throwing. Override by calling <c>AddMqJobEventPublisher()</c> (or registering your own
/// implementation) after <c>AddPostgresJobManagement()</c>.
/// </summary>
