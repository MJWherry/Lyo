...
/// <summary>One slot is <c>IEnumerable&lt;T&gt;</c> of an anonymous row with V0..Vn-1; expands to parallel arrays for each listed spec index (sibling collection columns).</summary>
