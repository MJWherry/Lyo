...
{
    /// <summary>
    /// Use after creates or when new rows are not represented in existing <c>entity:&lt;type&gt;:&lt;id&gt;</c> tags. Removes all cached list queries and type-scoped GET entries
    ...
    /// convention change affects all grids with a given select/computed/zip fingerprint without touching entity instance tags.
    /// </summary>
