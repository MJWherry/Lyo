...
public static partial class ServiceCollectionExtensions
{
    ...
    {
        /// <summary>
        /// Registers same-context and cross-schema navigations for <typeparamref name="TContext" />.
        /// Pair with <see cref="AddDbContextFactoryWithLyoNavigations{TContext}" /> so the model customizer applies them.
        /// Related tables must live in the same database; cross-schema mappings use <c>ExcludeFromMigrations</c>.
        /// </summary>
            ...
            where TContext : DbContext
        {
            ...
            configure(new CrossSchemaNavigationBuilder<TContext>(options));
        ...
        /// <summary>
        /// Registers <see cref="IDbContextFactory{TContext}" /> with <see cref="LyoComposingModelCustomizer" /> so
        /// <see cref="AddCrossSchemaNavigations{TContext}" /> registrations are applied after <c>OnModelCreating</c>.
        /// Call <see cref="AddCrossSchemaNavigations{TContext}" /> before this method.
        /// When registrations exist, ignores <see cref="RelationalEventId.PendingModelChangesWarning" /> so soft/cross-schema
        /// navigations do not block <c>MigrateAsync</c> against an unchanged migration snapshot.
        /// </summary>
        ...
        /// <summary>
        /// Registers <see cref="IDbContextFactory{TContext}" /> with typed options and <see cref="LyoComposingModelCustomizer" />.
        /// </summary>
        ...
        where TContext : DbContext
    {
        ...
        ((IDbContextOptionsBuilderInfrastructure)builder).AddOrUpdateExtension(
            new CrossSchemaNavigationOptionsExtension(navOptions.Registrations.ToArray()));
