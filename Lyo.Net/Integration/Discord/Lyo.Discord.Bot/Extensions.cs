...
/// <summary>
/// Strongly typed read/write for guild settings on <see cref="ICacheService" />, including <see cref="GuildSettingsChangedNotification" /> on meaningful updates.
/// </summary>
public static class Extensions
{
    ...
    {
        /// <summary>Gives cached settings for <paramref name="guildId" />, or null if missing or expired.</summary>
        ...
        /// <summary>Writes the cache entry and publishes <see cref="GuildSettingsChangedNotification" /> when meaningful values change.</summary>
    ...
    {
        /// <summary>Sends an error embed to the configured guild log channel.</summary>
        ...
        /// <summary>Sends an info embed to the configured guild log channel.</summary>
