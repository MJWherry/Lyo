...
/// <summary>Stock implementation: maps DSharpPlus entities to Lyo API upserts (bulk where supported).</summary>
...
{
    /// <summary>Snowflake epoch and shift for snowflake IDs from the chat API (2015-01-01 UTC origin, 22-bit timestamp field).</summary>
