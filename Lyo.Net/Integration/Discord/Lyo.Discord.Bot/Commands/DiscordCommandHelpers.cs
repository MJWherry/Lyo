...
/// <summary>Checks and helpers for slash commands; throws <see cref="DiscordCommandException" /> for the global error handler.</summary>
public static class DiscordCommandHelpers
{
    /// <summary>Raises <see cref="DiscordCommandException" /> when <paramref name="value" /> is null.</summary>
    ...
    /// <summary>Needs a guild context (not DMs).</summary>
    public static void RequireGuild(InteractionContext ctx) => ThrowIfNull(ctx.Guild, "Use this command in a server.");

    /// <summary>Needs <see cref="Permissions.ManageGuild" /> on the invoking member.</summary>
