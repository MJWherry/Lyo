...
/// <summary>Slash commands hanging under <c>/settings</c> for guild-scoped bot configuration (Lyo API).</summary>
/// <remarks>
/// Discord (and DSharpPlus) forbid mixing direct subcommands with nested subgroups on one slash group. All commands sit under subgroups: <c>/settings channels …</c>,
/// <c>/settings roles …</c>, plus <c>/settings info …</c>.
/// </remarks>
...
{
    /// <summary>Nested commands under <c>/settings channels</c>.</summary>
    ...
    /// <summary>Nested commands under <c>/settings roles</c>.</summary>
    ...
    /// <summary>Nested commands under <c>/settings info</c>.</summary>
