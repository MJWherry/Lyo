...
/// <summary>
/// Shared slash command and option names/descriptions for guild settings (<c>/settings</c> tree). Use with DSharpPlus attributes (compile-time string constants).
/// </summary>
public static class GuildSlashSettings
{
    /// <summary>Root command group: <c>/settings</c>.</summary>
    ...
    /// <summary>Command subgroup: <c>/settings channels</c>.</summary>
    public static class Channels
    {
        public const string Name = "channels";
        public const string Description = "Where the bot accepts commands";

        /// <summary>Slash command: <c>/settings channels setcommandchannel</c>.</summary>
        public static class SetCommandChannel
        {
            ...
            /// <summary>Target-channel option.</summary>
        ...
        /// <summary>Slash command: <c>/settings channels setlogchannel</c>.</summary>
    ...
    public static class Roles
    {
        ...
        /// <summary>Slash command: <c>/settings roles setadminrole</c>.</summary>
    ...
    /// <summary>Command subgroup: <c>/settings info</c>.</summary>
    public static class Info
    {
        public const string Name = "info";
        public const string Description = "View current bot settings";

        /// <summary>Slash command: <c>/settings info show</c>.</summary>
