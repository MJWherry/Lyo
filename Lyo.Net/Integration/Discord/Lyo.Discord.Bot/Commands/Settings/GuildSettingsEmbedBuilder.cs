...
/// <summary>Assembles <see cref="DiscordEmbed" />s for <see cref="DiscordGuildSettings" /> (Lyo bot configuration).</summary>
public static class GuildSettingsEmbedBuilder
{
    /// <summary>Discord blurple, matching typical bot embeds.</summary>
    public static readonly DiscordColor DefaultAccent = new(0x5865F2);

    /// <summary>Produces an embed summarizing guild settings, resolving IDs to mentions when the entity exists in <paramref name="guild" />.</summary>
