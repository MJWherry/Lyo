...
/// <summary>Address fields used in Person Search address criteria.</summary>
...
public class PersonQueryAddress
{
    ...
    /// <summary>Second address line (city/state/zip when supplied as one field).</summary>
    public string? AddressLine2 { get; set; }

    /// <summary>Filter on county.</summary>
