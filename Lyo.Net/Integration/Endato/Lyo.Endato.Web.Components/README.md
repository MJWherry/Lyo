...
MudBlazor views and search forms over `Lyo.Endato.Client`. Host in TestGateway or a product Blazor app.
...
```csharp
// Add the Endato workbench components to a Blazor host that already has AddEndatoClient.
```
