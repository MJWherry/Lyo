...
public sealed record ComponentSavedToFileResult(Type ComponentType, string FilePath, string Html, IReadOnlyDictionary<string, object>? ParameterDictionary, object? ComponentOptions)
{
