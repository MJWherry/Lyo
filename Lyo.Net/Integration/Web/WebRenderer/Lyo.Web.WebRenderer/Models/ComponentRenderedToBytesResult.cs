...
public sealed record ComponentRenderedToBytesResult(Type ComponentType, byte[] HtmlBytes, string Html, Dictionary<string, object>? ParameterDictionary, object? ComponentOptions)
{
