...
- [`Lyo.Web.Automation`](../Lyo.Web.Automation/README.md) — engine-agnostic abstractions and JSON automation plans.
- [`Lyo.Web.Automation.Selenium`](../Lyo.Web.Automation.Selenium/README.md) — Selenium counterpart with the same surface.
- [`Lyo.IO.Temp`](../../../../Data/IOTemp/Lyo.IO.Temp/README.md) — used internally for session directory cleanup.
