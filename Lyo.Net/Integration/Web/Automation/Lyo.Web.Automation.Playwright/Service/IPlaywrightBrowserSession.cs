...
public interface IPlaywrightBrowserSession : IWebAutomationSession
{
    ...
    /// <summary>
    /// Tab and page management (same as <see cref="PlaywrightBrowser.NativeTabs" />); engine-native APIs beyond <see cref="Lyo.Web.Automation.Abstractions.IWebAutomationTabs" />
    /// .
    /// </summary>
