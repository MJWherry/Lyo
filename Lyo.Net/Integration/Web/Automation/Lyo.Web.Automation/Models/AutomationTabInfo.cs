...
/// <summary>Engine-neutral snapshot of one tab/page (see <see cref="Lyo.Web.Automation.Abstractions.IWebAutomationTabs" />). <see cref="TabKey" /> is opaque: Selenium window handle or Playwright page key.</summary>
