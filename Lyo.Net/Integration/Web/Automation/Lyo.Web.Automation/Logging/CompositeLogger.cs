...
/// <summary>
/// Fans log calls out to two <see cref="ILogger" /> instances.
/// Used to write to both the injected application logger and the per-session file logger simultaneously.
/// </summary>
