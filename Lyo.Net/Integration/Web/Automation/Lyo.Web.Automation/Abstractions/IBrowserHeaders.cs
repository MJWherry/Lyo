...
/// <summary>
/// Extra HTTP request header management for browser engines that support it (e.g. Playwright). Headers set here are sent with every subsequent request made by the browser.
