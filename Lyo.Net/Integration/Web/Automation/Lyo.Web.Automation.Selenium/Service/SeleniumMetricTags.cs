...
{
    public static (string, string)[] ForOperation(LyoBrowser scraper, string operation, IEnumerable<(string, string)>? extra = null)
    {
    ...
    public static (string, string)[] ForOperation(LyoBrowser scraper, string operation, string? urlForHost, IEnumerable<(string, string)>? extra = null)
    {
        var list = new List<(string, string)> { ("operation", operation), ("session_id", scraper.SessionIdLabel), ("implementation", "selenium") };
