...
/// <summary>Factory for scoped browser sessions (similar to <c>IIOTempService.CreateSession</c>).</summary>
public interface ISeleniumBrowserService : IDisposable
{
    ...
    /// <summary>Creates a new browser session with a dedicated <see cref="LyoBrowser" />; call <see cref="IWebAutomationSession.StartBrowserAsync" /> before navigation (or use automation runners, which start the browser for you).</summary>
