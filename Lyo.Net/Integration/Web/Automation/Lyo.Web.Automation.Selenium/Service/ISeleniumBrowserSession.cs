...
public interface ISeleniumBrowserSession : IWebAutomationSession
{
    ...
    /// <summary>
    /// Tab and window management (same as <see cref="SeleniumBrowser.NativeTabs" />); engine-native APIs beyond <see cref="Lyo.Web.Automation.Abstractions.IWebAutomationTabs" />
    /// .
    /// </summary>
    TabManager Tabs { get; }
}