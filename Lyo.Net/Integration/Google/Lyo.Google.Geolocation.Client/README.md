...
**Archetype C.** `Integration/Google/` (vendor folder). Geolocation is not Communication. This package mirrors `Lyo.Endato.Client` plus a Core store, not `Lyo.Translation.Google`. Path confirmed in [package layout](../../../docs/package-layout.md) (Phase 1).
