...
using Lyo.Espn.Fantasy.Football.Client.Models.Request;
using Lyo.Exceptions;

namespace Lyo.Espn.Fantasy.Football.Client.Builders;
...
public sealed class FantasyFilterReqBuilder
{
    ...
    /// <summary>Assigns the player ids for a player-card request.</summary>
    ...
    /// <summary>Assigns the scoring period filter ESPN expects for player-card stats.</summary>
    ...
    /// <summary>Assigns the transaction types to include.</summary>
    ...
    /// <summary>Registers a topic type group to the league chat filter.</summary>
    ...
    /// <summary>Registers multiple topic type groups to the league chat filter.</summary>
    ...
    /// <summary>Fills the recent-activity topic filter.</summary>
    ...
    /// <summary>Assembles the typed ESPN fantasy filter.</summary>
