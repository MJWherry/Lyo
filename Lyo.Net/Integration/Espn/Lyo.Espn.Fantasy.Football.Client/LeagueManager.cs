using Lyo.Espn.Fantasy.Football.Client.Models.Response;

namespace Lyo.Espn.Fantasy.Football.Client;

/// <summary>Read APIs focused on the league.</summary>
public class LeagueManager(FantasyFootballClient client)
{
    /// <summary>Loads league settings, members, and teams for a season.</summary>
    ...
    /// <summary>Loads teams and rosters for a specific scoring period.</summary>
    ...
    /// <summary>Looks up a single team with roster info for a scoring period.</summary>
    ...
    /// <summary>Loads draft metadata and picks for a season.</summary>
    ...
    /// <summary>Loads matchup and scoreboard data for a scoring period.</summary>
