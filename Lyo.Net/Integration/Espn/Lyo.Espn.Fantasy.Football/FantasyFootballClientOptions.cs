...
/// <summary>
/// Configuration options for the ESPN fantasy football client. Inherits <see cref="ApiClientOptions" />; use <see cref="ApiClientOptions.BaseUrl" /> for the ESPN fantasy API
/// root.
/// </summary>
