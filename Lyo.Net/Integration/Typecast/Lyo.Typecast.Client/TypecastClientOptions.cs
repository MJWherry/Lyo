...
/// <summary>
/// Configuration options for Typecast API client. Inherits <see cref="ApiClientOptions" /> for HTTP transport; use <see cref="ApiClientOptions.BaseUrl" /> for the Typecast
/// API root.
/// </summary>
