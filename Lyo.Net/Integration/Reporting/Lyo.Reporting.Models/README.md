...
- `ReportDefinitionParameterReq.Options` — JSON picker source (static items or root `QueryReq`); `Value` remains the default/selected scalar. `AllowedValues` stays the
  pipe-separated validation shorthand.
